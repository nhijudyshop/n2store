...
router.post('/ticket', async (req, res) => {
    const db = req.app.locals.chatDb;
    const {
        phone, customer_name, order_id, tracking_code, carrier,
    ...
    try {
        ...
        const result = await db.query(`
            INSERT INTO customer_tickets (
                phone, customer_id, customer_name, order_id, tracking_code, carrier,
                type, status, priority, products, original_cod, new_cod,
                refund_amount, fix_cod_reason, internal_note, created_by
            )
            ...
            RETURNING *
        `, [
            normalizedPhone, customerId, customer_name, order_id, tracking_code, carrier,
