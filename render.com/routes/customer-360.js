    ...
    try {
        ...
        if (!finalStatus) {
            ...
            if (tposResult.success && tposResult.customer) {
                ...
                console.log(`[Customer360] Fetched TPOS status for ${normalizedPhone}: ${finalStatus}`);
            } else {
        ...
        const result = await db.query(`
            INSERT INTO customers (phone, name, email, address, status, tags, tpos_id, tpos_data)
...
router.post('/balance-history/link-customer', async (req, res) => {
    ...
    try {
        ...
        // 2. Get or create customer with TPOS data
