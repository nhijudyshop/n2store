...
//   - Web 2.0 nguồn data NCC là Firestore `web2_so_order/main` + `web2_supplier_wallet/main`
...
router.get('/summary', async (req, res) => {
    res.json({
        ...
        suppliers: [],
        note: 'Web 2.0 không đọc purchase_orders (Web 1.0). Frontend tự tính từ Firestore web2_so_order + web2_supplier_wallet.',
    });
});
