// #Note: Đọc CLAUDE.md, MEMORY.md, docs/dev-log.md trước khi code. Cập nhật dev-log sau thay đổi. | WEB2.0 — enrich tpos-pancake từ kho khách hàng.
// =====================================================================
// TposKhoEnricher — LẤP CHỖ TRỐNG SĐT/địa chỉ ở mỗi dòng comment khi TPOS
...
// fallback (TPOS trước, kho KH lấp chỗ trống — KHÔNG ghi đè partnerCache).
//
...
(function () {
    ...
    // Thu fb_ids cần enrich: có trong comment, CHƯA có Phone từ TPOS partnerCache,
    ...
    function gatherFbIds() {
        ...
        for (const c of state.comments) {
            ...
            if (partner && partner.Phone) continue; // TPOS đã có SĐT → bỏ qua
            ids.add(fbId);
        }
    ...
    async function flush() {
        ...
        try {
            ...
            console.warn('[TposKhoEnricher] flush fail:', e.message);
        }
    ...
    window.TposKhoEnricher = { scan, flush };
})();
