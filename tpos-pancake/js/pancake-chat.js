...
class PancakeChatManager {
    constructor() {
        ...
        this.serverMode = n2store.getItem('tpos_pancake_server_mode') || 'pancake';
    ...
    saveSelectedPage() {
        try {
            if (this.selectedPageId) {
                n2store.setItem('tpos_pancake_selected_page', this.selectedPageId);
            } else {
                n2store.removeItem('tpos_pancake_selected_page');
            }
        } catch (e) {
    ...
    loadSelectedPage() {
        try {
            const savedPageId = n2store.getItem('tpos_pancake_selected_page');
            if (savedPageId) {
    ...
    bindEmojiPicker() {
        ...
        const savedRecent = n2store.getItem('tpos_pk_recent_emojis');
        if (savedRecent) {
            try {
    ...
    addToRecentEmojis(emoji) {
        ...
        // Save to localStorage
        n2store.setItem('tpos_pk_recent_emojis', JSON.stringify(this.emojiData.recent));
    }
    ...
    setServerMode(mode) {
        ...
        n2store.setItem('tpos_pancake_server_mode', mode);
