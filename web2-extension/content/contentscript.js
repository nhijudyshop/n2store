    ...
    window.postMessage(
        {
            ...
            from: 'EXTENSION',
            extensionName: 'Web 2.0 Messenger',
        },
        '*'
    );
    // Đặt marker trên <html> dataset để page detect được không phụ thuộc event
    // timing (page có thể attach listener trễ hơn lúc EXTENSION_LOADED fire).
    try {
        document.documentElement.dataset.web2ExtLoaded = '1';
        document.documentElement.dataset.web2ExtVersion = '2.0.0';
    } catch (e) {
        /* ignore */
    }

    console.log('[WEB2-EXT] Content script loaded');
})();
