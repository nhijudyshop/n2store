...
6. 🟨 **Đợt GMT+7 + escape**: ✅ GMT+7 XONG (`6020700af` — 3H20 pbh-reports AT TIME ZONE + revenue_7d + audit-log + supplier-debt vnDate + 4 client fmt). ⬜ còn phần escape: module `web2/shared/web2-escape.js` 5-ký-tự + escJs + safeUrl thay ~15 bản copy (S6-residual variants/print + cluster 4-ký-tự).
