...
- ⬜ **TM-cụm** — kpi default-open + reclassify không auth + forecast/actual dead · ✅ `6020700af` dashboard revenue_7d pin GMT+7 · notifications không cron + scan serial ~400 query · ck-dashboard SSE 0ms · audit-log bảng thiếu silent · ✅ `a90ddc488` monitor pause tab ẩn · ✅ `b21df92b5` firebase compat ĐÃ GỠ (kpi ×2 gỡ 3 thẻ + firestore-compat ~470KB, services-dashboard/delivery-zone/printer-settings gỡ 2 thẻ + firebase-config).
