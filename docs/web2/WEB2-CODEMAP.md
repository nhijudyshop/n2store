...
> **Auto-generated** • 2026-06-18 17:47 • 279 files, 78 shared modules, 2548 hàm, 11 file > 800 dòng.
...
| `Web2SSE`                                  | [web2-sse-bridge.js](../../web2/shared/web2-sse-bridge.js)                            | WEB2.0 module.                                                                                          | 47        |
...
- **[live-livestream-snap-actions.js](../../live-chat/js/live/live-livestream-snap-actions.js)** ·569 — WEB2.0 module.
    - exposes: `LiveSnap`
    - uses shared: `Popup`
...
- **[live-livestream-snap-capture.js](../../live-chat/js/live/live-livestream-snap-capture.js)** ·400 — WEB2.0 module.
    - exposes: `LiveSnap`
...
- **[live-livestream-snap-extract.js](../../live-chat/js/live/live-livestream-snap-extract.js)** ·405 — WEB2.0 module.
    - exposes: `LiveSnap`
...
- **[live-livestream-snap-lock.js](../../live-chat/js/live/live-livestream-snap-lock.js)** ·185 — WEB2.0 module.
    - exposes: `LiveSnap`
...
- **[live-livestream-snap-render.js](../../live-chat/js/live/live-livestream-snap-render.js)** ·700 — WEB2.0 module.
    - exposes: `LiveSnap`
    - uses shared: `Popup`
...
- **[live-livestream-snap-seek.js](../../live-chat/js/live/live-livestream-snap-seek.js)** ·482 — WEB2.0 module.
    - exposes: `LiveSnap`
...
- **[live-livestream-snap-state.js](../../live-chat/js/live/live-livestream-snap-state.js)** ·389 — WEB2.0 module.
    - exposes: `LiveSnap`
...
- **[live-livestream-snap-stream.js](../../live-chat/js/live/live-livestream-snap-stream.js)** ·544 — WEB2.0 module.
    - exposes: `LiveSnap`
...
- **[live-livestream-snap-ui.js](../../live-chat/js/live/live-livestream-snap-ui.js)** ·374 — WEB2.0 module.
    - exposes: `LiveSnap`
    - uses shared: `Popup`
...
| `toast`            | 6       |                                                       | comments-mobile.js, live-livestream-snap-actions.js, payment-confirm-app.js, returns-core.js, web2-ck-assign-picker.js, web2-ck-review.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `_w2AuthHeaders`   | 5       | → `Web2Auth.authHeaders`                              | live-api.js, live-campaign-manager.js, live-init.js, live-livestream-snap-state.js, pancake-api.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| `_user`            | 4       |                                                       | live-livestream-gallery.js, live-livestream-snap-state.js, inventory-panel.js, returns-api.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
