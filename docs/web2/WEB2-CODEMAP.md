...
> **Auto-generated** • 2026-06-19 00:04 • 310 files, 89 shared modules, 2564 hàm, 4 file > 800 dòng.
...
| `Web2ChatPanel`                            | [web2-chat-panel.js](../../web2/shared/chat-panel/web2-chat-panel.js)                 | WEB2.0 — component chat HỢP NHẤT (Web2ChatPanel) dùng chung native-orders/web2-pancake/balance-history. | 12        |
...
| `Web2Chat`                                 | [web2-chat-client.js](../../web2/shared/web2-chat-client.js)                          | WEB2.0 module.                                                                                          | 35        |
...
**Dùng bởi:** `live-chat/js/live/live-chat-modal.js`, `live-chat/js/pancake/inventory-panel-render.js`, `live-chat/js/pancake/pancake-chat-window.js`, `native-orders/js/native-orders-app.js`, `web2/shared/chat-panel/web2-chat-emoji-data.js`, `web2/shared/chat-panel/web2-chat-panel-compose.js`, `web2/shared/chat-panel/web2-chat-panel-render.js`, `web2/shared/chat-panel/web2-chat-panel-state.js`, `web2/shared/chat-panel/web2-chat-sticker-data.js`, `web2/shared/web2-customer-chat-core.js`, `web2/shared/web2-customer-chat-modal.js`, `web2/shared/web2-customer-chat.js`
...
#### `Web2CustomerChat` — [web2/shared/web2-customer-chat.js](../../web2/shared/web2-customer-chat.js) · 207 dòng
...
**Dùng bởi:** `native-orders/js/native-orders-app.js`, `web2/shared/chat-panel/web2-chat-panel-compose.js`
...
- **[web2-customer-chat.js](../../web2/shared/web2-customer-chat.js)** ·207 — WEB2.0 module.
...
| `renderRows`       | 8       | → `Web2Page` (page-builder) nếu là list-page          | native-orders-app.js, dlv-app.js, pbh-render.js, rf-app.js, web2-products-render.js, page-builder.js, web2-customer-chat-modal.js, web2-variants-app.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| `loadOlder`        | 5       |                                                       | pancake-chat-window.js, native-orders-app.js, web2-chat-panel-render.js, web2-customer-chat-core.js, chat-view.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| `_fileToDataUrl`   | 4       |                                                       | pancake-chat-window.js, native-orders-app.js, web2-customer-chat-core.js, web2-effects.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| `quickReplies`     | 4       |                                                       | pancake-chat-window.js, native-orders-app.js, web2-customer-chat-core.js, web2-zalo-api.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
