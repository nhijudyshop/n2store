...
> **Auto-generated** • 2026-06-18 15:46 • 194 files, 75 shared modules, 2547 hàm, 24 file > 800 dòng.
...
| `renderPagination` | 10      | → `Web2Page` (page-builder) nếu là list-page          | native-orders-app.js, web2-balance-history-app.js, web2-customer-wallet-render.js, customers-app.js, dlv-app.js, pbh-render.js, rf-app.js, web2-products-app.js, page-builder.js, supplier-debt-app.js                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `closeModal`       | 9       | → `Web2Page` (page-builder) nếu là list-page          | live-customer-panel.js, web2-link-customer-modal.js, web2-pending-match.js, customers-app.js, web2-products-app.js, web2-products-print-modal.js, purchase-refund-app.js, page-builder.js, web2-variants-app.js                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| `jsonFetch`        | 6       |                                                       | web2-balance-history-app.js, web2-link-customer-modal.js, web2-manual-deposit.js, web2-pending-match.js, web2-customer-wallet-state.js, web2-wallet-api.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| `exportCsv`        | 5       |                                                       | web2-balance-history-app.js, web2-customer-wallet-events.js, customers-app.js, pbh-actions.js, supplier-debt-app.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| `debounce`         | 4       |                                                       | utils.js, web2-balance-history-app.js, web2-customer-wallet-state.js, jt-tracking-app.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `renderRow`        | 4       |                                                       | native-orders-app.js, web2-balance-history-app.js, web2-link-customer-modal.js, pbh-render.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
