...
> **Auto-generated** • 2026-06-26 07:07 • 438 files, 139 shared modules, 3496 hàm, 11 file > 800 dòng.
...
| `Popup`                                                 | [popup.js](../../web2/shared/popup.js)                                                | Web 2.0 — Custom Popup (alert / confirm / prompt)                                                       | 57        |
...
| `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`                 | [web2-auth.js](../../web2/shared/web2-auth.js)                                        | Token storage + verify + page guard.                                                                    | 133       |
...
| `Web2Escape`                                            | [web2-escape.js](../../web2/shared/web2-escape.js)                                    | WEB2.0 module.                                                                                          | 50        |
...
| `Web2Optimistic`                                        | [web2-optimistic.js](../../web2/shared/web2-optimistic.js)                            | Codifies pattern: snapshot → apply optimistic UI → fire backend background →                            | 25        |
...
| `Web2ProductTypesCache`                                 | [web2-product-types-cache.js](../../web2/shared/web2-product-types-cache.js)          | WEB2.0 module.                                                                                          | 4         |
...
| `Web2ProductsCache`                                     | [web2-products-cache.js](../../web2/shared/web2-products-cache.js)                    | WEB2.0 module.                                                                                          | 23        |
...
| `Web2SmartCache`                                        | [web2-smart-cache.js](../../web2/shared/web2-smart-cache.js)                          | WEB2.0 module.                                                                                          | 7         |
...
| `Web2SSE`                                               | [web2-sse-bridge.js](../../web2/shared/web2-sse-bridge.js)                            | WEB2.0 module.                                                                                          | 63        |
...
WEB2.0 module.
**Dùng bởi:** `web2/ai-hub/js/ai-chat.js`, `web2/ai-hub/js/ai-image.js`, `web2/shared/web2-sidebar.js`, `web2/shared/web2-tryon.js`
...
#### `Web2AuditLog` — [web2/shared/web2-audit-log.js](../../web2/shared/web2-audit-log.js) · 475 dòng
...
WEB2.0 module.
**Dùng bởi:** `web2/product-types/js/web2-product-types-app.js`, `web2/products/js/web2-products-modal.js`, `web2/products/js/web2-products-variant-picker.js`, `web2/shared/web2-variant-picker.js`
...
#### `Web2Sidebar` — [web2/shared/web2-sidebar.js](../../web2/shared/web2-sidebar.js) · 958 dòng
...
WEB2.0 module.
**Dùng bởi:** `web2/shared/web2-ai-page-registry.js`, `web2/shared/web2-customer-store.js`, `web2/shared/web2-product-types-cache.js`, `web2/shared/web2-products-cache.js`, `web2/shared/web2-sidebar.js`, `web2/shared/web2-suppliers-cache.js`, `web2/shared/web2-variants-cache.js`
...
#### `Web2VariantPicker` — [web2/shared/web2-variant-picker.js](../../web2/shared/web2-variant-picker.js) · 328 dòng
...
- **[native-orders-render.js](../../native-orders/js/native-orders-render.js)** ⚠️911 — WEB2.0 module.
    - exposes: `NativeOrders`
...
- **[so-order-barcode.js](../../so-order/js/so-order-barcode.js)** ·140 — WEB2.0 module.
    - exposes: `SoOrder`
    - uses shared: `Web2ProductsApi`
    - funcs (2): openBarcodePrintModal, printLabelsFromReceivePanel
...
- **[so-order-inline-edit.js](../../so-order/js/so-order-inline-edit.js)** ·530 — WEB2.0 module.
    - exposes: `SoOrder`
    - uses shared: `Web2NumberInput`, `Web2SuppliersCache`, `Web2VariantPicker`, `Web2VariantsCache`
    - funcs (21): \_beginVariantPickerEdit, \_currentStateSuppliers, \_ensureSupplierAsync, \_ensureSupplierCacheSubscription, \_ensureSupplierWithFeedback, \_maybeExpandVndShorthand, attachSupplierPickerOnDemand, attachVariantPickerOnDemand, beginInlineCellEdit, cancel, cleanup, commit, finish, onCellDoubleClick, onDocDown, onKey, onPick, refresh, renderDropdown, restore, updateActiveHighlight
...
- **[so-order-modal-core.js](../../so-order/js/so-order-modal-core.js)** ·499 — WEB2.0 module.
    - exposes: `SoOrder`
...
- **[so-order-modal-open.js](../../so-order/js/so-order-modal-open.js)** ·192 — WEB2.0 module.
    - exposes: `SoOrder`
    - uses shared: `Web2NumberInput`
    - funcs (6): \_applyShipMetaUi, \_setMoneyVal, \_shipMetaFlags, onPick, openOrderModal, updateContractHint
- **[so-order-modal-random.js](../../so-order/js/so-order-modal-random.js)** ·143 — WEB2.0 module.
    - exposes: `SoOrder`
    - uses shared: `Web2NumberInput`, `Web2VariantsCache`
    - funcs (7): \_rImg, \_rInt, \_rPick, \_randomRow, \_variantPools, fillModalRandom, generateRandomOrders
- **[so-order-modal-submit.js](../../so-order/js/so-order-modal-submit.js)** ·289 — WEB2.0 module.
    - exposes: `SoOrder`
...
- **[so-order-render.js](../../so-order/js/so-order-render.js)** ·779 — WEB2.0 module.
    - exposes: `SoOrder`
    - uses shared: `Web2Deeplink`, `Web2ProductsCache`, `Web2VariantMulti`
    - funcs (24): \_computeRowSpans, \_etaBadgeHtml, \_explodeVariants, \_groupMetaSubHeaderHtml, \_lookupKhoCode, \_orderReceivedGroupsLast, \_sp, \_updateVariantMultiPreview, applyEditTableModeUi, beginShipmentFieldEdit, columnHeaderRowHtml, commit, flashRow, pill, renderAll, renderFooterTotals, renderTabStrip, renderTableBody, renderTableHead, restore, rowHtml, setEditTableMode, shipmentHeaderHtml, shipmentHtml
...
- **[so-order-shipment.js](../../so-order/js/so-order-shipment.js)** ·223 — WEB2.0 module.
    - exposes: `SoOrder`
    - uses shared: `Web2NumberInput`
    - funcs (10): \_mostCommonSupplier, \_readPerOrderMeta, \_renderPerOrderMeta, num, numField, numMoney, onPick, openShipmentEditAllRows, openShipmentModal, updateContractHint
...
- **[so-order-storage.js](../../so-order/js/so-order-storage.js)** ·798 — WEB2.0 module.
...
- **[fb-insights.js](../../web2/fb-insights/js/fb-insights.js)** ·348 — WEB2.0 — Thống kê tương tác FB: tính từ bài đăng (like/cmt/share) + follower.
    - uses shared: `FBPostsApi`, `Web2Sidebar`, `Web2Skeleton`
...
- **[live-control.js](../../web2/live-control/js/live-control.js)** ·617 — WEB2.0 — Điều khiển TV livestream (user2): gắn SP vào chiến dịch + nhập số NCC báo (pending_qty).
...
- **[web2-product-detail.js](../../web2/products/js/web2-product-detail.js)** ·640 — WEB2.0 module.
...
- **[web2-products-print-modal.js](../../web2/products/js/web2-products-print-modal.js)** ·599 — WEB2.0 module.
    - exposes: `W2PP`
...
- **[web2-products-print-render.js](../../web2/products/js/web2-products-print-render.js)** ·524 — WEB2.0 module.
    - exposes: `W2PP`
...
- **[web2-products-variant-picker.js](../../web2/products/js/web2-products-variant-picker.js)** ·313 — WEB2.0 module.
    - exposes: `Web2ProductsCore`
    - uses shared: `Web2ProductCode`, `Web2ProductTypesCache`, `Web2ProductsApi`, `Web2ProductsCache`, `Web2VariantMulti`, `Web2VariantsCache`
    - funcs (14): \_bulkCreateVariants, \_combinedVariant, \_getSelectedCategory, \_isSizeGroup, \_renderCombinedHint, \_renderTypeChips, \_renderVariantMultiPreview, \_setSelectedCategory, \_setVariantPickers, \_show, \_variantKind, \_wireVariantPicker, \_wireVariantPickerFor, split
...
- **[supplier-debt-actions.js](../../web2/supplier-debt/js/supplier-debt-actions.js)** ·127 — WEB2.0 module.
    - uses shared: `Web2NumberInput`
...
- **[supplier-wallet-actions.js](../../web2/supplier-wallet/js/supplier-wallet-actions.js)** ·288 — WEB2.0 module.
    - uses shared: `Web2NumberInput`, `Web2ProductsApi`, `Web2ProductsCache`, `Web2SuppliersCache`
...
- **[system-services.js](../../web2/system/js/system-services.js)** ·320 — Fetch /api/services-overview + render cards (DB + service inventory + process).
    - exposes: `SystemServices`
    - uses shared: `API_CONFIG`, `Web2Skeleton`
    - funcs (15): $, \_scheduleRefresh, \_stopRefresh, clearFirstLoadSkeletons, escapeHtml, fmtBytes, fmtNumber, load, renderAll, renderCostSummary, renderDatabases, renderProcess, renderServices, showFirstLoadSkeletons, start
- **[system-sse.js](../../web2/system/js/system-sse.js)** ·380 — Đọc/hiển thị live SSE activity từ server. Tách từ admin-sse-monitor/js/monitor.js;
    - exposes: `SystemSSE`
...
- **[web2-audit-log.js](../../web2/shared/web2-audit-log.js)** ·475 — WEB2.0 module.
...
- **[web2-sidebar.js](../../web2/shared/web2-sidebar.js)** ⚠️958 — WEB2-clone sidebar for Web 2.0 pages.
    - exposes: `Web2Sidebar`
...
- **[web2-variant-picker.js](../../web2/shared/web2-variant-picker.js)** ·328 — WEB2.0 module.
    - exposes: `Web2VariantPicker`
    - uses shared: `Web2Escape`, `Web2ProductTypesCache`, `Web2VariantMulti`, `Web2VariantsCache`
    - funcs (19): bindInput, combinedCategory, combinedVariant, combos, destroy, ensureCss, esc, fire, focus, mount, onChange, refresh, renderAll, renderPieces, renderPreview, renderTypes, setValue, splitPieces, toggleType
...
| `toast`             | 16      |                                                       | comments-mobile-actions.js, live-livestream-snap-actions.js, ai-assistant.js, ai-hub.js, cham-cong-app.js, chi-tieu-app.js, live-control.js, payment-confirm-app.js, returns-core.js, web2-ai-describe.js, web2-ck-assign-picker.js, web2-ck-review.js, web2-content-maker.js, web2-tryon.js, web2-user-profile.js, video-stock.js                                                                                                     |
...
| `closeModal`        | 11      | → `Web2Page` (page-builder) nếu là list-page          | live-customer-panel.js, web2-link-customer-modal.js, web2-pm-modal.js, customers-detail.js, order-tags-app.js, web2-product-types-app.js, web2-products-modal.js, web2-products-print-modal.js, purchase-refund-modal.js, page-builder.js, web2-variants-app.js                                                                                                                                                                        |
...
| `health`            | 6       |                                                       | native-orders-api.js, web2-product-types-api.js, web2-api.js, web2-products-api.js, web2-vieneu.js, web2-variants-api.js                                                                                                                                                                                                                                                                                                               |
...
| `tbody`             | 5       |                                                       | native-orders-state.js, pbh-state.js, web2-product-types-app.js, web2-products-state.js, web2-variants-app.js                                                                                                                                                                                                                                                                                                                          |
...
_…và 111 hàm trùng khác (xem web2-codemap.json)._
...
| [web2/shared/web2-sidebar.js](../../web2/shared/web2-sidebar.js)                               | 958  |
| [native-orders/js/native-orders-render.js](../../native-orders/js/native-orders-render.js)     | 911  |
| [web2/cham-cong/js/cham-cong-app.js](../../web2/cham-cong/js/cham-cong-app.js)                 | 861  |
