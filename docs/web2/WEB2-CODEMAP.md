...
> **Auto-generated** • 2026-06-29 09:15 • 457 files, 147 shared modules, 3747 hàm, 15 file > 800 dòng.
...
**Dùng bởi:** `web2/reconcile/js/reconcile-app.js`, `web2/shared/web2-label-ocr.js`, `web2/shared/web2-pack-counter.js`, `web2/sort-station/js/sort-station.js`, `web2/unit-scan/js/unit-scan.js`
...
WEB2.0 shared.
**Dùng bởi:** `so-order/js/so-order-barcode.js`, `web2/products/js/web2-products-render.js`, `web2/shared/web2-unit-reprint.js`, `web2/sort-station/js/sort-station.js`, `web2/unit-scan/js/unit-scan.js`
...
#### `Web2Sidebar` — [web2/shared/web2-sidebar.js](../../web2/shared/web2-sidebar.js) · 985 dòng
...
### web2/sort-station — WEB2.0 — Bàn chia hàng: quét pile → KỆ to + theo dõi đủ/thiếu từng STT + manifest mang ra. Client units = Web2ProductUnits. Đặc tả: docs/web

- **[sort-station.js](../../web2/sort-station/js/sort-station.js)** ·399 — WEB2.0 — Bàn chia hàng: quét pile → KỆ to + theo dõi đủ/thiếu từng STT + manifest mang ra. Client units = Web2ProductUnits. Đặc tả: docs/web2/KB-PRODUCT-CODE-UN
    - uses shared: `Web2BarcodeScanner`, `Web2ProductUnits`, `Web2SSE`
    - funcs (26): $, PU, beep, boot, buildScanner, cardHtml, closeSheet, esc, flash, go, hideCamRetry, icons, initScanner, initSse, isDone, load, onScan, openManifest, parseScan, refreshCard, renderGrid, renderStats, showCamRetry, toast, vibe, wireManual
...
- **[unit-scan.js](../../web2/unit-scan/js/unit-scan.js)** ·454 — WEB2.0 — Quét QR đơn vị (mobile): resolve → HIỂN THỊ STT giỏ đã gán + đơn chờ (gán TỰ ĐỘNG ở luồng giỏ, KHÔNG nút Gán). Đặc tả: docs/web2/PER-UNIT-QR-PLAN.md
    - uses shared: `Web2BarcodeScanner`, `Web2ProductUnits`, `Web2SSE`
    - funcs (25): $, PU, \_mCard, boot, buildScanner, esc, fmtTime, fmtVnd, go, hideCamRetry, icons, initScanner, initSse, loadEvents, loadSiblings, onScan, parseScan, renderResult, reprintUnit, resolve, showCamRetry, sibRow, toast, toggleTorch, wireManual
...
- **[web2-sidebar.js](../../web2/shared/web2-sidebar.js)** ⚠️985 — WEB2-clone sidebar for Web 2.0 pages.
    - exposes: `Web2Sidebar`
...
| ------------------- | ------- | ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `toast`             | 21      |                                                       | comments-mobile-actions.js, live-livestream-snap-actions.js, ai-assistant.js, ai-hub.js, cham-cong-app.js, chi-tieu-app.js, clearance.js, goods-weight.js, live-control.js, payment-confirm-app.js, returns-core.js, web2-ai-describe.js, web2-ck-assign-picker.js, web2-ck-review.js, web2-content-maker.js, web2-gemini-chat.js, web2-tryon.js, web2-user-profile.js, sort-station.js, unit-scan.js, video-stock.js                  |
...
| `icons`             | 9       |                                                       | clearance.js, goods-weight.js, jt-tracking-constants.js, order-tags-app.js, web2-product-detail.js, web2-order-tag-detail.js, web2-unit-reprint.js, sort-station.js, unit-scan.js                                                                                                                                                                                                                                                      |
...
| `boot`              | 8       |                                                       | clearance.js, goods-weight.js, live-control.js, live-tv.js, overview.js, web2-lottie.js, sort-station.js, unit-scan.js                                                                                                                                                                                                                                                                                                                 |
...
| `cardHtml`          | 6       |                                                       | comments-mobile-render.js, web2-customer-wallet-render.js, live-tv.js, web2-ai-presets.js, sort-station.js, supplier-wallet-render.js                                                                                                                                                                                                                                                                                                  |
...
| `renderStats`       | 6       |                                                       | web2-bh-render.js, ck-dashboard-app.js, kpi-assignments.js, overview.js, web2-chat-panel-render.js, sort-station.js                                                                                                                                                                                                                                                                                                                    |
...
| [web2/shared/web2-sidebar.js](../../web2/shared/web2-sidebar.js)                               | 985  |
