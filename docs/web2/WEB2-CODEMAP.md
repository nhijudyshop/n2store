...
> **Auto-generated** • 2026-06-18 16:57 • 248 files, 78 shared modules, 2548 hàm, 13 file > 800 dòng.
...
| `Popup`                                    | [popup.js](../../web2/shared/popup.js)                                                | Web 2.0 — Custom Popup (alert / confirm / prompt)                                                       | 35        |
...
| `Web2ProductsCache`                        | [web2-products-cache.js](../../web2/shared/web2-products-cache.js)                    | Web2 Products — Shared cache + Firestore tickler realtime                                               | 12        |
...
| `Web2SuppliersCache`                       | [web2-suppliers-cache.js](../../web2/shared/web2-suppliers-cache.js)                  | WEB2.0 module.                                                                                          | 7         |
...
| `Web2VariantMulti`                         | [web2-variant-multi.js](../../web2/shared/web2-variant-multi.js)                      | WEB2.0 module.                                                                                          | 3         |
| `Web2VariantsCache`                        | [web2-variants-cache.js](../../web2/shared/web2-variants-cache.js)                    | Web2 Variants — Shared cache + Firestore tickler realtime                                               | 7         |
...
WEB2.0 module.
**Dùng bởi:** `so-order/js/so-order-app.js`, `web2/products/js/web2-products-app.js`, `web2/products/js/web2-products-modal.js`
...
WEB2.0 module.
**Dùng bởi:** `so-order/js/so-order-app.js`, `web2/products/js/web2-products-modal.js`, `web2/products/js/web2-products-state.js`, `web2/products/js/web2-products-variant-picker.js`, `web2/shared/web2-variants-cache.js`
...
**Dùng bởi:** `so-order/js/so-order-app.js`, `web2/products/js/web2-products-actions.js`, `web2/products/js/web2-products-app.js`, `web2/products/js/web2-products-modal.js`, `web2/products/js/web2-products-render.js`, `web2/products/js/web2-products-variant-picker.js`, `web2/purchase-refund/js/purchase-refund-actions.js`, `web2/purchase-refund/js/purchase-refund-api.js`, `web2/purchase-refund/js/purchase-refund-modal.js`, `web2/purchase-refund/js/purchase-refund-render.js`, `web2/supplier-wallet/js/supplier-wallet-actions.js`, `web2/supplier-wallet/js/supplier-wallet-app.js`
...
WEB2.0 module.
**Dùng bởi:** `so-order/js/so-order-app.js`, `web2/balance-history/js/web2-manual-deposit.js`, `web2/products/js/web2-products-app.js`, `web2/products/js/web2-products-state.js`, `web2/purchase-refund/js/purchase-refund-modal.js`, `web2/supplier-debt/js/supplier-debt-filters.js`, `web2/supplier-wallet/js/supplier-wallet-actions.js`
...
WEB2.0 module.
**Dùng bởi:** `so-order/js/so-order-app.js`, `web2/products/js/web2-products-modal.js`, `web2/products/js/web2-products-variant-picker.js`
...
**Dùng bởi:** `so-order/js/so-order-app.js`, `web2/products/js/web2-products-app.js`, `web2/products/js/web2-products-modal.js`, `web2/products/js/web2-products-state.js`, `web2/products/js/web2-products-variant-picker.js`, `web2/shared/web2-variant-multi.js`, `web2/variants/js/web2-variants-app.js`
...
- **[photo-studio-edit.js](../../web2/photo-studio/photo-studio-edit.js)** ·727 — WEB2.0 module.
    - exposes: `PS`
...
- **[photo-studio-state.js](../../web2/photo-studio/photo-studio-state.js)** ·216 — WEB2.0 module.
    - exposes: `PS`
...
- **[photo-studio-ui.js](../../web2/photo-studio/photo-studio-ui.js)** ·698 — WEB2.0 module.
    - exposes: `PS`
...
| `_toast`           | 4       |                                                       | live-hidden-commenters.js, live-livestream-gallery.js, live-livestream-snap.js, web2-msg-template-core.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| `tbody`            | 4       |                                                       | native-orders-app.js, pbh-state.js, web2-products-state.js, web2-variants-app.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
