...
> **Auto-generated** • 2026-06-18 16:04 • 207 files, 75 shared modules, 2547 hàm, 22 file > 800 dòng.
...
**Dùng bởi:** `web2/balance-history/js/web2-bh-render.js`, `web2/customers/js/customers-app.js`, `web2/shared/web2-wallet-balance.js`
...
**Dùng bởi:** `live-chat/js/live/live-comment-list.js`, `live-chat/js/live/live-livestream-gallery.js`, `native-orders/js/native-orders-app.js`, `so-order/js/so-order-app.js`, `web2/ck-dashboard/js/ck-dashboard-app.js`, `web2/customers/js/customers-app.js`, `web2/fastsaleorder-delivery/dlv-app.js`, `web2/fastsaleorder-invoice/pbh-actions.js`, `web2/fastsaleorder-refund/rf-app.js`, `web2/jt-tracking/js/jt-tracking-actions.js`, `web2/pancake-settings/js/pancake-settings.js`, `web2/payment-confirm/js/payment-confirm-app.js`, `web2/products/js/web2-products-app.js`, `web2/shared/chat-panel/web2-chat-panel.js`, `web2/shared/page-builder.js`, `web2/shared/web2-lottie.js`, `web2/shared/zalo-chat/chat-actions.js`, `web2/users/js/users-app.js`, `web2/variants/js/web2-variants-app.js`
...
- **[web2-bh-chat-export.js](../../web2/balance-history/js/web2-bh-chat-export.js)** ·150 — WEB2.0 module.
    - exposes: `W2BH`
    - uses shared: `Web2CustomerChat`
...
- **[web2-pm-core.js](../../web2/balance-history/js/web2-pm-core.js)** ·171 — WEB2.0 module.
    - exposes: `W2PM`
    - uses shared: `Web2Auth`
...
- **[web2-pm-resolve.js](../../web2/balance-history/js/web2-pm-resolve.js)** ·96 — WEB2.0 module.
    - exposes: `W2PM`
...
| ------------------ | ------- | ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `escapeHtml`       | 31      | → `Web2Escape` (web2-escape.js)                       | inventory-panel.js, utils.js, native-orders-app.js, so-order-app.js, web2-bh-core.js, web2-link-customer-modal.js, web2-manual-deposit.js, web2-partner-enricher.js, web2-pm-core.js, web2-customer-wallet-state.js, dlv-app.js, pbh-state.js, rf-app.js, kpi-assignments.js, kpi-dashboard.js, pancake-settings.js, web2-products-app.js, web2-products-print-utils.js, purchase-refund-app.js, reconcile-app.js, page-builder.js, web2-command-palette.js, web2-escape.js, web2-import.js, web2-notification-bell.js, web2-sidebar.js, supplier-debt-app.js, supplier-wallet-app.js, system-services.js, users-app.js, web2-variants-app.js |
...
| `fmtTime`          | 17      | → shared format ngày/giờ GMT+7 (nên gom `Web2Format`) | comments-mobile.js, live-order-history.js, web2-bh-core.js, web2-pm-core.js, ck-dashboard-app.js, web2-customer-wallet-state.js, payment-confirm-app.js, web2-product-detail.js, web2-chat-panel.js, page-builder.js, web2-ck-review.js, web2-unread-panel.js, chat-store.js, supplier-debt-app.js, supplier-wallet-app.js, system-sse.js, web2-zalo-utils.js                                                                                                                                                                                                                                                                                 |
...
| `normPhone`        | 10      | → `Web2CustomerStore` (normPhone)                     | live-kho-enricher.js, web2-partner-enricher.js, web2-customer-wallet-state.js, customers-app.js, web2-ck-review.js, web2-customer-detail-modal.js, web2-customer-store.js, web2-wallet-api.js, web2-wallet-balance.js, web2-zalo.js                                                                                                                                                                                                                                                                                                                                                                                                           |
| `renderPagination` | 10      | → `Web2Page` (page-builder) nếu là list-page          | native-orders-app.js, web2-bh-render.js, web2-customer-wallet-render.js, customers-app.js, dlv-app.js, pbh-render.js, rf-app.js, web2-products-app.js, page-builder.js, supplier-debt-app.js                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `closeModal`       | 9       | → `Web2Page` (page-builder) nếu là list-page          | live-customer-panel.js, web2-link-customer-modal.js, web2-pm-modal.js, customers-app.js, web2-products-app.js, web2-products-print-modal.js, purchase-refund-app.js, page-builder.js, web2-variants-app.js                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| `fmtMoney`         | 8       | → shared format tiền (nên gom `Web2Format`)           | live-order-history.js, customers-app.js, pbh-state.js, rf-app.js, payment-confirm-app.js, purchase-refund-app.js, reconcile-app.js, web2-ck-review.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `renderList`       | 8       | → `Web2Page` (page-builder) nếu là list-page          | web2-customer-wallet-render.js, jt-tracking-render.js, purchase-refund-app.js, reconcile-app.js, returns-tabs.js, web2-command-palette.js, supplier-wallet-app.js, users-app.js                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| `openModal`        | 6       |                                                       | web2-link-customer-modal.js, web2-pm-modal.js, customers-app.js, purchase-refund-app.js, web2-customer-chat.js, web2-quick-reply.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `exportCsv`        | 5       |                                                       | web2-bh-chat-export.js, web2-customer-wallet-events.js, customers-app.js, pbh-actions.js, supplier-debt-app.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| `renderHistory`    | 4       |                                                       | ck-dashboard-app.js, web2-customer-wallet-render.js, kpi-assignments.js, supplier-wallet-app.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
