...
> **Auto-generated** • 2026-06-18 16:39 • 233 files, 75 shared modules, 2547 hàm, 16 file > 800 dòng.
...
| `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`    | [web2-auth.js](../../web2/shared/web2-auth.js)                                        | Token storage + verify + page guard.                                                                    | 84        |
...
| `Web2Chat`                                 | [web2-chat-client.js](../../web2/shared/web2-chat-client.js)                          | Web 2.0 — Chat client (Pancake + Extension)                                                             | 24        |
...
| `Web2ProductsCache`                        | [web2-products-cache.js](../../web2/shared/web2-products-cache.js)                    | Web2 Products — Shared cache + Firestore tickler realtime                                               | 8         |
...
**Dùng bởi:** `live-chat/js/layout/settings-manager.js`, `live-chat/js/live/live-campaign-manager.js`, `live-chat/js/live/live-comment-list.js`, `live-chat/js/live/live-livestream-gallery.js`, `live-chat/js/live/live-livestream-snap.js`, `live-chat/js/pancake/inventory-panel.js`, `live-chat/js/pancake/pancake-context-menu.js`, `native-orders/js/native-orders-app.js`, `so-order/js/so-order-app.js`, `web2/balance-history/js/web2-bh-link-customer.js`, `web2/customer-wallet/js/web2-customer-wallet-app.js`, `web2/customers/js/customers-detail.js`, `web2/fastsaleorder-delivery/dlv-app.js`, `web2/fastsaleorder-invoice/pbh-state.js`, `web2/fastsaleorder-refund/rf-app.js`, `web2/pancake-settings/js/pancake-settings-actions.js`, `web2/payment-confirm/js/payment-confirm-app.js`, `web2/products/js/web2-products-app.js`, `web2/purchase-refund/js/purchase-refund-actions.js`, `web2/reconcile/js/reconcile-actions.js`, `web2/returns/js/returns-tabs.js`, `web2/shared/page-builder.js`, `web2/shared/web2-ck-assign-picker.js`, `web2/shared/web2-export-helpers.js`, `web2/shared/web2-msg-template.js`, `web2/shared/web2-notify.js`, `web2/shared/web2-quick-reply.js`, `web2/shared/web2-return-bill.js`, `web2/shared/web2-sidebar.js`, `web2/shared/zalo-chat/chat-view.js`, `web2/system/js/system-sse.js`, `web2/users/js/users-app.js`, `web2/variants/js/web2-variants-app.js`, `web2/zalo/js/web2-zalo-accounts.js`
...
**Dùng bởi:** `live-chat/js/live/live-comment-list.js`, `live-chat/js/live/live-livestream-gallery.js`, `native-orders/js/native-orders-app.js`, `so-order/js/so-order-app.js`, `web2/ck-dashboard/js/ck-dashboard-app.js`, `web2/customers/js/customers-app.js`, `web2/customers/js/customers-state.js`, `web2/fastsaleorder-delivery/dlv-app.js`, `web2/fastsaleorder-invoice/pbh-actions.js`, `web2/fastsaleorder-refund/rf-app.js`, `web2/jt-tracking/js/jt-tracking-actions.js`, `web2/pancake-settings/js/pancake-settings-actions.js`, `web2/payment-confirm/js/payment-confirm-app.js`, `web2/products/js/web2-products-app.js`, `web2/shared/chat-panel/web2-chat-panel.js`, `web2/shared/page-builder.js`, `web2/shared/web2-lottie.js`, `web2/shared/zalo-chat/chat-actions.js`, `web2/users/js/users-app.js`, `web2/variants/js/web2-variants-app.js`
...
WEB2.0 module.
**Dùng bởi:** `live-chat/js/pancake/inventory-panel.js`, `web2/purchase-refund/js/purchase-refund-api.js`, `web2/supplier-debt/js/supplier-debt-api.js`, `web2/supplier-debt/js/supplier-debt-app.js`, `web2/supplier-wallet/js/supplier-wallet-storage.js`
...
WEB2.0 module.
**Dùng bởi:** `so-order/js/so-order-app.js`, `web2/balance-history/js/web2-manual-deposit.js`, `web2/products/js/web2-products-app.js`, `web2/purchase-refund/js/purchase-refund-modal.js`, `web2/supplier-debt/js/supplier-debt-filters.js`, `web2/supplier-wallet/js/supplier-wallet-actions.js`
...
- **[pancake-settings-render.js](../../web2/pancake-settings/js/pancake-settings-render.js)** ·392 — WEB2.0 module.
...
- **[purchase-refund-modal.js](../../web2/purchase-refund/js/purchase-refund-modal.js)** ·377 — WEB2.0 module.
    - exposes: `PurchaseRefund`
...
| ------------------ | ------- | ----------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `escapeHtml`       | 31      | → `Web2Escape` (web2-escape.js)                       | inventory-panel.js, utils.js, native-orders-app.js, so-order-app.js, web2-bh-core.js, web2-link-customer-modal.js, web2-manual-deposit.js, web2-partner-enricher.js, web2-pm-core.js, web2-customer-wallet-state.js, dlv-app.js, pbh-state.js, rf-app.js, kpi-assignments.js, kpi-dashboard.js, pancake-settings-state.js, web2-products-app.js, web2-products-print-utils.js, purchase-refund-state.js, reconcile-state.js, page-builder.js, web2-command-palette.js, web2-escape.js, web2-import.js, web2-notification-bell.js, web2-sidebar.js, supplier-debt-state.js, supplier-wallet-state.js, system-services.js, users-app.js, web2-variants-app.js |
| `_authHeaders`     | 17      | → `Web2Auth.authHeaders`                              | native-orders-api.js, customers-api.js, pbh-api.js, kpi-dashboard.js, purchase-refund-api.js, web2-api.js, web2-chat-client.js, web2-msg-template.js, web2-notification-bell.js, web2-pancake-accounts.js, web2-quick-reply.js, web2-so-order-reader.js, web2-suppliers-cache.js, web2-wallet-api.js, web2-zalo-api.js, web2-zalo.js, supplier-wallet-storage.js                                                                                                                                                                                                                                                                                            |
...
| `closeModal`       | 9       | → `Web2Page` (page-builder) nếu là list-page          | live-customer-panel.js, web2-link-customer-modal.js, web2-pm-modal.js, customers-detail.js, web2-products-app.js, web2-products-print-modal.js, purchase-refund-modal.js, page-builder.js, web2-variants-app.js                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `applyFilters`     | 8       | → `Web2Page` (page-builder) nếu là list-page          | native-orders-app.js, dlv-app.js, pbh-filters.js, rf-app.js, web2-products-app.js, purchase-refund-render.js, page-builder.js, web2-variants-app.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
