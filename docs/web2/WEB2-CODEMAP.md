...
> **Auto-generated** • 2026-06-18 17:22 • 270 files, 78 shared modules, 2548 hàm, 12 file > 800 dòng.
...
- **[so-order-barcode.js](../../so-order/js/so-order-barcode.js)** ·258 — WEB2.0 module.
    - exposes: `SoOrder`
    - funcs (4): \_updateBarcodeSummary, openBarcodePrintModal, printBarcodes, printLabelsFromReceivePanel
- **[so-order-bulk-edit.js](../../so-order/js/so-order-bulk-edit.js)** ·87 — WEB2.0 module.
    - exposes: `SoOrder`
    - funcs (5): commitBulkEditField, onBulkEditChange, onBulkEditFocusIn, onBulkEditKeydown, onPick
- **[so-order-confirm.js](../../so-order/js/so-order-confirm.js)** ·192 — WEB2.0 module.
    - exposes: `SoOrder`
    - funcs (10): close, finish, hideModal, onClick, onKey, render, showModal, soConfirm, soConfirmOpen, update
- **[so-order-delete.js](../../so-order/js/so-order-delete.js)** ·342 — WEB2.0 module.
    - exposes: `SoOrder`
...
- **[so-order-image-modal.js](../../so-order/js/so-order-image-modal.js)** ·138 — WEB2.0 module.
    - exposes: `SoOrder`
...
- **[so-order-import.js](../../so-order/js/so-order-import.js)** ·237 — WEB2.0 module.
    - exposes: `SoOrder`
    - uses shared: `Web2Import`
    - funcs (3): \_commitSoImport, \_normImportDate, \_soImportConfig
- **[so-order-inline-edit.js](../../so-order/js/so-order-inline-edit.js)** ·430 — WEB2.0 module.
    - exposes: `SoOrder`
...
- **[so-order-kho-sync.js](../../so-order/js/so-order-kho-sync.js)** ·371 — WEB2.0 module.
    - exposes: `SoOrder`
...
- **[so-order-modal-core.js](../../so-order/js/so-order-modal-core.js)** ·478 — WEB2.0 module.
    - exposes: `SoOrder`
...
- **[so-order-modal-image.js](../../so-order/js/so-order-modal-image.js)** ·180 — WEB2.0 module.
    - exposes: `SoOrder`
    - uses shared: `Web2Effects`
...
- **[so-order-modal-open.js](../../so-order/js/so-order-modal-open.js)** ·184 — WEB2.0 module.
    - exposes: `SoOrder`
    - funcs (5): \_applyShipMetaUi, \_shipMetaFlags, onPick, openOrderModal, updateContractHint
- **[so-order-modal-random.js](../../so-order/js/so-order-modal-random.js)** ·128 — WEB2.0 module.
    - exposes: `SoOrder`
    - uses shared: `Web2VariantsCache`
    - funcs (7): \_rImg, \_rInt, \_rPick, \_randomRow, \_variantPools, fillModalRandom, generateRandomOrders
- **[so-order-modal-submit.js](../../so-order/js/so-order-modal-submit.js)** ·277 — WEB2.0 module.
    - exposes: `SoOrder`
    - uses shared: `Web2VariantMulti`
    - funcs (1): handleOrderSubmit
- **[so-order-modal-suggest.js](../../so-order/js/so-order-modal-suggest.js)** ·285 — WEB2.0 module.
    - exposes: `SoOrder`
...
- **[so-order-receive.js](../../so-order/js/so-order-receive.js)** ·736 — WEB2.0 module.
    - exposes: `SoOrder`
...
- **[so-order-render-cells.js](../../so-order/js/so-order-render-cells.js)** ·159 — WEB2.0 module.
    - exposes: `SoOrder`
    - funcs (6): \_isRowLocked, actionsCell, editableCellHtml, imgCell, priceCell, statusCell
- **[so-order-render.js](../../so-order/js/so-order-render.js)** ·746 — WEB2.0 module.
    - exposes: `SoOrder`
...
- **[so-order-settings.js](../../so-order/js/so-order-settings.js)** ·218 — WEB2.0 module.
    - exposes: `SoOrder`
...
- **[so-order-shipment.js](../../so-order/js/so-order-shipment.js)** ·206 — WEB2.0 module.
    - exposes: `SoOrder`
...
- **[so-order-toolbar.js](../../so-order/js/so-order-toolbar.js)** ·90 — WEB2.0 module.
    - exposes: `SoOrder`
...
| `finish`           | 4       |                                                       | live-livestream-gallery.js, live-livestream-snap.js, so-order-confirm.js, so-order-inline-edit.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
