...
> **Auto-generated** • 2026-06-18 23:28 • 296 files, 78 shared modules, 2557 hàm, 7 file > 800 dòng.
...
- **[pancake-token-codec.js](../../live-chat/js/pancake/pancake-token-codec.js)** ·220 — WEB2.0 module.
    - exposes: `PancakeTokenCodec`
    - funcs (5): analyzeToken, base64UrlDecode, cleanToken, decodeToken, isTokenExpired
- **[pancake-token-manager.js](../../live-chat/js/pancake/pancake-token-manager.js)** ·800 — WEB2.0 module.
...
_…và 51 hàm trùng khác (xem web2-codemap.json)._
