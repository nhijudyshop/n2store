...
> **Auto-generated** • 2026-06-18 14:45 • 160 files, 70 shared modules, 2535 hàm, 30 file > 800 dòng.
...
| `Popup`                                    | [popup.js](../../web2/shared/popup.js)                                                | Web 2.0 — Custom Popup (alert / confirm / prompt)                                                       | 33        |
| `Web2Api`                                  | [web2-api.js](../../web2/shared/web2-api.js)                                          | Web 2.0 generic API client — talks to /api/web2/:entity/\*                                              | 1         |
| `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`    | [web2-auth.js](../../web2/shared/web2-auth.js)                                        | Token storage + verify + page guard.                                                                    | 78        |
...
| `Web2CustomerStore`                        | [web2-customer-store.js](../../web2/shared/web2-customer-store.js)                    | WEB2.0 — NGUỒN DUY NHẤT truy cập kho KH web2_customers.                                                 | 5         |
...
| `Web2Escape`                               | [web2-escape.js](../../web2/shared/web2-escape.js)                                    | WEB2.0 module.                                                                                          | 0         |
...
| `Web2WalletBalance`                        | [web2-wallet-balance.js](../../web2/shared/web2-wallet-balance.js)                    | WEB2.0 — shared helper hiển thị số dư ví KH.                                                            | 14        |
...
**Dùng bởi:** `web2/balance-history/js/web2-balance-history-app.js`, `web2/balance-history/js/web2-pending-match.js`, `web2/jt-tracking/js/jt-tracking-app.js`, `web2/shared/web2-customer-detail-modal.js`, `web2/shared/web2-product-counter.js`
...
**Dùng bởi:** `live-chat/js/live/live-api.js`, `live-chat/js/live/live-comment-list.js`, `live-chat/js/shared/live-customer-sync.js`, `live-chat/js/shared/live-status.js`, `web2/shared/web2-customer-lookup.js`
...
**Dùng bởi:** `live-chat/js/live/live-comment-list.js`, `live-chat/js/live/live-livestream-gallery.js`, `native-orders/js/native-orders-app.js`, `so-order/js/so-order-app.js`, `web2/ck-dashboard/js/ck-dashboard-app.js`, `web2/customers/js/customers-app.js`, `web2/fastsaleorder-delivery/dlv-app.js`, `web2/fastsaleorder-invoice/pbh-app.js`, `web2/fastsaleorder-refund/rf-app.js`, `web2/jt-tracking/js/jt-tracking-app.js`, `web2/pancake-settings/js/pancake-settings.js`, `web2/payment-confirm/js/payment-confirm-app.js`, `web2/products/js/web2-products-app.js`, `web2/shared/chat-panel/web2-chat-panel.js`, `web2/shared/page-builder.js`, `web2/shared/web2-lottie.js`, `web2/shared/zalo-chat/chat-actions.js`, `web2/users/js/users-app.js`, `web2/variants/js/web2-variants-app.js`
...
#### `Web2Sidebar` — [web2/shared/web2-sidebar.js](../../web2/shared/web2-sidebar.js) · 620 dòng
...
**Dùng bởi:** `web2/jt-tracking/js/jt-tracking-app.js`, `web2/shared/web2-customer-chat.js`, `web2/shared/zalo-chat/chat-view.js`, `web2/zalo/js/web2-zalo-app.js`
...
### web2/jt-tracking — WEB2.0 — Tra cứu vận đơn J&T (app).

- **[jt-tracking-app.js](../../web2/jt-tracking/js/jt-tracking-app.js)** ⚠️1091 — WEB2.0 — Tra cứu vận đơn J&T (app).
    - uses shared: `API_CONFIG`, `Web2Auth`, `Web2Chat`, `Web2CustomerChat`, `Web2Optimistic`, `Web2Sidebar`, `Web2SSE`, `Web2Zalo`
    - funcs (55): $, AUTHH, ST, \_persistTag, \_saveTagged, api, apply, approvedTag, bring, close, copyText, debounce, deriveFromDesc, destroyLottie, done, esc, fallbackCopy, findMessageInChat, fmtDesc, fmtSrcMsg, getPancakePageIds, icons, init, jtConfirm, load, loadBcTags, loadTagged, markTagged, notify, ok, onEsc, onReady, openChat, openMsgModal, openPasteModal, openTimeline, parseOrderInfo, playLottie, quickAdd, refreshAll, relTime, renderKpi, renderList, resolvePancakeConv, rollback, rowAction, rowHtml, run, scanHistory, scanZalo, setBusy, setTagButtons, tagPancake, timelineHtml, unmarkTagged
...
- **[returns-app.js](../../web2/returns/js/returns-app.js)** ⚠️867 — WEB2.0 module.
    - exposes: `Web2Returns`
    - uses shared: `Popup`, `Web2Sidebar`, `Web2SSE`, `Web2WalletBalance`
    - funcs (38): $, \_typeLabel, approve, bind, buildReasonSelect, canSubmit, clearCustomer, esc, fmt, init, loadCustomerOrders, loadList, loadPending, onCodInput, onCustInput, onIssueChange, onMethodChange, onReasonChange, onReasonShipChange, onSubTypeChange, pickCustomer, pickOrder, removeReturn, renderCodCalc, renderCodWallet, renderList, renderOrderItems, renderOrderSummary, renderPending, renderSummary, resetForm, selectedLines, setLineQty, setupSse, submit, switchTab, toast, toggleLine
...
- **[web2-sidebar.js](../../web2/shared/web2-sidebar.js)** ·620 — WEB2-clone sidebar for Web 2.0 pages.
    - exposes: `Web2Sidebar`
    - uses shared: `DeliveryMethodPicker`, `Popup`, `Web2Auth`, `Web2CommandPalette`, `Web2Lottie`
...
| `authHeaders`      | 13      | → `Web2Auth.authHeaders`                              | native-orders-kpi.js, web2-balance-history-app.js, web2-link-customer-modal.js, web2-manual-deposit.js, web2-pending-match.js, multi-tool.js, payment-confirm-app.js, photo-studio.js, web2-auth.js, web2-ck-assign-picker.js, web2-ck-review.js, web2-customer-store.js, supplier-debt-app.js                                                                                                                                                                                                                                                                                                                                                        |
...
| `renderList`       | 8       | → `Web2Page` (page-builder) nếu là list-page          | web2-customer-wallet-app.js, jt-tracking-app.js, purchase-refund-app.js, reconcile-app.js, returns-app.js, web2-command-palette.js, supplier-wallet-app.js, users-app.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| `switchTab`        | 6       |                                                       | ck-dashboard-app.js, payment-confirm-app.js, returns-app.js, web2-customer-detail-modal.js, web2-import.js, web2-zalo-app.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `toast`            | 6       |                                                       | comments-mobile.js, live-livestream-snap.js, payment-confirm-app.js, returns-app.js, web2-ck-assign-picker.js, web2-ck-review.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| `norm`             | 4       |                                                       | live-init.js, live-customer-sync.js, so-order-app.js, web2-command-palette.js                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
_…và 43 hàm trùng khác (xem web2-codemap.json)._
...
| [web2/jt-tracking/js/jt-tracking-app.js](../../web2/jt-tracking/js/jt-tracking-app.js)                           | 1091 |
...
| [web2/returns/js/returns-app.js](../../web2/returns/js/returns-app.js)                                           | 867  |
