...
> **Auto-generated** • 2026-07-02 02:35 • 469 files, 155 shared modules, 3957 hàm, 20 file > 800 dòng.
...
| `Popup`                                                 | [popup.js](../../web2/shared/popup.js)                                                | Web 2.0 — Custom Popup (alert / confirm / prompt)                                                       | 59        |
...
| `Web2ApiFetch`                                          | [web2-api-fetch.js](../../web2/shared/web2-api-fetch.js)                              | WEB2.0 shared — 1 NGUỒN fetch JSON (auth + fallback base) cho Web 2.0.                                  | 7         |
...
| `Web2AuditLogData`, `Web2AuditLog`                      | [web2-audit-log.js](../../web2/shared/web2-audit-log.js)                              | WEB2.0 module.                                                                                          | 21        |
| `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`                 | [web2-auth.js](../../web2/shared/web2-auth.js)                                        | Token storage + verify + page guard.                                                                    | 154       |
| `Web2AvatarUtils`                                       | [web2-avatar-utils.js](../../web2/shared/web2-avatar-utils.js)                        | WEB2.0 shared module.                                                                                   | 1         |
| `Web2BarcodeScanner`                                    | [web2-barcode-scanner.js](../../web2/shared/web2-barcode-scanner.js)                  | WEB2.0 — Web2BarcodeScanner: quét barcode/QR bằng CAMERA on-device, dùng chung mọi trang.               | 5         |
...
| `Web2Bill`                                              | [web2-bill-service.js](../../web2/shared/web2-bill-service.js)                        | WEB2.0 module.                                                                                          | 4         |
| `Web2CampaignPicker`                                    | [web2-campaign-picker.js](../../web2/shared/web2-campaign-picker.js)                  | WEB2.0 shared.                                                                                          | 4         |
| `Web2Campaign`                                          | [web2-campaign.js](../../web2/shared/web2-campaign.js)                                | WEB2.0 shared.                                                                                          | 6         |
...
| `Web2Chat`                                              | [web2-chat-client.js](../../web2/shared/web2-chat-client.js)                          | WEB2.0 module.                                                                                          | 42        |
...
| `Web2Drawer`                                            | [web2-drawer.js](../../web2/shared/web2-drawer.js)                                    | WEB2.0 — Drawer trượt dùng chung (mọi trang Web 2.0).                                                   | 1         |
| `Web2Effects`                                           | [web2-effects.js](../../web2/shared/web2-effects.js)                                  | Web 2.0 — Effects / animations library                                                                  | 9         |
| `Web2Escape`                                            | [web2-escape.js](../../web2/shared/web2-escape.js)                                    | WEB2.0 module.                                                                                          | 90        |
| `Web2EvidenceCamera`                                    | [web2-evidence-camera.js](../../web2/shared/web2-evidence-camera.js)                  | WEB2.0 module.                                                                                          | 2         |
...
| `Web2Format`                                            | [web2-format.js](../../web2/shared/web2-format.js)                                    | WEB2.0 shared — 1 NGUỒN format tiền/ngày/giờ (GMT+7) cho Web 2.0.                                       | 32        |
...
| `Web2ImageLightbox`                                     | [web2-image-lightbox.js](../../web2/shared/web2-image-lightbox.js)                    | WEB2.0 shared module.                                                                                   | 9         |
...
| `Web2NumberInput`                                       | [web2-number-input.js](../../web2/shared/web2-number-input.js)                        | WEB2.0 shared — 1 NGUỒN format số khi NHẬP (live thousand "." + decimal ",") cho Web 2.0.               | 18        |
| `Web2Optimistic`                                        | [web2-optimistic.js](../../web2/shared/web2-optimistic.js)                            | Codifies pattern: snapshot → apply optimistic UI → fire backend background →                            | 28        |
...
| `Web2Pagination`                                        | [web2-pagination.js](../../web2/shared/web2-pagination.js)                            | WEB2.0 shared — 1 NGUỒN thuật toán + render phân trang.                                                 | 4         |
...
| `Web2Perm`                                              | [web2-perm.js](../../web2/shared/web2-perm.js)                                        | WEB2.0 shared — phân quyền (enforcement).                                                               | 4         |
| `Web2PhoneUtils`                                        | [web2-phone-utils.js](../../web2/shared/web2-phone-utils.js)                          | WEB2.0 shared — 1 NGUỒN chuẩn hoá SĐT VN cho Web 2.0.                                                   | 15        |
| `Web2PinchZoom`                                         | [web2-pinch-zoom.js](../../web2/shared/web2-pinch-zoom.js)                            | WEB2.0 — Pinch-to-zoom ảnh (2 ngón) dùng chung.                                                         | 1         |
...
| `Web2ProductStatus`                                     | [web2-product-status.js](../../web2/shared/web2-product-status.js)                    | WEB2.0 module — 1 NGUỒN trạng thái SP.                                                                  | 3         |
| `Web2ProductTypesCache`                                 | [web2-product-types-cache.js](../../web2/shared/web2-product-types-cache.js)          | WEB2.0 module.                                                                                          | 5         |
| `Web2ProductUnits`                                      | [web2-product-units.js](../../web2/shared/web2-product-units.js)                      | WEB2.0 shared.                                                                                          | 5         |
| `Web2ProductsApi`                                       | [web2-products-api.js](../../web2/shared/web2-products-api.js)                        | WEB2.0 shared — Web2ProductsApi client (1 NGUỒN cho mọi trang dùng Kho SP).                             | 13        |
| `Web2ProductsCache`                                     | [web2-products-cache.js](../../web2/shared/web2-products-cache.js)                    | WEB2.0 module.                                                                                          | 26        |
| `Web2PutWall`                                           | [web2-putwall.js](../../web2/shared/web2-putwall.js)                                  | WEB2.0 shared.                                                                                          | 1         |
...
| `Web2Sidebar`                                           | [web2-sidebar.js](../../web2/shared/web2-sidebar.js)                                  | WEB2-clone sidebar for Web 2.0 pages.                                                                   | 19        |
...
| `Web2SSE`                                               | [web2-sse-bridge.js](../../web2/shared/web2-sse-bridge.js)                            | WEB2.0 module.                                                                                          | 70        |
...
| `Web2UserInfo`                                          | [web2-user-info.js](../../web2/shared/web2-user-info.js)                              | WEB2.0 module.                                                                                          | 26        |
...
#### `Web2BeautyStudio` — [web2/shared/beauty/web2-beauty-studio.js](../../web2/shared/beauty/web2-beauty-studio.js) · 609 dòng
...
#### `Web2ChatEntityDetect` — [web2/shared/chat-panel/web2-chat-entity-detect.js](../../web2/shared/chat-panel/web2-chat-entity-detect.js) · 144 dòng
...
#### `Web2Page` — [web2/shared/page-builder.js](../../web2/shared/page-builder.js) · 742 dòng
...
#### `Web2AiDescribe` — [web2/shared/web2-ai-describe.js](../../web2/shared/web2-ai-describe.js) · 304 dòng
...
**Dùng bởi:** `live-chat/js/live/live-native-orders-api.js`, `native-orders/js/native-orders-api.js`, `web2/product-types/js/web2-product-types-api.js`, `web2/shared/web2-api.js`, `web2/shared/web2-products-api.js`, `web2/shared/web2-sidebar.js`, `web2/variants/js/web2-variants-api.js`

#### `Web2Api` — [web2/shared/web2-api.js](../../web2/shared/web2-api.js) · 97 dòng
...
#### `Web2AuditLogData`, `Web2AuditLog` — [web2/shared/web2-audit-log.js](../../web2/shared/web2-audit-log.js) · 479 dòng

WEB2.0 module.
**Dùng bởi:** `native-orders/js/native-orders-public-api.js`, `so-order/js/so-order-toolbar.js`, `web2/balance-history/js/web2-bh-render.js`, `web2/cham-cong/js/cham-cong-payroll.js`, `web2/customers/js/customers-detail.js`, `web2/fastsaleorder-delivery/dlv-app.js`, `web2/fastsaleorder-refund/rf-app.js`, `web2/fb-posts/js/fb-posts-drafts.js`, `web2/fb-posts/js/fb-posts-list.js`, `web2/jt-tracking/js/jt-tracking-app.js`, `web2/kpi/js/kpi-dashboard.js`, `web2/live-control/js/live-control.js`, `web2/order-tags/js/order-tags-app.js`, `web2/reconcile/js/reconcile-render.js`, `web2/returns/js/returns-app.js`, `web2/shared/page-builder.js`, `web2/shared/web2-ai-page-registry.js`, `web2/shared/web2-sidebar.js`, `web2/supplier-debt/js/supplier-debt-render.js`, `web2/supplier-wallet/js/supplier-wallet-render.js`, `web2/users/js/users-app.js`
...
**Dùng bởi:** `live-chat/js/api-config.js`, `live-chat/js/live/comments-mobile-actions.js`, `live-chat/js/live/comments-mobile-state.js`, `live-chat/js/live/live-api.js`, `live-chat/js/live/live-campaign-manager.js`, `live-chat/js/live/live-comment-list-base.js`, `live-chat/js/live/live-hidden-commenters.js`, `live-chat/js/live/live-init-state.js`, `live-chat/js/live/live-kho-enricher.js`, `live-chat/js/live/live-livestream-snap-lock.js`, `live-chat/js/live/live-livestream-snap-state.js`, `live-chat/js/live/live-native-orders-api.js`, `live-chat/js/live/live-state.js`, `live-chat/js/pancake/inventory-panel-actions.js`, `live-chat/js/pancake/inventory-panel-state.js`, `live-chat/js/pancake/pancake-api.js`, `live-chat/js/pancake/pancake-chat-window.js`, `live-chat/js/pancake/pancake-livestream-filter.js`, `live-chat/js/pancake/pancake-page-access-tokens.js`, `live-chat/js/pancake/pancake-state.js`, `live-chat/js/shared/debt-manager.js`, `live-chat/js/shared/live-comments-stream.js`, `live-chat/js/shared/live-customer-sync.js`, `live-chat/js/shared/utils.js`, `native-orders/js/native-orders-api.js`, `native-orders/js/native-orders-bulk-operations.js`, `native-orders/js/native-orders-customer-panel.js`, `native-orders/js/native-orders-customer360.js`, `native-orders/js/native-orders-inbox-add.js`, `native-orders/js/native-orders-inbox-resolve.js`, `native-orders/js/native-orders-kpi.js`, `native-orders/js/native-orders-pbh-bill.js`, `native-orders/js/native-orders-product-picker.js`, `native-orders/js/native-orders-render.js`, `native-orders/js/native-orders-snapshots.js`, `native-orders/js/native-orders-state.js`, `native-orders/js/native-orders-unit-serials.js`, `so-order/js/so-order-image-manager.js`, `so-order/js/so-order-payments.js`, `so-order/js/so-order-receive.js`, `so-order/js/so-order-state.js`, `so-order/js/so-order-storage-sync.js`, `web2/ai-assistant/js/ai-assistant.js`, `web2/ai-hub/js/ai-hub.js`, `web2/balance-history/js/web2-bh-core.js`, `web2/balance-history/js/web2-link-customer-modal.js`, `web2/balance-history/js/web2-manual-deposit.js`, `web2/balance-history/js/web2-pm-core.js`, `web2/campaign-manager/js/campaign-manager.js`, `web2/cham-cong/js/cham-cong-api.js`, `web2/cham-cong/js/cham-cong-app.js`, `web2/chi-tieu/js/chi-tieu-api.js`, `web2/chi-tieu/js/chi-tieu-app.js`, `web2/ck-dashboard/js/ck-dashboard-app.js`, `web2/clearance/js/clearance.js`, `web2/customer-wallet/js/web2-customer-wallet-api.js`, `web2/customer-wallet/js/web2-customer-wallet-events.js`, `web2/customer-wallet/js/web2-customer-wallet-render.js`, `web2/customer-wallet/js/web2-customer-wallet-state.js`, `web2/customers/js/customers-api.js`, `web2/fastsaleorder-delivery/dlv-app.js`, `web2/fastsaleorder-invoice/pbh-api.js`, `web2/fastsaleorder-invoice/pbh-state.js`, `web2/fastsaleorder-refund/rf-app.js`, `web2/fb-ads-stats/js/fb-ads-manual.js`, `web2/fb-posts/js/fb-posts-composer.js`, `web2/goods-weight/js/goods-weight.js`, `web2/jt-tracking/js/jt-tracking-api.js`, `web2/jt-tracking/js/jt-tracking-constants.js`, `web2/kpi/js/kpi-assignments.js`, `web2/kpi/js/kpi-dashboard.js`, `web2/live-control/js/live-control.js`, `web2/multi-tool/js/multi-tool.js`, `web2/order-tags/js/order-tags-app.js`, `web2/overview/overview.js`, `web2/pancake-settings/js/pancake-settings-api.js`, `web2/pancake-settings/js/pancake-settings-state.js`, `web2/payment-confirm/js/payment-confirm-app.js`, `web2/photo-studio/photo-studio-bg.js`, `web2/photo-studio/photo-studio-state.js`, `web2/product-types/js/web2-product-types-api.js`, `web2/products/js/web2-product-detail.js`, `web2/products/js/web2-products-modal.js`, `web2/products/js/web2-products-print-barcode.js`, `web2/products/js/web2-products-print-utils.js`, `web2/products/js/web2-products-state.js`, `web2/purchase-refund/js/purchase-refund-api.js`, `web2/purchase-refund/js/purchase-refund-state.js`, `web2/reconcile/js/reconcile-api.js`, `web2/reconcile/js/reconcile-state.js`, `web2/returns/js/returns-api.js`, `web2/shared/beauty/web2-beauty-face.js`, `web2/shared/chat-panel/web2-chat-panel-state.js`, `web2/shared/delivery-method-picker.js`, `web2/shared/web2-ai-assistant.js`, `web2/shared/web2-ai-describe.js`, `web2/shared/web2-ai-page-registry.js`, `web2/shared/web2-api-fetch.js`, `web2/shared/web2-api.js`, `web2/shared/web2-attendance-installer.js`, `web2/shared/web2-audit-log.js`, `web2/shared/web2-avatar-utils.js`, `web2/shared/web2-bgremover.js`, `web2/shared/web2-campaign.js`, `web2/shared/web2-chat-utils.js`, `web2/shared/web2-ck-assign-picker.js`, `web2/shared/web2-ck-review.js`, `web2/shared/web2-customer-chat-core.js`, `web2/shared/web2-customer-detail-modal.js`, `web2/shared/web2-customer-store.js`, `web2/shared/web2-evidence-camera.js`, `web2/shared/web2-fb-client.js`, `web2/shared/web2-gemini-client.js`, `web2/shared/web2-html-skill.js`, `web2/shared/web2-kpi.js`, `web2/shared/web2-msg-template-core.js`, `web2/shared/web2-notification-bell.js`, `web2/shared/web2-order-tag-detail.js`, `web2/shared/web2-pancake-accounts.js`, `web2/shared/web2-perm.js`, `web2/shared/web2-printer.js`, `web2/shared/web2-product-counter.js`, `web2/shared/web2-product-units.js`, `web2/shared/web2-products-api.js`, `web2/shared/web2-qr-modal.js`, `web2/shared/web2-quick-reply.js`, `web2/shared/web2-realtime.js`, `web2/shared/web2-return-bill.js`, `web2/shared/web2-sidebar.js`, `web2/shared/web2-so-order-reader.js`, `web2/shared/web2-sse-bridge.js`, `web2/shared/web2-suppliers-cache.js`, `web2/shared/web2-translate.js`, `web2/shared/web2-tryon.js`, `web2/shared/web2-unread-panel.js`, `web2/shared/web2-user-info.js`, `web2/shared/web2-user-profile.js`, `web2/shared/web2-video-render.js`, `web2/shared/web2-vieneu.js`, `web2/shared/web2-wallet-api.js`, `web2/shared/web2-wallet-balance.js`, `web2/shared/web2-zalo-api.js`, `web2/shared/web2-zalo.js`, `web2/supplier-debt/js/supplier-debt-actions.js`, `web2/supplier-debt/js/supplier-debt-api.js`, `web2/supplier-wallet/js/supplier-wallet-storage.js`, `web2/system/js/system-services.js`, `web2/system/js/system-sse.js`, `web2/users/js/users-app.js`, `web2/variants/js/web2-variants-api.js`, `web2/video-maker/js/video-ai-script.js`, `web2/video-maker/js/video-stock.js`, `web2/video-maker/js/video-tts.js`, `web2/zalo/js/web2-zalo-app.js`
...
**Dùng bởi:** `web2/reconcile/js/reconcile-app.js`, `web2/returns/js/returns-scenario.js`, `web2/shared/web2-label-ocr.js`, `web2/shared/web2-pack-counter.js`, `web2/unit-scan/js/unit-scan.js`
...
#### `Web2Bill` — [web2/shared/web2-bill-service.js](../../web2/shared/web2-bill-service.js) · 814 dòng

WEB2.0 module.
**Dùng bởi:** `native-orders/js/native-orders-inbox-add.js`, `native-orders/js/native-orders-packing-slip.js`, `native-orders/js/native-orders-pbh-bill.js`, `web2/fastsaleorder-invoice/pbh-actions.js`

#### `Web2CampaignPicker` — [web2/shared/web2-campaign-picker.js](../../web2/shared/web2-campaign-picker.js) · 297 dòng

WEB2.0 shared.
**Dùng bởi:** `native-orders/js/native-orders-filters-campaigns.js`, `native-orders/js/native-orders-realtime-init.js`, `web2/reconcile/js/reconcile-app.js`, `web2/reconcile/js/reconcile-state.js`

#### `Web2Campaign` — [web2/shared/web2-campaign.js](../../web2/shared/web2-campaign.js) · 250 dòng

WEB2.0 shared.
**Dùng bởi:** `live-chat/js/live/live-campaign-manager.js`, `native-orders/js/native-orders-filters-campaigns.js`, `web2/campaign-manager/js/campaign-manager.js`, `web2/live-control/js/live-control.js`, `web2/live-tv/js/live-tv.js`, `web2/shared/web2-campaign-picker.js`
...
#### `Web2CkReview` — [web2/shared/web2-ck-review.js](../../web2/shared/web2-ck-review.js) · 498 dòng
...
#### `Web2CommandPalette` — [web2/shared/web2-command-palette.js](../../web2/shared/web2-command-palette.js) · 271 dòng

WEB2.0 shared — Command Palette (Ctrl/Cmd+K) toàn cục.
**Dùng bởi:** `web2/shared/web2-sidebar.js`

#### `Web2ContentMaker` — [web2/shared/web2-content-maker.js](../../web2/shared/web2-content-maker.js) · 384 dòng
...
#### `Web2CustomerDetailModal` — [web2/shared/web2-customer-detail-modal.js](../../web2/shared/web2-customer-detail-modal.js) · 423 dòng
...
#### `Web2CustomerStore` — [web2/shared/web2-customer-store.js](../../web2/shared/web2-customer-store.js) · 523 dòng
...
#### `Web2Drawer` — [web2/shared/web2-drawer.js](../../web2/shared/web2-drawer.js) · 228 dòng

WEB2.0 — Drawer trượt dùng chung (mọi trang Web 2.0).
**Dùng bởi:** `web2/goods-weight/js/goods-weight.js`
...
WEB2.0 module.
**Dùng bởi:** `live-chat/js/pancake/inventory-panel-state.js`, `native-orders/js/native-orders-control-drawer.js`, `native-orders/js/native-orders-kpi-health.js`, `native-orders/js/native-orders-kpi.js`, `native-orders/js/native-orders-packing-slip.js`, `native-orders/js/native-orders-state.js`, `so-order/js/so-order-format.js`, `so-order/js/so-order-restock.js`, `web2/ai-hub/js/ai-hub.js`, `web2/balance-history/js/web2-bh-core.js`, `web2/balance-history/js/web2-link-customer-modal.js`, `web2/balance-history/js/web2-manual-deposit.js`, `web2/balance-history/js/web2-partner-enricher.js`, `web2/balance-history/js/web2-pm-core.js`, `web2/campaign-manager/js/campaign-manager.js`, `web2/cham-cong/js/cham-cong-app.js`, `web2/chi-tieu/js/chi-tieu-app.js`, `web2/ck-dashboard/js/ck-dashboard-app.js`, `web2/customer-wallet/js/web2-customer-wallet-state.js`, `web2/customers/js/customers-state.js`, `web2/fastsaleorder-delivery/dlv-app.js`, `web2/fastsaleorder-invoice/pbh-state.js`, `web2/fastsaleorder-refund/rf-app.js`, `web2/fb-ads-stats/js/fb-ads-manual.js`, `web2/fb-ads-stats/js/fb-ads-stats.js`, `web2/fb-insights/js/fb-insights.js`, `web2/fb-posts/js/fb-posts-app.js`, `web2/fb-posts/js/fb-posts-composer.js`, `web2/fb-posts/js/fb-posts-drafts.js`, `web2/fb-posts/js/fb-posts-list.js`, `web2/fb-posts/js/fb-posts-media.js`, `web2/kpi/js/kpi-assignments.js`, `web2/kpi/js/kpi-dashboard.js`, `web2/live-control/js/live-control.js`, `web2/live-tv/js/live-tv.js`, `web2/multi-tool/js/multi-tool.js`, `web2/order-tags/js/order-tags-app.js`, `web2/overview/overview.js`, `web2/pancake-settings/js/pancake-settings-state.js`, `web2/payment-confirm/js/payment-confirm-app.js`, `web2/product-card/js/product-card.js`, `web2/product-types/js/web2-product-types-app.js`, `web2/products/js/web2-product-detail.js`, `web2/products/js/web2-products-print-utils.js`, `web2/products/js/web2-products-state.js`, `web2/purchase-refund/js/purchase-refund-state.js`, `web2/reconcile/js/reconcile-state.js`, `web2/shared/beauty/web2-beauty-studio.js`, `web2/shared/chat-panel/web2-chat-panel-state.js`, `web2/shared/page-builder.js`, `web2/shared/web2-ai-assistant.js`, `web2/shared/web2-ai-describe.js`, `web2/shared/web2-audit-log.js`, `web2/shared/web2-avatar-utils.js`, `web2/shared/web2-ck-assign-picker.js`, `web2/shared/web2-ck-review.js`, `web2/shared/web2-command-palette.js`, `web2/shared/web2-content-maker.js`, `web2/shared/web2-customer-detail-modal.js`, `web2/shared/web2-fb-post-preview.js`, `web2/shared/web2-gemini-chat.js`, `web2/shared/web2-image-lightbox.js`, `web2/shared/web2-image-paste.js`, `web2/shared/web2-import.js`, `web2/shared/web2-kpi.js`, `web2/shared/web2-notification-bell.js`, `web2/shared/web2-order-tag-detail.js`, `web2/shared/web2-order-tag-pill.js`, `web2/shared/web2-product-group.js`, `web2/shared/web2-product-picker.js`, `web2/shared/web2-product-status.js`, `web2/shared/web2-quick-reply.js`, `web2/shared/web2-sidebar.js`, `web2/shared/web2-supplier-pay.js`, `web2/shared/web2-tryon.js`, `web2/shared/web2-unread-panel.js`, `web2/shared/web2-user-profile.js`, `web2/shared/web2-variant-picker.js`, `web2/supplier-debt/js/supplier-debt-state.js`, `web2/supplier-wallet/js/supplier-wallet-state.js`, `web2/system/js/system-ai-suggestions.js`, `web2/system/js/system-dedup.js`, `web2/system/js/system-modules.js`, `web2/system/js/system-services.js`, `web2/system/js/system-sse.js`, `web2/system/js/system-thirdparty.js`, `web2/users/js/users-app.js`, `web2/variants/js/web2-variants-app.js`, `web2/video-maker/js/video-maker.js`, `web2/video-maker/js/video-stock.js`

#### `Web2EvidenceCamera` — [web2/shared/web2-evidence-camera.js](../../web2/shared/web2-evidence-camera.js) · 249 dòng

WEB2.0 module.
**Dùng bởi:** `web2/reconcile/js/reconcile-actions.js`, `web2/reconcile/js/reconcile-app.js`
...
#### `Web2FbPostPreview` — [web2/shared/web2-fb-post-preview.js](../../web2/shared/web2-fb-post-preview.js) · 149 dòng
...
**Dùng bởi:** `so-order/js/so-order-format.js`, `web2/balance-history/js/web2-bh-core.js`, `web2/balance-history/js/web2-link-customer-modal.js`, `web2/balance-history/js/web2-pm-core.js`, `web2/cham-cong/js/cham-cong-salary.js`, `web2/chi-tieu/js/chi-tieu-app.js`, `web2/ck-dashboard/js/ck-dashboard-app.js`, `web2/clearance/js/clearance.js`, `web2/customer-wallet/js/web2-customer-wallet-state.js`, `web2/customers/js/customers-state.js`, `web2/fastsaleorder-delivery/dlv-app.js`, `web2/fastsaleorder-invoice/pbh-state.js`, `web2/fastsaleorder-refund/rf-app.js`, `web2/kpi/js/kpi-assignments.js`, `web2/kpi/js/kpi-dashboard.js`, `web2/payment-confirm/js/payment-confirm-app.js`, `web2/products/js/web2-product-detail.js`, `web2/purchase-refund/js/purchase-refund-state.js`, `web2/reconcile/js/reconcile-state.js`, `web2/shared/page-builder.js`, `web2/shared/web2-ck-assign-picker.js`, `web2/shared/web2-ck-review.js`, `web2/shared/web2-customer-detail-modal.js`, `web2/shared/web2-kpi.js`, `web2/shared/web2-sidebar.js`, `web2/shared/web2-supplier-pay.js`, `web2/shared/web2-unread-panel.js`, `web2/shared/web2-wallet-api.js`, `web2/shared/web2-wallet-balance.js`, `web2/supplier-debt/js/supplier-debt-state.js`, `web2/supplier-wallet/js/supplier-wallet-state.js`, `web2/unit-scan/js/unit-scan.js`

#### `Web2GeminiChat` — [web2/shared/web2-gemini-chat.js](../../web2/shared/web2-gemini-chat.js) · 473 dòng

WEB2.0 shared module.
**Dùng bởi:** `web2/ai-hub/js/ai-gemini-chat.js`, `web2/ai-hub/js/ai-hub.js`

#### `Web2GeminiClient` — [web2/shared/web2-gemini-client.js](../../web2/shared/web2-gemini-client.js) · 242 dòng
...
WEB2.0 shared module.
**Dùng bởi:** `web2/goods-weight/js/goods-weight.js`, `web2/live-tv/js/live-tv.js`, `web2/purchase-refund/js/purchase-refund-state.js`, `web2/reconcile/js/reconcile-api.js`, `web2/reconcile/js/reconcile-render.js`, `web2/shared/chat-panel/web2-chat-panel-compose.js`, `web2/shared/web2-gemini-chat.js`, `web2/shared/web2-image-paste.js`, `web2/shared/web2-sidebar.js`
...
#### `Web2Import` — [web2/shared/web2-import.js](../../web2/shared/web2-import.js) · 597 dòng
...
#### `Web2Kpi` — [web2/shared/web2-kpi.js](../../web2/shared/web2-kpi.js) · 100 dòng
...
#### `Web2LiveTvDisplay` — [web2/shared/web2-live-tv-display.js](../../web2/shared/web2-live-tv-display.js) · 151 dòng
...
#### `Web2NotificationBell` — [web2/shared/web2-notification-bell.js](../../web2/shared/web2-notification-bell.js) · 190 dòng
...
**Dùng bởi:** `live-chat/js/live/live-comment-list-actions.js`, `live-chat/js/live/live-livestream-gallery.js`, `native-orders/js/native-orders-customer-panel.js`, `native-orders/js/native-orders-delivery.js`, `native-orders/js/native-orders-modal-edit.js`, `so-order/js/so-order-kho-sync.js`, `so-order/js/so-order-payments.js`, `web2/ck-dashboard/js/ck-dashboard-app.js`, `web2/customers/js/customers-app.js`, `web2/customers/js/customers-state.js`, `web2/fastsaleorder-delivery/dlv-app.js`, `web2/fastsaleorder-invoice/pbh-actions.js`, `web2/fastsaleorder-refund/rf-app.js`, `web2/jt-tracking/js/jt-tracking-actions.js`, `web2/live-control/js/live-control.js`, `web2/pancake-settings/js/pancake-settings-actions.js`, `web2/payment-confirm/js/payment-confirm-app.js`, `web2/product-types/js/web2-product-types-app.js`, `web2/products/js/web2-product-detail.js`, `web2/products/js/web2-products-actions.js`, `web2/products/js/web2-products-modal.js`, `web2/shared/chat-panel/web2-chat-panel-compose.js`, `web2/shared/page-builder.js`, `web2/shared/web2-lottie.js`, `web2/shared/zalo-chat/chat-actions.js`, `web2/users/js/users-app.js`, `web2/variants/js/web2-variants-app.js`, `web2/zalo/js/web2-zalo-chat.js`

#### `Web2OrderTagDetail` — [web2/shared/web2-order-tag-detail.js](../../web2/shared/web2-order-tag-detail.js) · 387 dòng

WEB2.0 module.
**Dùng bởi:** `native-orders/js/native-orders-public-api.js`, `native-orders/js/native-orders-render.js`

#### `Web2OrderTagPill` — [web2/shared/web2-order-tag-pill.js](../../web2/shared/web2-order-tag-pill.js) · 95 dòng
...
#### `Web2Pagination` — [web2/shared/web2-pagination.js](../../web2/shared/web2-pagination.js) · 99 dòng

WEB2.0 shared — 1 NGUỒN thuật toán + render phân trang.
**Dùng bởi:** `native-orders/js/native-orders-render.js`, `web2/products/js/web2-products-render.js`, `web2/shared/page-builder.js`, `web2/shared/web2-sidebar.js`
...
#### `Web2Perm` — [web2/shared/web2-perm.js](../../web2/shared/web2-perm.js) · 232 dòng

WEB2.0 shared — phân quyền (enforcement).
**Dùng bởi:** `web2/campaign-manager/js/campaign-manager.js`, `web2/overview/overview.js`, `web2/shared/web2-sidebar.js`, `web2/shared/web2-tryon.js`

#### `Web2PhoneUtils` — [web2/shared/web2-phone-utils.js](../../web2/shared/web2-phone-utils.js) · 53 dòng

WEB2.0 shared — 1 NGUỒN chuẩn hoá SĐT VN cho Web 2.0.
**Dùng bởi:** `live-chat/js/live/live-kho-enricher.js`, `live-chat/js/pancake/pancake-livestream-filter.js`, `web2/balance-history/js/web2-bh-core.js`, `web2/balance-history/js/web2-partner-enricher.js`, `web2/balance-history/js/web2-pm-core.js`, `web2/customer-wallet/js/web2-customer-wallet-state.js`, `web2/shared/chat-panel/web2-chat-entity-detect.js`, `web2/shared/web2-ck-review.js`, `web2/shared/web2-customer-detail-modal.js`, `web2/shared/web2-customer-store.js`, `web2/shared/web2-return-bill.js`, `web2/shared/web2-sidebar.js`, `web2/shared/web2-wallet-api.js`, `web2/shared/web2-wallet-balance.js`, `web2/shared/web2-zalo.js`

#### `Web2PinchZoom` — [web2/shared/web2-pinch-zoom.js](../../web2/shared/web2-pinch-zoom.js) · 134 dòng

WEB2.0 — Pinch-to-zoom ảnh (2 ngón) dùng chung.
**Dùng bởi:** `web2/goods-weight/js/goods-weight.js`

#### `Web2PosInstaller` — [web2/shared/web2-pos-installer.js](../../web2/shared/web2-pos-installer.js) · 268 dòng

WEB2.0 shared — kho đa dụng.
**Dùng bởi:** `web2/shared/web2-tryon.js`, `web2/video-maker/js/video-vieneu.js`

#### `Web2Printer` — [web2/shared/web2-printer.js](../../web2/shared/web2-printer.js) · 782 dòng
...
#### `Web2ProductGroup` — [web2/shared/web2-product-group.js](../../web2/shared/web2-product-group.js) · 100 dòng
...
#### `Web2ProductStatus` — [web2/shared/web2-product-status.js](../../web2/shared/web2-product-status.js) · 159 dòng

WEB2.0 module — 1 NGUỒN trạng thái SP.
...
**Dùng bởi:** `live-chat/js/pancake/inventory-panel-render.js`, `web2/products/js/web2-product-detail.js`, `web2/products/js/web2-products-render.js`
...
#### `Web2ProductUnits` — [web2/shared/web2-product-units.js](../../web2/shared/web2-product-units.js) · 172 dòng

WEB2.0 shared.
**Dùng bởi:** `so-order/js/so-order-barcode.js`, `web2/products/js/web2-products-render.js`, `web2/reconcile/js/reconcile-actions.js`, `web2/shared/web2-unit-reprint.js`, `web2/unit-scan/js/unit-scan.js`

#### `Web2ProductsApi` — [web2/shared/web2-products-api.js](../../web2/shared/web2-products-api.js) · 170 dòng

WEB2.0 shared — Web2ProductsApi client (1 NGUỒN cho mọi trang dùng Kho SP).
**Dùng bởi:** `so-order/js/so-order-barcode.js`, `so-order/js/so-order-kho-sync.js`, `so-order/js/so-order-receive.js`, `so-order/js/so-order-restock.js`, `web2/live-control/js/live-control.js`, `web2/products/js/web2-product-detail.js`, `web2/products/js/web2-products-actions.js`, `web2/products/js/web2-products-modal.js`, `web2/products/js/web2-products-render.js`, `web2/products/js/web2-products-state.js`, `web2/products/js/web2-products-variant-picker.js`, `web2/shared/web2-products-cache.js`, `web2/supplier-wallet/js/supplier-wallet-actions.js`

#### `Web2ProductsCache` — [web2/shared/web2-products-cache.js](../../web2/shared/web2-products-cache.js) · 324 dòng

WEB2.0 module.
**Dùng bởi:** `so-order/js/so-order-app.js`, `so-order/js/so-order-barcode.js`, `so-order/js/so-order-kho-sync.js`, `so-order/js/so-order-modal-core.js`, `so-order/js/so-order-modal-suggest.js`, `so-order/js/so-order-receive.js`, `so-order/js/so-order-render.js`, `so-order/js/so-order-restock.js`, `web2/fb-posts/js/fb-posts-media.js`, `web2/product-card/js/product-card.js`, `web2/products/js/web2-products-actions.js`, `web2/products/js/web2-products-app.js`, `web2/products/js/web2-products-modal.js`, `web2/products/js/web2-products-render.js`, `web2/products/js/web2-products-variant-picker.js`, `web2/purchase-refund/js/purchase-refund-actions.js`, `web2/purchase-refund/js/purchase-refund-api.js`, `web2/purchase-refund/js/purchase-refund-modal.js`, `web2/purchase-refund/js/purchase-refund-render.js`, `web2/shared/web2-ai-page-registry.js`, `web2/shared/web2-product-picker.js`, `web2/shared/web2-smart-cache.js`, `web2/shared/web2-unit-reprint.js`, `web2/supplier-wallet/js/supplier-wallet-actions.js`, `web2/supplier-wallet/js/supplier-wallet-app.js`, `web2/video-maker/js/video-maker.js`

#### `Web2PutWall` — [web2/shared/web2-putwall.js](../../web2/shared/web2-putwall.js) · 130 dòng
...
#### `Web2QrModal` — [web2/shared/web2-qr-modal.js](../../web2/shared/web2-qr-modal.js) · 307 dòng
...
#### `NativeReturnBill` — [web2/shared/web2-return-bill.js](../../web2/shared/web2-return-bill.js) · 103 dòng
...
#### `Web2Tryon` — [web2/shared/web2-tryon.js](../../web2/shared/web2-tryon.js) · 810 dòng

WEB2.0 shared module.
**Dùng bởi:** `web2/ai-hub/js/ai-tryon.js`, `web2/shared/web2-ai-assistant.js`

#### `Web2UnitReprint` — [web2/shared/web2-unit-reprint.js](../../web2/shared/web2-unit-reprint.js) · 291 dòng
...
#### `Web2UnreadPanel` — [web2/shared/web2-unread-panel.js](../../web2/shared/web2-unread-panel.js) · 153 dòng
...
#### `Web2UserProfile` — [web2/shared/web2-user-profile.js](../../web2/shared/web2-user-profile.js) · 481 dòng
...
#### `Web2VariantPicker` — [web2/shared/web2-variant-picker.js](../../web2/shared/web2-variant-picker.js) · 407 dòng
...
#### `Web2WalletApi` — [web2/shared/web2-wallet-api.js](../../web2/shared/web2-wallet-api.js) · 235 dòng
...
#### `Web2WalletBalance` — [web2/shared/web2-wallet-balance.js](../../web2/shared/web2-wallet-balance.js) · 343 dòng
...
#### `Web2ZaloOwner`, `ZaloApi` — [web2/shared/web2-zalo-api.js](../../web2/shared/web2-zalo-api.js) · 273 dòng
...
#### `Web2Zalo` — [web2/shared/web2-zalo.js](../../web2/shared/web2-zalo.js) · 380 dòng
...
- **[comments-mobile-actions.js](../../live-chat/js/live/comments-mobile-actions.js)** ·389 — WEB2.0 module.
    - exposes: `LCM`
    - uses shared: `Web2Auth`, `Web2Chat`, `Web2SSE`
    - funcs (26): applyDelta, enrichDelta, fetchThumbs, getCreatedMs, getPostIds, getStream, getWorkerUrl, livingIds, livingSet, load, loadNativeOrders, loadPosts, mapRow, onDelta, onReconcile, overrideRealCounts, postLiving, primeFromData, realCommentTotal, scheduleLoadNative, shouldAnimateNew, showNewPill, toast, updateLiveTag, updateOrderCounts, wireSse
...
- **[live-campaign-manager.js](../../live-chat/js/live/live-campaign-manager.js)** ·275 — WEB2.0 — XEM comment chiến dịch trong live-chat; TẠO/GÁN/QUẢN LÝ ở trang campaign-manager (1 nguồn).
    - exposes: `LiveCampaignManager`
    - uses shared: `Popup`, `Web2Auth`, `Web2Campaign`
    - funcs (14): API, \_api, \_close, \_injectStyles, \_mount, \_open, \_openManager, \_removeBackBanner, \_render, \_showBackBanner, \_viewCampaign, \_w2AuthHeaders, esc, exitCampaignView
...
- **[live-comment-list-actions.js](../../live-chat/js/live/live-comment-list-actions.js)** ·500 — WEB2.0 module.
    - uses shared: `Web2CustomerStore`, `Web2Optimistic`
    - funcs (18): \_applyBadge, \_setKho, apply, handleSaveToLive, removeComments, rollback, run, saveInlineAddress, saveInlinePhone, selectComment, selectInlineStatus, sendReply, setDebtDisplaySettings, showReplyInput, snapshot, toggleInlineStatusDropdown, updateConnectionStatus, updateSaveButtonToCheckmark
...
- **[live-comment-list-orders.js](../../live-chat/js/live/live-comment-list-orders.js)** ·459 — WEB2.0 module.
...
- **[live-init.js](../../live-chat/js/live/live-init.js)** ·168 — WEB2.0 module.
    - uses shared: `Web2SSE`
    - funcs (23): closeCustomerInfoModal, getCacheStats, getPostIds, getWorkerUrl, handleSaveToLive, initialize, loadComments, mapRow, onDelta, onReconcile, refresh, saveInlineAddress, saveInlinePhone, selectComment, selectInlineStatus, selectStatus, setDebtDisplaySettings, shouldFetch, showCustomerInfo, toggleHideComment, toggleInlineStatusDropdown, toggleStatusDropdown, updateSaveButtonToCheckmark
- **[live-kho-enricher.js](../../live-chat/js/live/live-kho-enricher.js)** ·235 — WEB2.0 — enrich live-chat từ kho khách hàng.
    - exposes: `LiveKhoEnricher`
    - uses shared: `Web2Auth`, `Web2PhoneUtils`
...
- **[live-native-orders-api.js](../../live-chat/js/live/live-native-orders-api.js)** ·126 — Native Orders API (frontend client)
    - exposes: `NativeOrdersApi`
    - uses shared: `Web2ApiFetch`, `API_CONFIG`, `Web2Auth`
...
- **[inventory-panel-render.js](../../live-chat/js/pancake/inventory-panel-render.js)** ·627 — WEB2.0 module.
    - uses shared: `Web2ChatPanel`, `Popup`, `Web2ProductStatus`
...
- **[inventory-panel-state.js](../../live-chat/js/pancake/inventory-panel-state.js)** ·280 — WEB2.0 module.
    - uses shared: `API_CONFIG`, `Web2Escape`, `Web2SoOrder`
...
- **[pancake-livestream-filter.js](../../live-chat/js/pancake/pancake-livestream-filter.js)** ·435 — WEB2.0 module.
    - exposes: `PancakeLivestreamFilter`
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `Web2PhoneUtils`, `Web2SSE`
...
- **[live-comments-stream.js](../../live-chat/js/shared/live-comments-stream.js)** ·204 — LiveCommentsStream — engine realtime comment livestream DÙNG CHUNG
    - exposes: `LiveCommentsStream`
    - uses shared: `Web2Auth`, `Web2SSE`
    - funcs (7): create, cursor, fetchDelta, primeCursor, schedule, start, stop
- **[live-customer-sync.js](../../live-chat/js/shared/live-customer-sync.js)** ·213 — LiveCustomerSync — NGUỒN CHUNG đồng bộ KH giữa 2 trang comment livestream
    - exposes: `LiveCustomerSync`
    - uses shared: `API_CONFIG`, `Web2Auth`, `Web2CustomerStore`
    - funcs (11): authHeaders, enrich, flushHarvest, harvest, norm, pickFb, pickName, pickPageId, pickPhone, post, reset
...
- **[utils.js](../../live-chat/js/shared/utils.js)** ·279 — Shared Utilities for Live-Pancake
    - exposes: `SharedUtils`
    - uses shared: `API_CONFIG`
...
- **[native-orders-api.js](../../native-orders/js/native-orders-api.js)** ·224 — Native Orders — API client cho trang Đơn Web.
    - exposes: `NativeOrdersApi`
    - uses shared: `Web2ApiFetch`, `API_CONFIG`, `Web2Auth`
    - funcs (15): \_authHeaders, \_fetchJson, \_orderTagList, campaigns, createManual, getByUser, getKpiScope, health, list, markPrinted, markProductsPrinted, remove, searchProducts, soanHangPrintEnabled, update
- **[native-orders-bulk-operations.js](../../native-orders/js/native-orders-bulk-operations.js)** ·532 — WEB2.0 module.
    - exposes: `NativeOrders`
    - uses shared: `DeliveryMethodPicker`, `Popup`, `Web2Auth`, `Web2Chat`, `Web2MsgTemplate`
    - funcs (8): bulkCreatePbh, bulkMergeOrders, bulkSendMessage, collect, fmt, getSelectedCodes, unselectAllOrders, updateBulkBar
...
- **[native-orders-control-drawer.js](../../native-orders/js/native-orders-control-drawer.js)** ·452 — WEB2.0 module.
    - exposes: `NativeOrders`
    - uses shared: `Web2Escape`
    - funcs (21): aggregateProducts, card, close, ensureDom, ensureStyles, esc, onBodyClick, open, prodQty, refreshControlDrawer, render, renderProductList, renderProductsTab, renderStatsTab, renderTagsTab, scrollToOrder, tagDetailHtml, tagSummary, toggle, updateBadge, vnd
- **[native-orders-customer-panel.js](../../native-orders/js/native-orders-customer-panel.js)** ·428 — WEB2.0 module.
    - exposes: `NativeOrders`
...
- **[native-orders-filters-campaigns.js](../../native-orders/js/native-orders-filters-campaigns.js)** ·483 — WEB2.0 module.
    - exposes: `NativeOrders`
    - uses shared: `Web2CampaignPicker`, `Web2Campaign`
    - funcs (29): \_searchSuggestItems, \_syncChannelUi, \_tagSummary, \_visibleOrders, applyFilters, applyTagFilter, clearFilters, clearParentSelection, clearTagFilter, firstMatch, hideSearchSuggest, loadAvailableCampaigns, loadCampaignSelection, loadParentCampaigns, mountCampaignPicker, moveSuggestActive, onChange, pickNewestHouseStore, pickSuggestion, reconcileCampaignSelection, renderCampaignDropdown, renderCampaignLabel, renderParentCampaigns, renderSearchSuggest, row, saveCampaignSelection, selectParentCampaign, toggleCampaignDropdown, toggleFilter
- **[native-orders-inbox-add.js](../../native-orders/js/native-orders-inbox-add.js)** ·608 — WEB2.0 module.
    - exposes: `NativeOrders`
    - uses shared: `Web2Auth`, `Web2Bill`, `Web2UserInfo`
...
- **[native-orders-inbox-resolve.js](../../native-orders/js/native-orders-inbox-resolve.js)** ·306 — WEB2.0 module.
    - exposes: `NativeOrders`
    - uses shared: `API_CONFIG`, `Web2Auth`, `Web2Chat`, `Web2CustomerChat`
...
- **[native-orders-kpi-health.js](../../native-orders/js/native-orders-kpi-health.js)** ·220 — WEB2.0 module.
...
- **[native-orders-kpi.js](../../native-orders/js/native-orders-kpi.js)** ·124 — WEB2.0 module.
...
- **[native-orders-modal-edit.js](../../native-orders/js/native-orders-modal-edit.js)** ·502 — WEB2.0 module.
    - exposes: `NativeOrders`
...
- **[native-orders-packing-slip.js](../../native-orders/js/native-orders-packing-slip.js)** ·369 — WEB2.0 module — Phiếu Soạn Hàng cho giỏ hàng (native-orders chưa PBH).
    - exposes: `NativeOrdersPackingSlip`
    - uses shared: `Web2Bill`, `Web2Escape`, `Web2UserInfo`
    - funcs (13): \_buildPrintHTML, \_ensureModal, \_esc, \_isWaiting, \_notify, \_print, \_printViaLocalIframe, \_renderRows, \_seller, \_waitingCodes, close, go, open
- **[native-orders-pbh-bill.js](../../native-orders/js/native-orders-pbh-bill.js)** ⚠️903 — WEB2.0 module.
    - exposes: `NativeOrders`
    - uses shared: `DeliveryMethodPicker`, `Popup`, `Web2Auth`, `Web2Bill`, `Web2Effects`, `Web2NumberInput`, `NativeReturnBill`
    - funcs (30): \_billShipPriceOf, \_buildPbhShape, \_dateInputToIsoWithNowTime, \_doCreatePbh, \_getDeliveryOpts, \_gv, \_markPrintedCodes, \_onSoanHangPrint, bulkPrintBills, cancelOrder, cancelPbh, cancelPbhFromEdit, cleanup, collect, copyCode, createPbh, fmt, goPage, onKey, onMount, onPrint, openCustomFormPopup, openNext, pickedHint, printConfirmedBills, removeOrder, splitOrder, splitPbh, validateOrderForPbh, viewOrderBill
...
- **[native-orders-realtime-init.js](../../native-orders/js/native-orders-realtime-init.js)** ·275 — WEB2.0 module.
    - exposes: `NativeOrders`
    - uses shared: `Web2CkReview`, `Web2CampaignPicker`, `Web2CkAssignPicker`, `Web2SSE`
    - funcs (5): \_loadAndRenderScopeBanner, \_scheduleReload, \_sseConnect, init, onDone
- **[native-orders-render.js](../../native-orders/js/native-orders-render.js)** ⚠️1032 — WEB2.0 module.
    - exposes: `NativeOrders`
    - uses shared: `Web2Auth`, `Web2Effects`, `Web2Kpi`, `Web2NewMsgBadge`, `Web2OrderTagDetail`, `Web2OrderTagPill`, `Web2Pagination`, `Web2WalletBalance`
    - funcs (29): \_autoTagPills, \_buildOrderHtml, \_finalizeRender, \_iconsIn, \_renderExpandRow, \_rowSignature, \_rowTagSignature, \_rowTagTriggers, buildJob, clearCustomerFilter, computeOrderStt, detectCarrier, filterByCustomer, infoText, isAdmin, load, lockKpiBase, onAssign, onClick, onLock, openTagDetail, orderDerivedBadges, renderChunk, renderCounters, renderCustomerChip, renderPagination, renderRows, toggleExpand, web2StatusText
...
- **[native-orders-state.js](../../native-orders/js/native-orders-state.js)** ·426 — WEB2.0 module.
    - exposes: `NativeOrders`
...
- **[so-order-modal-submit.js](../../so-order/js/so-order-modal-submit.js)** ·323 — WEB2.0 module.
    - exposes: `SoOrder`
...
- **[so-order-receive.js](../../so-order/js/so-order-receive.js)** ⚠️817 — WEB2.0 module.
    - exposes: `SoOrder`
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`, `Web2ProductsApi`, `Web2ProductsCache`
...
- **[so-order-restock.js](../../so-order/js/so-order-restock.js)** ·156 — WEB2.0 module — Sổ Order: surface "chờ hàng cần đặt".
    - exposes: `SoOrder`
    - uses shared: `Web2Escape`, `Web2ProductsApi`, `Web2ProductsCache`
    - funcs (5): \_addSelected, \_hide, \_overlay, esc, openRestockModal
...
- **[so-order-toolbar.js](../../so-order/js/so-order-toolbar.js)** ·106 — WEB2.0 module.
    - exposes: `SoOrder`
...
- **[ai-html.js](../../web2/ai-hub/js/ai-html.js)** ·30 — WEB2.0 module.
    ...
    - funcs (2): init, onShow
- **[ai-hub.js](../../web2/ai-hub/js/ai-hub.js)** ·239 — WEB2.0 module.
    - exposes: `AiHub`
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `Web2Escape`, `Web2GeminiChat`
...
- **[web2-bh-core.js](../../web2/balance-history/js/web2-bh-core.js)** ·227 — WEB2.0 module.
    - exposes: `W2BH`
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `Web2Escape`, `Web2Format`, `Web2PhoneUtils`
...
- **[web2-bh-reassign-modal.js](../../web2/balance-history/js/web2-bh-reassign-modal.js)** ·290 — WEB2.0 module.
    - exposes: `W2BH`
    - uses shared: `Web2WalletBalance`
...
- **[web2-link-customer-modal.js](../../web2/balance-history/js/web2-link-customer-modal.js)** ·305 — WEB2.0 — smart customer search modal cho balance-history.
    - exposes: `Web2LinkCustomerModal`
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `PartnerCustomerApi`, `Web2Escape`, `Web2Format`, `Web2WalletBalance`
...
- **[web2-manual-deposit.js](../../web2/balance-history/js/web2-manual-deposit.js)** ·669 — WEB2.0 — manual deposit modal cho balance-history page.
    - exposes: `Web2ManualDeposit`
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `PartnerCustomerApi`, `Web2Escape`, `Web2NumberInput`, `Web2SuppliersCache`
...
- **[web2-partner-enricher.js](../../web2/balance-history/js/web2-partner-enricher.js)** ·153 — WEB2.0 — enrich balance-history rows với trạng thái KH Web 2.0.
    - exposes: `Web2PartnerEnricher`
    - uses shared: `PartnerCustomerApi`, `Web2CustomerStore`, `Web2Escape`, `Web2PhoneUtils`
...
- **[web2-pm-core.js](../../web2/balance-history/js/web2-pm-core.js)** ·181 — WEB2.0 module.
    - exposes: `W2PM`
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `Web2Escape`, `Web2Format`, `Web2PhoneUtils`
...
- **[web2-pm-customer-search.js](../../web2/balance-history/js/web2-pm-customer-search.js)** ·246 — WEB2.0 module.
    - exposes: `W2PM`
...
### web2/campaign-manager — WEB2.0 module — Quản lý chiến dịch livestream (CHA span 2 page). Admin-only. Dùng Web2Campaign + Web2Chat (fetch Pancake 2 page).

- **[campaign-manager.js](../../web2/campaign-manager/js/campaign-manager.js)** ·650 — WEB2.0 module — Quản lý chiến dịch livestream (CHA span 2 page). Admin-only. Dùng Web2Campaign + Web2Chat (fetch Pancake 2 page).
    - uses shared: `Popup`, `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `Web2Campaign`, `Web2Chat`, `Web2Escape`, `Web2Perm`, `Web2Sidebar`
    - funcs (32): $, boot, confirmDanger, dedupeSort, doAssign, doCreate, doDelete, doResync, doUnassign, ensurePosts, esc, filter, fmtDate, icon, isAdmin, loadCampaigns, loadPancakePosts, parseTs, postRowHtml, reloadAll, renderAdd, renderCampaign, renderCreate, renderDetail, renderList, renderPickerInto, subscribeRealtime, toast, trailing, updatePickCount, waitDeps, wireEvents
...
- **[cham-cong-app.js](../../web2/cham-cong/js/cham-cong-app.js)** ⚠️1001 — WEB2.0 module — Chấm công: app core (state + bảng công + import + sync).
    - exposes: `ChamCong`
    - uses shared: `Popup`, `Web2Auth`, `Web2Escape`, `Web2IdbStore`, `Web2Sidebar`, `Web2Skeleton`, `Web2SSE`
    - funcs (36): applyResults, cfgFor, chip, close, confirmBox, curMonthKey, empName, esc, fmtDayHeader, fmtEditTs, init, isFulldaySet, isManualEmp, isVisibleEmp, latestRecordDateKey, listLine, loadAll, monthRange, needsAttendance, normalizeHM24, onclick, openDay, payrollFor, quickFillWork, recordsFor, refreshSyncOnly, renderActive, renderSyncStrip, renderTimesheet, renderTodayHtml, saveDayDetail, setTab, shiftMonth, syncLeaveFromIO, toast, weekdayShort
...
- **[cham-cong-payroll.js](../../web2/cham-cong/js/cham-cong-payroll.js)** ⚠️1072 — WEB2.0 module — Chấm công: tab Bảng lương + modal điều chỉnh.
    - exposes: `ChamCongPayroll`
    - uses shared: `Web2AuditLog`, `Web2Skeleton`
    - funcs (43): CC, add, clickCell, close, collectItems, computeRow, defOf, dmy, doLock, doUnlock, entriesForRender, exportPayroll, fmt, fmtLockTime, hm, isFullDay, isLocked, itemRowHtml, itemRows, lockObj, noteCell, onclick, onerror, onload, openAttendance, openGiamTruModal, openItemsModal, openLuongChinhModal, openOtModal, parseAmt, printPayslip, recompute, render, resolveRow, rowHtml, saveInline, saveInlineNote, sectionHead, snapRow, snapRows, tplShell, wireItems, wireRow
- **[cham-cong-salary.js](../../web2/cham-cong/js/cham-cong-salary.js)** ·310 — WEB2.0 module — Chấm công: tính lương (pure).
    - exposes: `ChamCongSalary`
    - uses shared: `Web2Format`
...
- **[chi-tieu-app.js](../../web2/chi-tieu/js/chi-tieu-app.js)** ·643 — WEB2.0 module — Quản lý chi tiêu: app core.
    - exposes: `ChiTieu`
    - uses shared: `Popup`, `Web2Auth`, `Web2Escape`, `Web2Format`, `Web2ImagePaste`, `Web2NumberInput`, `Web2Sidebar`, `Web2Skeleton`, `Web2SSE`
...
- **[ck-dashboard-app.js](../../web2/ck-dashboard/js/ck-dashboard-app.js)** ·489 — WEB2.0 module — Dashboard đối soát CK.
...
- **[clearance.js](../../web2/clearance/js/clearance.js)** ·257 — WEB2.0 — Kho rớt xả (derived/lazy, 0 cron). Đặc tả: docs/web2/PER-UNIT-QR-PLAN.md
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `Web2Format`, `Web2Sidebar`, `Web2SSE`
...
- **[web2-customer-wallet-api.js](../../web2/customer-wallet/js/web2-customer-wallet-api.js)** ·300 — WEB2.0 module.
    - exposes: `W2CW`
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `PartnerCustomerApi`, `Web2WalletApi`
...
- **[web2-customer-wallet-state.js](../../web2/customer-wallet/js/web2-customer-wallet-state.js)** ·200 — WEB2.0 module.
    - exposes: `W2CW`
    - uses shared: `API_CONFIG`, `Web2Escape`, `Web2Format`, `Web2PhoneUtils`
...
- **[customers-api.js](../../web2/customers/js/customers-api.js)** ·111 — WEB2.0 module — Kho KH warehouse (web2_customers). warehouse riêng.
...
- **[customers-state.js](../../web2/customers/js/customers-state.js)** ·84 — WEB2.0 module — Kho KH warehouse state/constants/utils. warehouse riêng.
    - uses shared: `Web2Escape`, `Web2Format`, `Web2Optimistic`
    - funcs (5): $, esc, fmtMoney, normPhone, notify

### web2/fastsaleorder-delivery

- **[dlv-app.js](../../web2/fastsaleorder-delivery/dlv-app.js)** ·288
    - exposes: `DlvApp`
...
- **[pbh-state.js](../../web2/fastsaleorder-invoice/pbh-state.js)** ·92 — WEB2.0 module.
    - exposes: `PbhState`
    - uses shared: `Popup`, `API_CONFIG`, `Web2Escape`, `Web2Format`
    - funcs (10): $, escapeHtml, fmtDate, fmtMoney, notify, stateBadge, tbody, w2pAlert, w2pConfirm, w2pPrompt

### web2/fastsaleorder-refund

- **[rf-app.js](../../web2/fastsaleorder-refund/rf-app.js)** ·295
    - exposes: `RfApp`
...
- **[fb-ads-manual.js](../../web2/fb-ads-stats/js/fb-ads-manual.js)** ·350 — WEB2.0 — Sổ quảng cáo NHẬP TAY: gắn bài/đợt live + tiền QC + số đơn → tổng hợp ngày/tuần/tháng.
    - exposes: `FBAdsManual`
    - uses shared: `Popup`, `Web2Auth`, `Web2Escape`, `FBPostsApi`
...
- **[fb-ads-stats.js](../../web2/fb-ads-stats/js/fb-ads-stats.js)** ·300 — WEB2.0 — Thống kê quảng cáo FB: ad account insights + campaign breakdown.
    - uses shared: `Web2Escape`, `FBPostsApi`, `Web2Sidebar`, `Web2Skeleton`
...
- **[fb-insights.js](../../web2/fb-insights/js/fb-insights.js)** ·351 — WEB2.0 — Thống kê tương tác FB: tính từ bài đăng (like/cmt/share) + follower.
    - exposes: `Web2FbInsightsData`
    - uses shared: `Web2AiPageRegistry`, `Web2Escape`, `FBPostsApi`, `Web2Sidebar`, `Web2Skeleton`
...
- **[fb-posts-app.js](../../web2/fb-posts/js/fb-posts-app.js)** ·274 — WEB2.0 — Đăng bài FB: orchestrator (sidebar, tabs, kết nối FB, SSE, trạng thái).
    - exposes: `FBPosts`
    - uses shared: `Popup`, `Web2Escape`, `FBPostsApi`, `Web2Sidebar`, `Web2SSE`
    - funcs (12): Api, close, esc, init, loadStatus, notify, onclick, openConnect, renderActive, renderPill, setupSSE, switchTab
- **[fb-posts-composer.js](../../web2/fb-posts/js/fb-posts-composer.js)** ·514 — WEB2.0 — Đăng bài FB: soạn bài (page chips + AI caption + media + lịch + đăng).
    - exposes: `FBPostsComposer`
    - uses shared: `Popup`, `Web2Auth`, `Web2Escape`, `FBPostsApi`, `Web2FbPostPreview`, `Web2FbShare`, `Web2ImagePaste`, `Web2ProductPicker`
...
- **[fb-posts-drafts.js](../../web2/fb-posts/js/fb-posts-drafts.js)** ·191 — WEB2.0 — Đăng bài FB: Lịch & Nháp (agenda theo ngày, sửa/đăng/xoá).
    - exposes: `FBPostsDrafts`
    - uses shared: `Popup`, `Web2AuditLog`, `Web2Escape`, `FBPostsApi`, `Web2Skeleton`
    - funcs (12): Api, S, dayKey, del, esc, load, notify, openHistory, pageNames, render, rowHtml, timeOf
- **[fb-posts-list.js](../../web2/fb-posts/js/fb-posts-list.js)** ·415 — WEB2.0 — Đăng bài FB: quản lý bài viết (liệt kê đã đăng + đã lên lịch, xoá).
    - exposes: `FBPostsList`
    - uses shared: `Popup`, `Web2AuditLog`, `Web2Escape`, `FBPostsApi`
...
- **[fb-posts-media.js](../../web2/fb-posts/js/fb-posts-media.js)** ·203 — WEB2.0 — Đăng bài FB: media picker (URL / upload imgbb / Kho SP).
    - exposes: `FBPostsMedia`
    - uses shared: `Web2Escape`, `FBPostsApi`, `Web2ProductsCache`
...
- **[goods-weight.js](../../web2/goods-weight/js/goods-weight.js)** ·678 — WEB2.0 — Cân nặng hàng khi về kiện.
    - uses shared: `Popup`, `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `Web2Drawer`, `Web2ImageLightbox`, `Web2PinchZoom`, `Web2SSE`
    - funcs (48): $, \_auth, addDays, api, boot, buildMonths, clearMonthActive, clearPhoto, compress, currentMonth, del, delRecord, ensureFilterDrawer, esc, fillUserOptions, fmtDateTime, fmtInt, fmtKg, fmtTime, icons, isAdmin, last12Months, load, loadReport, money, monthRange, onDateChange, onPhoto, onerror, onload, reload, render, renderReport, reportQs, save, saveEditRow, selectMonth, setPreset, setupReport, setupSSE, shipForWeight, showTab, startEditRow, tickClock, toast, todayHCM, token, username
...
- **[kpi-assignments.js](../../web2/kpi/js/kpi-assignments.js)** ·449 — WEB2.0 module.
...
- **[kpi-dashboard.js](../../web2/kpi/js/kpi-dashboard.js)** ·251 — WEB2.0 module.
    - exposes: `Web2KpiData`
    - uses shared: `Web2AiPageRegistry`, `Web2AuditLog`, `API_CONFIG`, `Web2Auth`, `Web2Escape`, `Web2Format`, `Web2Kpi`, `Web2SSE`
...
- **[live-control.js](../../web2/live-control/js/live-control.js)** ⚠️1017 — WEB2.0 — Điều khiển TV livestream (user2): gắn SP vào chiến dịch + nhập số NCC báo (pending_qty).
    - uses shared: `Popup`, `Web2AuditLog`, `WEB2_CONFIG`, `API_CONFIG`, `Web2Campaign`, `Web2Escape`, `Web2LiveTvDisplay`, `Web2Optimistic`, `Web2ProductsApi`, `Web2Sidebar`, `Web2Skeleton`, `Web2SSE`, `Web2VariantGroup`
    - funcs (48): $, \_boardOpBegin, \_boardOpEnd, addGroup, apply, applyRegionFilter, applyTvControlSse, boot, cartAvatarUrl, cartRowHtml, close, computeBoardOp, flatCodes, goTvPage, groupByKey, groupHtml, loadBoard, loadCampaigns, loadPicker, loadTvControl, miniCardHtml, normRegion, onBoardOp, onEsc, onLayoutInput, onSse, onSuccess, openCartDetail, openHistory, pickerItemHtml, refreshPickerAddedFlags, regionChipsHtml, renderBoard, renderPicker, renderTvCtl, rollback, run, runBoardOp, saveTvControl, scheduleBoard, schedulePicker, selectCampaign, setTvLayout, snapshot, toast, tvPaginate, vrowHtml, wire

### web2/live-tv — WEB2.0 — TV livestream board (user1 xem). Realtime, read-only.

- **[live-tv.js](../../web2/live-tv/js/live-tv.js)** ·431 — WEB2.0 — TV livestream board (user1 xem). Realtime, read-only.
...
- **[multi-tool.js](../../web2/multi-tool/js/multi-tool.js)** ·677 — WEB2.0 — trang Đa dụng: tab tiện ích nội bộ. Tab "Tăng comment" = reply_comment qua Web2Chat (như Pancake gõ+Enter).
...
- **[order-tags-app.js](../../web2/order-tags/js/order-tags-app.js)** ·636 — WEB2.0 module.
    ...
    - funcs (36): $, allIconNames, apiGet, apiSend, authHeaders, closeModal, esc, fillForm, groupedTriggers, icons, init, load, loadTriggers, notify, openCreate, openEdit, openHistory, openModal, pill, readForm, removeTag, renderCards, renderIconGrid, renderIconPreview, renderSwatches, renderTriggerReference, renderTriggerSelect, saveModal, setupIconPicker, subscribeSSE, toKebab, togglePrint, toggleTag, updatePreview, usedTriggers, wire

### web2/overview — WEB2.0 module — trang giới thiệu (landing) Web 2.0, phong cách Framer.

- **[overview.js](../../web2/overview/overview.js)** ·637 — WEB2.0 module — trang giới thiệu (landing) Web 2.0, phong cách Framer.
    - uses shared: `Web2Auth`, `Web2Escape`, `Web2Perm`, `Web2UserProfile`
    - funcs (21): apply, boot, canOpen, countUp, esc, firstAccessiblePage, isAdmin, magnetic, navState, observeRise, onScroll, renderAccount, renderEnterButton, renderModules, renderStats, resolveHref, run, step, visibleGroups, wireFilters, wireLogout
...
- **[pancake-settings-state.js](../../web2/pancake-settings/js/pancake-settings-state.js)** ·112 — WEB2.0 module.
...
- **[payment-confirm-app.js](../../web2/payment-confirm/js/payment-confirm-app.js)** ·405 — Web 2.0 — Trang "Xác nhận Chuyển Khoản"
...
- **[photo-studio-state.js](../../web2/photo-studio/photo-studio-state.js)** ·219 — WEB2.0 module.
    - exposes: `PS`
...
- **[product-card.js](../../web2/product-card/js/product-card.js)** ·518 — WEB2.0 module.
...
- **[web2-product-types-api.js](../../web2/product-types/js/web2-product-types-api.js)** ·80 — WEB2.0 module.
    - exposes: `Web2ProductTypesApi`
    - uses shared: `Web2ApiFetch`, `API_CONFIG`, `Web2Auth`
    - funcs (7): \_fetchJson, \_w2Auth, create, health, list, remove, update
- **[web2-product-types-app.js](../../web2/product-types/js/web2-product-types-app.js)** ·394 — WEB2.0 module.
...
- **[web2-product-detail.js](../../web2/products/js/web2-product-detail.js)** ·674 — WEB2.0 module.
    - exposes: `Web2ProductDetail`
    - uses shared: `Web2Auth`, `Web2Escape`, `Web2Format`, `Web2NumberInput`, `Web2Optimistic`, `Web2ProductStatus`, `Web2ProductsApi`, `Web2UserInfo`
    - funcs (37): \_activateTab, \_applySaved, \_ensureWired, \_histEntryHtml, \_pane, \_renderEdit, \_renderHistory, \_renderOrders, \_renderOverview, \_renderTab, \_saveEdit, \_setBadge, \_shellHtml, \_wireRowClick, api, app, apply, close, cssEscape, done, esc, fmt, fmtTime, fmtVnd, headEl, icons, notify, onSuccess, open, originHint, proxyBase, rollback, run, safeImg, snapshot, val, valNum
- **[web2-products-actions.js](../../web2/products/js/web2-products-actions.js)** ·158 — WEB2.0 module.
...
- **[web2-products-modal.js](../../web2/products/js/web2-products-modal.js)** ·784 — WEB2.0 module.
    - exposes: `Web2ProductsCore`
...
- **[web2-products-print-modal.js](../../web2/products/js/web2-products-print-modal.js)** ·621 — WEB2.0 module.
    - exposes: `W2PP`
...
- **[web2-products-print-render.js](../../web2/products/js/web2-products-print-render.js)** ·557 — WEB2.0 module.
    - exposes: `W2PP`
...
- **[web2-products-render.js](../../web2/products/js/web2-products-render.js)** ·561 — WEB2.0 module.
    - exposes: `Web2ProductsCore`
    - uses shared: `Web2Pagination`, `Web2ProductGroup`, `Web2ProductStatus`, `Web2ProductUnits`, `Web2ProductsApi`, `Web2ProductsCache`, `Web2Skeleton`, `Web2VariantGroup`
    - funcs (24): \_attachUnitsForPrint, \_bulkPrint, \_childPanelHtml, \_childRowHtml, \_clearSelection, \_loadUsageForCurrentPage, \_parentDisplayCode, \_parentRowHtml, \_rowActionsHtml, \_rowHtml, \_selectAllVisible, \_statusBadgeHtml, \_toggleSelect, \_updateBulkBar, \_updateRowInPlace, \_updateRowsBatch, \_updateSelectAllState, firstIdx, infoText, load, onClick, renderCounters, renderPagination, renderRows
...
- **[web2-products-variant-picker.js](../../web2/products/js/web2-products-variant-picker.js)** ·352 — WEB2.0 module.
    - exposes: `Web2ProductsCore`
...
- **[purchase-refund-app.js](../../web2/purchase-refund/js/purchase-refund-app.js)** ·114 — WEB2.0 module.
    - exposes: `PurchaseRefund`
...
- **[purchase-refund-state.js](../../web2/purchase-refund/js/purchase-refund-state.js)** ·278 — WEB2.0 module.
    - exposes: `PurchaseRefund`
    - uses shared: `API_CONFIG`, `Web2Auth`, `Web2Escape`, `Web2Format`, `Web2ImageLightbox`, `Web2SoOrderUtils`, `Web2UserInfo`
...
- **[reconcile-actions.js](../../web2/reconcile/js/reconcile-actions.js)** ·751 — WEB2.0 module.
    - exposes: `RC`
    - uses shared: `Popup`, `Web2EvidenceCamera`, `Web2ProductUnits`, `Web2UserInfo`
    - funcs (26): bindAuditUi, cancelPack, closeAuditModal, decrementPick, deliverOrder, fetchAudit, finalize, fmtTsFull, inputToTs, lockBody, normC, onScannerSubmit, openAuditModal, packOrder, pad2, parseUnitScan, renderAuditResults, resetPick, returnFailedOrder, scanToProductCode, selectPbh, shipOrder, syncAuditInputs, toggleManualPick, tsToInput, unlockBody
- **[reconcile-api.js](../../web2/reconcile/js/reconcile-api.js)** ·280 — WEB2.0 module.
    - exposes: `RC`
    - uses shared: `Web2Auth`, `Web2HistoryTimeline`, `Web2ImageLightbox`, `Web2SSE`
    - funcs (10): \_scheduleSseDetail, \_scheduleSseList, fetchSnapshotBlobUrl, fmtSnapTs, historyNote, loadCounts, loadHistory, loadList, loadSnapshots, setupSse
- **[reconcile-app.js](../../web2/reconcile/js/reconcile-app.js)** ·213 — WEB2.0 module.
    - uses shared: `Web2BarcodeScanner`, `Web2CampaignPicker`, `Web2EvidenceCamera`, `Web2HistoryTimeline`, `Web2LabelOcr`
    - funcs (7): \_overlayOpen, bindUi, init, mountCampaignPicker, onChange, onResult, onScan
- **[reconcile-render.js](../../web2/reconcile/js/reconcile-render.js)** ·348 — WEB2.0 module.
    - exposes: `RC`
    - uses shared: `Web2AuditLog`, `Web2ImageLightbox`
    - funcs (6): b, open, renderActionButtons, renderDetail, renderLine, renderList
- **[reconcile-state.js](../../web2/reconcile/js/reconcile-state.js)** ·203 — WEB2.0 module.
    - exposes: `RC`
    - uses shared: `API_CONFIG`, `Web2Auth`, `Web2CampaignPicker`, `Web2Escape`, `Web2Format`, `Web2HistoryTimeline`
    - funcs (10): api, escapeHtml, feedback, fmtDateInvoice, fmtMoney, fmtSttDisplay, fmtTs, focusScanner, notify, recomputeTotals

### web2/returns — WEB2.0 module.

- **[returns-api.js](../../web2/returns/js/returns-api.js)** ·121 — WEB2.0 module.
    - exposes: `Web2ReturnsApi`
    - uses shared: `API_CONFIG`, `Web2Auth`, `Web2UserInfo`
    - funcs (14): \_json, \_user, \_w2Auth, approve, create, customerOrders, decline, list, pending, remove, searchCustomers, searchProducts, sourceOrder, walletBalance
- **[returns-app.js](../../web2/returns/js/returns-app.js)** ·263 — WEB2.0 module.
    - exposes: `Web2Returns`
    - uses shared: `Web2AuditLog`, `Web2NumberInput`, `Web2Sidebar`, `Web2SSE`
...
- **[returns-core.js](../../web2/returns/js/returns-core.js)** ·188 — WEB2.0 module.
    - exposes: `ReturnsCore`
    - funcs (4): $, esc, fmt, toast
- **[returns-customer.js](../../web2/returns/js/returns-customer.js)** ·158 — WEB2.0 module.
    - exposes: `ReturnsCustomer`
    - uses shared: `Web2WalletBalance`
    - funcs (4): clearCustomer, loadCustomerOrders, onCustInput, pickCustomer
- **[returns-form.js](../../web2/returns/js/returns-form.js)** ·270 — WEB2.0 module.
    - exposes: `ReturnsForm`
    - funcs (11): buildReasonSelect, canSubmit, onIssueChange, onMethodChange, onReasonChange, onReasonShipChange, renderSummary, resetForm, scn, selLines, submit
...
- **[returns-scenario.js](../../web2/returns/js/returns-scenario.js)** ·413 — WEB2.0 module — Thu về (scenario-first).
    - exposes: `ReturnsScenario`
    - uses shared: `Web2BarcodeScanner`, `Web2NumberInput`
    - funcs (29): \_mapProduct, \_renderDropdown, \_searchProducts, addManualItem, addReplacement, applyUI, currentScn, onCustomerBearInput, onDispoChange, onFeeBearerChange, onOrphanSearch, onRefundChange, onReplSearch, onScan, onShipFeeInput, onclick, payloadExtras, removeManual, removeRepl, renderGrid, renderManualItems, renderRefundHint, renderReplDiff, renderReplList, scan, selectScenario, setManualQty, setReplQty, show
- **[returns-tabs.js](../../web2/returns/js/returns-tabs.js)** ·264 — WEB2.0 module.
    - exposes: `ReturnsTabs`
    - uses shared: `Popup`, `Web2WalletBalance`
    - funcs (12): \_listParams, \_typeLabel, approve, decline, loadList, loadPending, removeReturn, renderList, renderPending, setFilterChip, setFilterDates, switchTab
...
- **[supplier-debt-state.js](../../web2/supplier-debt/js/supplier-debt-state.js)** ·142 — WEB2.0 module.
    - uses shared: `Web2Escape`, `Web2Format`
...
- **[supplier-wallet-state.js](../../web2/supplier-wallet/js/supplier-wallet-state.js)** ·145 — WEB2.0 module.
    - exposes: `SW_DEBUG`
...
- **[system-ai-suggestions.js](../../web2/system/js/system-ai-suggestions.js)** ·165 — WEB2.0 module.
    - exposes: `SystemAiSuggestions`
    - uses shared: `Web2AiPageRegistry`, `Web2Escape`
    - funcs (12): $, allEntries, buildToolbar, entryCard, esc, hay, modelLabel, reg, reload, renderList, renderSummary, start
- **[system-app.js](../../web2/system/js/system-app.js)** ·210 — Mount sidebar, điều phối tab (Dịch vụ / Realtime SSE / Các trang), build danh
    - uses shared: `Web2Sidebar`
    - funcs (9): $, \_cleanLabel, \_esc, \_parseLink, activate, buildPages, init, wireReload, wireTabs
- **[system-dedup.js](../../web2/system/js/system-dedup.js)** ·231 — Audit các chỗ TRÙNG CHỨC NĂNG trong Web 2.0 + hướng gộp về 1 nguồn (single source).
    - exposes: `SystemDedup`
    - uses shared: `Web2Escape`
    - funcs (12): $, card, catLabel, esc, groups, load, matchQ, renderAll, renderBody, renderSummary, renderToolbar, start
- **[system-modules.js](../../web2/system/js/system-modules.js)** ·323 — Tổng hợp TOÀN BỘ module Web 2.0: shared (web2/shared) + trang + backend (Render).
    - exposes: `SystemModules`
    - uses shared: `Popup`, `Web2Escape`
...
- **[system-services.js](../../web2/system/js/system-services.js)** ·629 — Fetch /api/services-overview + render cards (DB + service inventory + process).
    - exposes: `SystemServices`
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `Web2Escape`, `Web2Skeleton`
    - funcs (30): $, \_ensureModal, \_kvRows, \_scheduleRefresh, \_stopRefresh, \_wireClicks, clearFirstLoadSkeletons, closeModal, escapeHtml, fmtBytes, fmtNumber, fmtV, getData, handler, keyHandler, load, openAllTablesModal, openModal, openServiceModal, openTableModal, reload, renderAll, renderCostSummary, renderDatabases, renderGeminiMachines, renderProcess, renderSepayInvoices, renderServices, showFirstLoadSkeletons, start
...
- **[system-sse.js](../../web2/system/js/system-sse.js)** ·412 — Đọc/hiển thị live SSE activity từ server. Tách từ admin-sse-monitor/js/monitor.js;
    - exposes: `SystemSSE`
    - uses shared: `Popup`, `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `Web2Escape`, `Web2Skeleton`
...
- **[system-thirdparty.js](../../web2/system/js/system-thirdparty.js)** ·305 — Tổng hợp TOÀN BỘ dịch vụ / API / thư viện / dự án GitHub / hạ tầng bên thứ 3 dùng
...
### web2/unit-scan — WEB2.0 — Quét tem (gộp bỏ tab 2026-06-29): 1 VIEW DUY NHẤT. Quét 1 món → hero "Bỏ vào KỆ X · STT · 📍 Hàng·Cột" + chi tiết SP (in lại, sibli

- **[unit-scan.js](../../web2/unit-scan/js/unit-scan.js)** ⚠️1403 — WEB2.0 — Quét tem (gộp bỏ tab 2026-06-29): 1 VIEW DUY NHẤT. Quét 1 món → hero "Bỏ vào KỆ X · STT · 📍 Hàng·Cột" + chi tiết SP (in lại, sibling, đơn, lịch sử) Ở
    - uses shared: `Web2BarcodeScanner`, `Web2Format`, `Web2ProductUnits`, `Web2PutWall`, `Web2ShelfMap`, `Web2SSE`
    - funcs (71): $, PU, SM, \_mCard, addToBatch, beep, boot, buildKes, buildPrintProducts, buildScanner, clearBatch, clearHot, close, closeDrawer, closeSheet, esc, flashScan, fmtTime, fmtVnd, go, heroHtml, hideCamRetry, icons, initScanner, initSse, kDone, keColor, keHero, keOf, keOfStt, loadEvents, loadSiblings, loadStore, locate, markSorted, oDone, onKey, onScan, openBatchMap, openCellDetail, openDrawer, openKe, openManifest, openPutwallSettings, parseScan, posLine, printBatch, queueResolve, readForm, refreshKeCard, removeFromBatch, renderBatch, renderGrid, renderPrinted, renderResult, renderStats, reprintGroup, reprintUnit, resolve, saveBatch …

### web2/users — WEB2.0 module.

- **[users-app.js](../../web2/users/js/users-app.js)** ⚠️984 — WEB2.0 module.
...
- **[web2-variants-api.js](../../web2/variants/js/web2-variants-api.js)** ·90 — Web2 Variants API client — /api/web2/variants/\* qua Cloudflare Worker.
    - exposes: `Web2VariantsApi`
    - uses shared: `Web2ApiFetch`, `API_CONFIG`, `Web2Auth`
    - funcs (9): \_fetchJson, \_w2Auth, backfillShortCodes, create, health, list, remove, suggestShortCode, update
- **[web2-variants-app.js](../../web2/variants/js/web2-variants-app.js)** ·513 — Kho Biến Thể Web 2.0 — main app: render bảng + CRUD qua modal.
...
- **[video-maker.js](../../web2/video-maker/js/video-maker.js)** ⚠️1618 — WEB2.0 module.
...
- **[video-stock.js](../../web2/video-maker/js/video-stock.js)** ·309 — WEB2.0 module.
...
- **[web2-zalo-accounts.js](../../web2/zalo/js/web2-zalo-accounts.js)** ·474 — WEB2.0 module.
    - exposes: `WZApp`
    - uses shared: `Popup`, `Web2Ext`, `Web2SSE`, `ZaloApi`
    - funcs (24): \_ensureGlobalKey, \_loginKey, \_oa, \_personal, \_showOpts, \_stopQr, accCardHtml, autoCookieIfDetected, autoTryCookieInModal, closeLogin, closeOaModal, doCookieLogin, heroLoginHtml, loadAccounts, oaChoiceHtml, onAccAction, onQrEvent, openLogin, openOaModal, renderAccounts, renderRailHealth, saveOa, skelCards, startQrLogin
- **[web2-zalo-app.js](../../web2/zalo/js/web2-zalo-app.js)** ·220 — WEB2.0 module — Zalo single-source page app.
    - exposes: `WZApp`
    - uses shared: `Web2Auth`, `Web2SSE`, `Web2ZaloOwner`, `Web2Zalo`
    - funcs (10): applyAdminGate, bind, focusTab, gridActivate, init, isAdmin, refAcc, refList, subscribeSse, switchTab
- **[web2-zalo-chat.js](../../web2/zalo/js/web2-zalo-chat.js)** ·330 — WEB2.0 module.
    - exposes: `WZApp`
...
- **[web2-beauty-studio.js](../../web2/shared/beauty/web2-beauty-studio.js)** ·609 — WEB2.0 shared — beauty studio UI.
    - exposes: `Web2BeautyStudio`
    - uses shared: `Web2BeautyFace`, `Web2BeautyFilters`, `Web2Escape`
...
- **[web2-chat-entity-detect.js](../../web2/shared/chat-panel/web2-chat-entity-detect.js)** ·144 — WEB2.0 — nhận diện SĐT + địa chỉ trong tin nhắn chat (Feature 3).
    - exposes: `Web2ChatEntityDetect`
    - uses shared: `Web2PhoneUtils`
...
- **[web2-chat-panel-state.js](../../web2/shared/chat-panel/web2-chat-panel-state.js)** ·204 — WEB2.0 module.
    - uses shared: `Web2ChatPanel`, `API_CONFIG`, `Web2Chat`, `Web2Escape`
...
- **[page-builder.js](../../web2/shared/page-builder.js)** ·742 — Web 2.0 generic CRUD page builder — same look as WEB2 list views.
    - exposes: `Web2Page`
    - uses shared: `Popup`, `Web2Api`, `Web2AuditLog`, `Web2Escape`, `Web2Format`, `Web2Optimistic`, `Web2Pagination`, `Web2SSE`
...
- **[web2-ai-assistant.js](../../web2/shared/web2-ai-assistant.js)** ⚠️1337 — WEB2.0 shared module.
    - exposes: `Web2AiAssistant`
    - uses shared: `Web2AiDescribe`, `Web2AiPageRegistry`, `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `Web2ContentMaker`, `Web2Escape`, `Web2SmartCache`, `Web2Tryon`
...
- **[web2-ai-describe.js](../../web2/shared/web2-ai-describe.js)** ·304 — WEB2.0 shared module.
    - exposes: `Web2AiDescribe`
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `Web2Escape`
...
- **[web2-api.js](../../web2/shared/web2-api.js)** ·97 — Web 2.0 generic API client — talks to /api/web2/:entity/\*
    - exposes: `Web2Api`
    - uses shared: `Web2ApiFetch`, `API_CONFIG`, `Web2Auth`, `Web2UserInfo`
...
- **[web2-audit-log.js](../../web2/shared/web2-audit-log.js)** ·479 — WEB2.0 module.
    - exposes: `Web2AuditLogData`, `Web2AuditLog`
    - uses shared: `Web2AiPageRegistry`, `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `Web2Escape`
...
- **[web2-bill-service.js](../../web2/shared/web2-bill-service.js)** ⚠️814 — WEB2.0 module.
    - exposes: `Web2Bill`
    - uses shared: `Web2Printer`, `Web2QR`, `Web2UserInfo`
    - funcs (22): \_buildBillBody, \_esc, \_fmtDate, \_fmtMoney, \_nl2br, \_printViaIframe, \_renderBarcodeSvg, \_renderCodeMarkup, \_shop, cleanup, close, generateHTML, generateImage, getMergedSttDisplay, go, isReturnLine, onKey, onload, openCombinedPrint, openPreview, openPrint, printDocHtml
- **[web2-campaign-picker.js](../../web2/shared/web2-campaign-picker.js)** ·297 — WEB2.0 shared.
    - exposes: `Web2CampaignPicker`
    - uses shared: `Web2Campaign`
    - funcs (17): close, currentCampaign, destroy, emitChange, ensureStyles, esc, getSelection, mount, onChange, onDocDown, open, readSaved, refresh, renderButton, renderList, saveSel, setCampaign
- **[web2-campaign.js](../../web2/shared/web2-campaign.js)** ·250 — WEB2.0 shared.
    - exposes: `Web2Campaign`
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `Web2SSE`
    - funcs (26): CP_BASE, LC_BASE, \_json, \_patch, \_post, addProducts, assignPost, authHeaders, create, getCartDetail, getTvControl, list, listAssignments, listPagePosts, listPosts, listProducts, postsForCampaign, remove, removeProduct, reorder, setPending, setPinned, setTvControl, subscribe, unassignPost, workerBase
...
- **[web2-ck-assign-picker.js](../../web2/shared/web2-ck-assign-picker.js)** ·271 — WEB2.0 — picker gán giao dịch CK (balance-history) cho đơn chưa nhận CK.
...
- **[web2-ck-review.js](../../web2/shared/web2-ck-review.js)** ·498 — WEB2.0 module — đối chiếu & duyệt tín hiệu CK (dùng chung 3 trang).
...
- **[web2-command-palette.js](../../web2/shared/web2-command-palette.js)** ·271 — WEB2.0 shared — Command Palette (Ctrl/Cmd+K) toàn cục.
...
- **[web2-content-maker.js](../../web2/shared/web2-content-maker.js)** ·384 — WEB2.0 shared module.
    - exposes: `Web2ContentMaker`
    - uses shared: `Web2AiDescribe`, `Web2Escape`, `Web2HtmlSkill`, `Web2VideoRender`
...
- **[web2-customer-detail-modal.js](../../web2/shared/web2-customer-detail-modal.js)** ·423 — WEB2.0 — modal chi tiết KH (balance-history). Đọc kho KH chung /api/web2/customers/\*.
...
- **[web2-customer-store.js](../../web2/shared/web2-customer-store.js)** ·523 — WEB2.0 — NGUỒN DUY NHẤT truy cập kho KH web2_customers.
    - exposes: `Web2CustomerStore`
    - uses shared: `API_CONFIG`, `Web2Auth`, `PartnerCustomerApi`, `Web2CustomerLookup`, `Web2PhoneUtils`, `Web2SmartCache`, `Web2SSE`
...
- **[web2-drawer.js](../../web2/shared/web2-drawer.js)** ·228 — WEB2.0 — Drawer trượt dùng chung (mọi trang Web 2.0).
    - exposes: `Web2Drawer`
    - funcs (15): close, create, destroy, ensureStyles, isOpen, lockBody, lucide, onKey, open, setBadge, setBody, setTitle, showToggle, toggle, unlockBody
...
- **[web2-evidence-camera.js](../../web2/shared/web2-evidence-camera.js)** ·249 — WEB2.0 module.
    - exposes: `Web2EvidenceCamera`
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`
    - funcs (14): \_captureKbvision, \_captureWebcam, \_ensureVideoEl, \_findSidecar, \_log, \_probeLocal, blobToBase64, capture, init, onerror, onload, source, stop, warm
...
- **[web2-fb-post-preview.js](../../web2/shared/web2-fb-post-preview.js)** ·149 — WEB2.0 shared — xem trước bài Facebook (giống FB) trước khi đăng.
...
- **[web2-gemini-chat.js](../../web2/shared/web2-gemini-chat.js)** ·473 — WEB2.0 shared module.
    - exposes: `Web2GeminiChat`
    - uses shared: `Web2AiPresets`, `AiPresets`, `Web2Escape`, `Web2GeminiClient`, `Web2ImageLightbox`, `Web2ImagePaste`
...
- **[web2-gemini-client.js](../../web2/shared/web2-gemini-client.js)** ·242 — WEB2.0 shared module.
...
- **[web2-import.js](../../web2/shared/web2-import.js)** ·597 — WEB2.0 module.
    - exposes: `Web2Import`
    - uses shared: `Web2Escape`
...
- **[web2-kpi.js](../../web2/shared/web2-kpi.js)** ·100 — WEB2.0 module.
    - exposes: `Web2Kpi`
...
- **[web2-live-tv-display.js](../../web2/shared/web2-live-tv-display.js)** ·151 — WEB2.0 shared — quy tắc HIỂN THỊ màn TV livestream.
    - exposes: `Web2LiveTvDisplay`
    - uses shared: `Web2VariantGroup`
    - funcs (4): cardState, khConModel, orderForDisplay, paginate
...
- **[web2-notification-bell.js](../../web2/shared/web2-notification-bell.js)** ·190
...
- **[web2-order-tag-detail.js](../../web2/shared/web2-order-tag-detail.js)** ·387 — WEB2.0 module.
...
- **[web2-order-tag-pill.js](../../web2/shared/web2-order-tag-pill.js)** ·95 — WEB2.0 module.
...
- **[web2-pagination.js](../../web2/shared/web2-pagination.js)** ·99 — WEB2.0 shared — 1 NGUỒN thuật toán + render phân trang.
    - exposes: `Web2Pagination`
    - funcs (4): goAttr, html, render, windowOf
...
- **[web2-perm.js](../../web2/shared/web2-perm.js)** ·232 — WEB2.0 shared — phân quyền (enforcement).
    - exposes: `Web2Perm`
    - uses shared: `Web2Auth`, `Web2Sidebar`
    - funcs (13): \_block, \_resolveOur, \_runGuard, \_user, \_waitAndGuard, can, canView, canViewUrl, firstPermittedUrl, isAdmin, isAdminOnlySlug, isAdminOnlyUrl, slugFromUrl
- **[web2-phone-utils.js](../../web2/shared/web2-phone-utils.js)** ·53 — WEB2.0 shared — 1 NGUỒN chuẩn hoá SĐT VN cho Web 2.0.
    - exposes: `Web2PhoneUtils`
    - uses shared: `Web2CustomerStore`
    - funcs (4): display, isMobile, isValid, norm
- **[web2-pinch-zoom.js](../../web2/shared/web2-pinch-zoom.js)** ·134 — WEB2.0 — Pinch-to-zoom ảnh (2 ngón) dùng chung.
    - exposes: `Web2PinchZoom`
    - funcs (12): apply, clampPan, destroy, dist, frame, isZoomed, midIn, mount, onEnd, onMove, onStart, reset
- **[web2-pos-installer.js](../../web2/shared/web2-pos-installer.js)** ·268 — WEB2.0 shared — kho đa dụng.
...
- **[web2-printer.js](../../web2/shared/web2-printer.js)** ·782 — WEB2.0 — DANH SÁCH máy in + gán máy in theo chức năng + in ESC/POS raster qua print-bridge.
    - exposes: `Web2Printer`
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `Web2SSE`
    - funcs (42): \_ascii, \_b64, \_bridgeOk, \_canvasToEscpos, \_canvasToTsplBitmap, \_defaultPrinterIdForRole, \_fire, \_genId, \_isLabelLang, \_loadScript, \_migrateToServer, \_printers, \_read, \_recToPrinter, \_w2Auth, bridgeAlive, dotsWidth, effectiveRoleId, escposRasterFromHtml, escposRasterFromHtmlPhysical, escposRasterFromSvg, getPrinter, getPrinterFor, getPrinters, getRoles, loadPrinters, norm, onPrintersChanged, onerror, onload, printBillHtml, printEscpos, printHtml, printSvg, put, removePrinter, resolveBridgeUrl, roleIsBridge, setRole, testConnection, tsplFromHtmlPhysical, upsertPrinter
...
- **[web2-product-group.js](../../web2/shared/web2-product-group.js)** ·100 — WEB2.0 shared.
...
- **[web2-product-status.js](../../web2/shared/web2-product-status.js)** ·159 — WEB2.0 module — 1 NGUỒN trạng thái SP.
    - exposes: `Web2ProductStatus`
    - uses shared: `Web2Escape`
    - funcs (9): chip, esc, isChoHang, isHetHang, isMua1Phan, meta, num, pill, tableBadge
...
- **[web2-product-units.js](../../web2/shared/web2-product-units.js)** ·172 — WEB2.0 shared.
    - exposes: `Web2ProductUnits`
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`
    - funcs (13): URL\_, attachForPrint, base, byProduct, ensure, events, headers, printUnit, reprint, resolve, sortManifest, token, userName
- **[web2-products-api.js](../../web2/shared/web2-products-api.js)** ·170 — WEB2.0 shared — Web2ProductsApi client (1 NGUỒN cho mọi trang dùng Kho SP).
    - exposes: `Web2ProductsApi`
    - uses shared: `Web2ApiFetch`, `API_CONFIG`, `Web2Auth`
    - funcs (16): \_fetchJson, \_w2Auth, adjustPending, adjustStock, confirmPurchase, create, getBatch, health, list, listChildren, listPending, remove, restockNeeded, update, upsertPending, usage
...
- **[web2-putwall.js](../../web2/shared/web2-putwall.js)** ·130 — WEB2.0 shared.
    - exposes: `Web2PutWall`
    - funcs (13): cfg, clear, fire, health, hex, isHttps, isOn, light, lightMany, save, test, urls, willBlock
...
- **[web2-qr-modal.js](../../web2/shared/web2-qr-modal.js)** ·307 — WEB2.0 shared component — reusable QR modal cho customer-wallet + partner-customer.
    - exposes: `Web2QrModal`
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`
...
- **[web2-return-bill.js](../../web2/shared/web2-return-bill.js)** ·103 — WEB2.0 module.
    - exposes: `NativeReturnBill`
    - uses shared: `Popup`, `API_CONFIG`, `Web2Auth`, `Web2PhoneUtils`
    - funcs (5): \_authHeaders, \_normPhone, collect, fetchQueued, onOrder
...
- **[web2-sse-bridge.js](../../web2/shared/web2-sse-bridge.js)** ·328 — WEB2.0 module.
    - exposes: `Web2SSE`
    - uses shared: `WEB2_CONFIG`
    - funcs (13): \_dispatchResync, \_openConnection, \_refreshConnectionForTopicChange, \_scheduleReconnect, \_scheduleResync, close, handleData, onerror, schedule, subscribe, subscribeReload, topics, unsubscribe
...
- **[web2-tryon.js](../../web2/shared/web2-tryon.js)** ⚠️810 — WEB2.0 shared module.
    - exposes: `Web2Tryon`
    - uses shared: `Web2AiDescribe`, `Web2AiPresets`, `AiPresets`, `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `Web2Escape`, `Web2ImagePaste`, `Web2Perm`, `Web2PosInstaller`
...
- **[web2-unit-reprint.js](../../web2/shared/web2-unit-reprint.js)** ·291 — WEB2.0 shared — In lại tem ĐƠN VỊ (per-unit reprint). Đặc tả: docs/web2/PER-UNIT-QR-PLAN.md
...
- **[web2-unread-panel.js](../../web2/shared/web2-unread-panel.js)** ·153 — WEB2.0 — panel "Tin nhắn chưa đọc" dùng chung (gộp từ payment-confirm vào ck-dashboard).
...
- **[web2-user-profile.js](../../web2/shared/web2-user-profile.js)** ·481 — WEB2.0 module — Hồ sơ user + đổi avatar DiceBear (dùng chung mọi trang).
    - exposes: `Web2UserProfile`
    - uses shared: `Popup`, `Web2Auth`, `Web2DicebearCustomizer`, `Web2Escape`, `Web2Sidebar`
...
- **[web2-variant-picker.js](../../web2/shared/web2-variant-picker.js)** ·407 — WEB2.0 module.
...
- **[web2-wallet-api.js](../../web2/shared/web2-wallet-api.js)** ·235 — WEB2.0 shared — client ví KH /api/web2/wallets (NGUỒN CHUNG).
    - exposes: `Web2WalletApi`
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `Web2Format`, `Web2PhoneUtils`, `Web2UserInfo`, `Web2WalletBalance`
...
- **[web2-wallet-balance.js](../../web2/shared/web2-wallet-balance.js)** ·343 — WEB2.0 — shared helper hiển thị số dư ví KH.
    - exposes: `Web2WalletBalance`
    - uses shared: `WEB2_CONFIG`, `API_CONFIG`, `Web2Auth`, `Web2CustomerDetailModal`, `Web2Format`, `Web2PhoneUtils`, `Web2SSE`, `Web2WalletApi`
...
- **[web2-zalo-api.js](../../web2/shared/web2-zalo-api.js)** ·273 — WEB2.0 module — ZaloApi wrapper (/api/web2-zalo).
    - exposes: `Web2ZaloOwner`, `ZaloApi`
    - uses shared: `API_CONFIG`, `Web2Auth`
    - funcs (46): \_authHeaders, \_fetch, \_qs, \_zaloOwner, accounts, addQuickReply, backfill, conversations, createAccount, deleteAccount, deleteMessage, disconnect, forward, friends, groupMembers, groups, lease, loadHistory, loginCookie, loginQr, lookup, markConversation, messages, muteConversation, oaConnect, pinConversation, quickReplies, react, recall, release, releaseBeacon, seen, self, sendCs, sendFile, sendImage, sendMessage, sendSticker, sendZns, status, stickers, syncConversations, syncTemplates, typing, znsLog, znsTemplates
...
- **[web2-zalo.js](../../web2/shared/web2-zalo.js)** ·380 — WEB2.0 shared — Web2Zalo helper (single-source Zalo).
    - exposes: `Web2Zalo`
    - uses shared: `API_CONFIG`, `Web2Auth`, `Web2Ext`, `Web2PhoneUtils`, `Web2SSE`, `Web2WalletBalance`, `Web2ZaloOwner`, `ZaloApi`, `WZChat`
...
| ------------------- | ------- | ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ensureStyles`      | 22      | → CSS shared / theme thay vì inject lặp               | native-orders-control-drawer.js, native-orders-kpi-health.js, web2-link-customer-modal.js, web2-manual-deposit.js, web2-pm-modal.js, web2-beauty-studio.js, popup.js, web2-barcode-scanner.js, web2-campaign-picker.js, web2-command-palette.js, web2-customer-chat-core.js, web2-drawer.js, web2-image-editor.js, web2-label-ocr.js, web2-logo-eraser.js, web2-order-tag-detail.js, web2-pack-counter.js, web2-product-counter.js, web2-qr-modal.js, web2-unread-panel.js, web2-wallet-balance.js, web2-zalo.js |
| `toast`             | 21      |                                                       | comments-mobile-actions.js, live-livestream-snap-actions.js, ai-assistant.js, ai-hub.js, campaign-manager.js, cham-cong-app.js, chi-tieu-app.js, clearance.js, goods-weight.js, live-control.js, payment-confirm-app.js, returns-core.js, web2-ai-describe.js, web2-ck-assign-picker.js, web2-ck-review.js, web2-content-maker.js, web2-gemini-chat.js, web2-tryon.js, web2-user-profile.js, unit-scan.js, video-stock.js                                                                                        |
...
| `renderList`        | 15      | → `Web2Page` (page-builder) nếu là list-page          | ai-chat.js, campaign-manager.js, chi-tieu-app.js, clearance.js, web2-customer-wallet-render.js, jt-tracking-render.js, purchase-refund-render.js, reconcile-render.js, returns-tabs.js, web2-campaign-picker.js, web2-command-palette.js, web2-gemini-chat.js, supplier-wallet-render.js, system-ai-suggestions.js, users-app.js                                                                                                                                                                                 |
...
| `isAdmin`           | 12      |                                                       | native-orders-render.js, native-orders-state.js, ai-hub.js, web2-manual-deposit.js, campaign-manager.js, goods-weight.js, overview.js, web2-kpi.js, web2-perm.js, web2-tryon.js, system-sse.js, web2-zalo-app.js                                                                                                                                                                                                                                                                                                 |
| `reload`            | 12      |                                                       | live-livestream-gallery.js, web2-bh-data.js, pbh-app.js, goods-weight.js, live-tv.js, payment-confirm-app.js, web2-audit-log.js, web2-unread-panel.js, chat-view.js, system-ai-suggestions.js, system-services.js, system-sse.js                                                                                                                                                                                                                                                                                 |
...
| `boot`              | 8       |                                                       | campaign-manager.js, clearance.js, goods-weight.js, live-control.js, live-tv.js, overview.js, web2-lottie.js, unit-scan.js                                                                                                                                                                                                                                                                                                                                                                                       |
| `card`              | 8       |                                                       | native-orders-control-drawer.js, clearance.js, fb-ads-manual.js, fb-ads-stats.js, fb-insights.js, web2-qr.js, system-dedup.js, system-thirdparty.js                                                                                                                                                                                                                                                                                                                                                              |
...
| `health`            | 8       |                                                       | native-orders-api.js, web2-product-types-api.js, web2-api.js, web2-gemini-client.js, web2-products-api.js, web2-putwall.js, web2-vieneu.js, web2-variants-api.js                                                                                                                                                                                                                                                                                                                                                 |
...
| `renderAll`         | 7       |                                                       | so-order-render.js, web2-chat-panel-render.js, web2-variant-picker.js, system-dedup.js, system-modules.js, system-services.js, system-thirdparty.js                                                                                                                                                                                                                                                                                                                                                              |
| `rowHtml`           | 7       |                                                       | so-order-render.js, cham-cong-payroll.js, fb-ads-manual.js, fb-posts-drafts.js, jt-tracking-render.js, web2-audit-log.js, web2-product-picker.js                                                                                                                                                                                                                                                                                                                                                                 |
...
| `fmtDate`           | 6       | → shared format ngày/giờ GMT+7 (nên gom `Web2Format`) | campaign-manager.js, web2-customer-wallet-state.js, pbh-state.js, fb-insights.js, multi-tool.js, purchase-refund-state.js                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `openEdit`          | 6       |                                                       | native-orders-modal-edit.js, order-tags-app.js, web2-product-types-app.js, web2-products-modal.js, page-builder.js, web2-variants-app.js                                                                                                                                                                                                                                                                                                                                                                         |
| `parseTs`           | 6       |                                                       | comments-mobile-state.js, campaign-manager.js, fb-insights.js, multi-tool.js, web2-chat-panel-state.js, web2-format.js                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `renderSummary`     | 6       |                                                       | clearance.js, returns-form.js, system-ai-suggestions.js, system-dedup.js, system-modules.js, system-thirdparty.js                                                                                                                                                                                                                                                                                                                                                                                                |
...
| `scan`              | 6       |                                                       | live-kho-enricher.js, native-orders-kpi-health.js, returns-scenario.js, web2-chat-entity-detect.js, web2-effects.js, web2-lottie.js                                                                                                                                                                                                                                                                                                                                                                              |
| `schedule`          | 6       |                                                       | live-comment-list-render-list.js, live-comment-list-state.js, live-comments-stream.js, native-orders-kpi-health.js, photo-studio-edit.js, web2-sse-bridge.js                                                                                                                                                                                                                                                                                                                                                     |
...
| `send`              | 5       |                                                       | pancake-chat-window.js, ai-chat.js, web2-customer-chat-core.js, web2-fb-share.js, web2-gemini-chat.js                                                                                                                                                                                                                                                                                                                                                                                                            |
| `setBusy`           | 5       |                                                       | jt-tracking-actions.js, web2-beauty-studio.js, web2-content-maker.js, web2-image-paste.js, web2-zalo-utils.js                                                                                                                                                                                                                                                                                                                                                                                                    |

_…và 127 hàm trùng khác (xem web2-codemap.json)._
...
| [web2/video-maker/js/video-maker.js](../../web2/video-maker/js/video-maker.js)                 | 1618 |
| [web2/unit-scan/js/unit-scan.js](../../web2/unit-scan/js/unit-scan.js)                         | 1403 |
| [web2/shared/web2-ai-assistant.js](../../web2/shared/web2-ai-assistant.js)                     | 1337 |
| [web2/cham-cong/js/cham-cong-payroll.js](../../web2/cham-cong/js/cham-cong-payroll.js)         | 1072 |
| [so-order/js/so-order-render.js](../../so-order/js/so-order-render.js)                         | 1039 |
| [native-orders/js/native-orders-render.js](../../native-orders/js/native-orders-render.js)     | 1032 |
| [web2/live-control/js/live-control.js](../../web2/live-control/js/live-control.js)             | 1017 |
| [web2/cham-cong/js/cham-cong-app.js](../../web2/cham-cong/js/cham-cong-app.js)                 | 1001 |
| [web2/shared/web2-sidebar.js](../../web2/shared/web2-sidebar.js)                               | 988  |
| [web2/users/js/users-app.js](../../web2/users/js/users-app.js)                                 | 984  |
| [so-order/js/so-order-storage.js](../../so-order/js/so-order-storage.js)                       | 954  |
| [native-orders/js/native-orders-pbh-bill.js](../../native-orders/js/native-orders-pbh-bill.js) | 903  |
| [web2/shared/web2-ai-presets.js](../../web2/shared/web2-ai-presets.js)                         | 897  |
| [so-order/js/so-order-receive.js](../../so-order/js/so-order-receive.js)                       | 817  |
| [web2/shared/web2-effects.js](../../web2/shared/web2-effects.js)                               | 815  |
| [web2/shared/web2-bill-service.js](../../web2/shared/web2-bill-service.js)                     | 814  |
| [web2/shared/web2-tryon.js](../../web2/shared/web2-tryon.js)                                   | 810  |
