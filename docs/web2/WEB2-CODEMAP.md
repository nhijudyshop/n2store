...
> **Auto-generated** • 2026-06-19 05:17 • 352 files, 97 shared modules, 2572 hàm, 0 file > 800 dòng.
...
| `Web2LogoEraser`                           | [web2-logo-eraser.js](../../web2/shared/web2-logo-eraser.js)                          | WEB2.0 shared.                                                                                          | 1         |
...
#### `Web2ImageEditor` — [web2/shared/web2-image-editor.js](../../web2/shared/web2-image-editor.js) · 156 dòng
...
WEB2.0 shared.
**Dùng bởi:** `web2/product-card/js/product-card.js`
...
#### `Web2Sidebar` — [web2/shared/web2-sidebar.js](../../web2/shared/web2-sidebar.js) · 650 dòng
...
- **[photo-editor.js](../../web2/photo-editor/js/photo-editor.js)** ·130 — WEB2.0 module.
    - exposes: `PhotoEditorPage`
    - uses shared: `Web2Escape`, `Web2ImageEditor`, `Web2ProductsCache`
    - funcs (12): $, close, copy, download, edit, esc, fileToDataUrl, init, notify, onload, showResult, wirePicker
...
- **[web2-image-editor.js](../../web2/shared/web2-image-editor.js)** ·156 — WEB2.0 shared.
    - exposes: `Web2ImageEditor`
    - funcs (9): \_load, cleanup, ensureStyles, finish, onClose, onSave, onload, open, tryNext
...
- **[web2-sidebar.js](../../web2/shared/web2-sidebar.js)** ·650 — WEB2-clone sidebar for Web 2.0 pages.
    - exposes: `Web2Sidebar`
...
| ------------------ | ------- | ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ensureStyles`     | 16      | → CSS shared / theme thay vì inject lặp               | web2-link-customer-modal.js, web2-manual-deposit.js, web2-pm-modal.js, popup.js, web2-barcode-scanner.js, web2-command-palette.js, web2-customer-chat-core.js, web2-image-editor.js, web2-label-ocr.js, web2-logo-eraser.js, web2-pack-counter.js, web2-product-counter.js, web2-qr-modal.js, web2-unread-panel.js, web2-wallet-balance.js, web2-zalo.js |
