...
- `buildLabelHTML`: font ×1.3 (`fsBase*1.3`), barcode cao **55% tem** (thay 45%). Content `justify-content: center` (user chốt: canh giữa dọc tem — khối to nhưng không sát mép trên/dưới; bản space-between trước bị sát mép).
