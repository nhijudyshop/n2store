...
# Session Resume — 2026-06-23 02:08:52 +07

**Token**: `RESUME:20260623-020852-a7eef5b`
**Branch**: `main`
**HEAD**: `a7eef5b1e6c8318b647f502151d1fc84e72be277`
**Range**: `4be494a..a7eef5b` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-06-22T19:08:52Z

---

## 1. Summary

fix(web2) customer-orders: ẩn Đơn Web đã convert sang PBH (hết trùng dòng + double-count)
...
- `docs/sessions/20260623-014742-4be494a.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260623-014742-4be494a`](./20260623-014742-4be494a.md)
...
```
RESUME:20260623-020852-a7eef5b
```
