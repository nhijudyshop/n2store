...
**Latest commit**: `fb59af0` — fix(gemini-tryon): bắt trọn log uvicorn (PIPE pump) + đọc/hiện log UTF-8 (hết mojibake)
**Last updated**: 2026-06-27 13:25:51 +07
**Latest session**: [`RESUME:20260627-132551-fb59af0`](../20260627-132551-fb59af0.md)
...
- [`docs/`](./docs.md) — updated 2026-06-27 13:25
...
- [`web2/`](./web2.md) — updated 2026-06-27 13:25
