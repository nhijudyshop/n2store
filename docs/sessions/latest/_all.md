...
**Latest commit**: `37f177d` — feat(inventory): đợt section tabs + stats theo tab + audit logging
**Last updated**: 2026-05-22 11:46:48 +07
**Latest session**: [`RESUME:20260522-114648-37f177d`](../20260522-114648-37f177d.md)
**Summary**: feat(inventory): đợt section tabs + stats theo tab + audit logging

## Folders affected in this commit

- [`docs/`](./docs.md) — 1 file(s)
- [`inventory-tracking/`](./inventory-tracking.md) — 7 file(s)
- [`native-orders/`](./native-orders.md) — 1 file(s)
- [`render.com/`](./render.com.md) — 8 file(s)
- [`so-order/`](./so-order.md) — 1 file(s)
- [`tpos-pancake/`](./tpos-pancake.md) — 1 file(s)
- [`web2/`](./web2.md) — 40 file(s)
...
- [`balance-history/`](./balance-history.md) — updated 2026-05-21 15:39
...
- [`docs/`](./docs.md) — updated 2026-05-22 11:46
...
- [`inventory-tracking/`](./inventory-tracking.md) — updated 2026-05-22 11:46
...
- [`render.com/`](./render.com.md) — updated 2026-05-22 11:46
...
- [`web2/`](./web2.md) — updated 2026-05-22 11:46
