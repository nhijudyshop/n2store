...
**Latest commit**: `5c77fce` — feat(web2/chat): Feature 3 — nhận diện SĐT/địa chỉ trong chat + Thêm vào KH (fill đơn + upsert web2_customers); test OK
**Last updated**: 2026-06-07 15:18:37 +07
**Latest session**: [`RESUME:20260607-151837-5c77fce`](../20260607-151837-5c77fce.md)
...
- [`docs/`](./docs.md) — updated 2026-06-07 15:18
...
- [`native-orders/`](./native-orders.md) — updated 2026-06-07 15:16
...
- [`render.com/`](./render.com.md) — updated 2026-06-07 15:16
...
- [`so-order/`](./so-order.md) — updated 2026-06-07 12:41
