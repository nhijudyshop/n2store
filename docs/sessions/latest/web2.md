...
**Latest session**: `RESUME:20260518-132855-ac0034c`
**Session file**: [`./20260518-132855-ac0034c.md`](../20260518-132855-ac0034c.md)
**Commit**: `ac0034c` — feat(web2/supplier-debt): Mã NCC + sort natural A1-A10-B1 + nút Tạo NCC
...
3. Hoặc paste token `RESUME:20260518-132855-ac0034c` cho Claude walk chain theo CLAUDE.md protocol.
