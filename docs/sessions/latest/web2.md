...
**Latest session**: `RESUME:20260606-140607-723c7d9`
**Session file**: [`./20260606-140607-723c7d9.md`](../20260606-140607-723c7d9.md)
**Commit**: `723c7d9` — feat(web2-products-print): đặt khổ tem rộng 50×30mm làm mặc định
...
3. Hoặc paste token `RESUME:20260606-140607-723c7d9` cho Claude walk chain theo CLAUDE.md protocol.
