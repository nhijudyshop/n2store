...
**Latest session**: `RESUME:20260526-093137-c099ceb`
**Session file**: [`./20260526-093137-c099ceb.md`](../20260526-093137-c099ceb.md)
**Commit**: `c099ceb` — fix(web2/customer-wallet): merge wallet-only customers (KH có ví Web 2 nhưng chưa lập PBH)
...
3. Hoặc paste token `RESUME:20260526-093137-c099ceb` cho Claude walk chain theo CLAUDE.md protocol.
