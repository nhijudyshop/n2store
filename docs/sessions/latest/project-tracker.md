# Latest Snapshot — `project-tracker/`
...
## Files changed in this commit (`project-tracker/`)

- `project-tracker/index.html`

## Last 5 commits touching `project-tracker/`
...
- `59306f58` fix(firebase): upgrade SDK 10.7.1→10.14.1 + add IndexedDB corruption auto-recovery _(2026-03-30)_
- `5d207cd8` feat: complete project-tracker with full interactive features _(2026-03-19)_
