...
- `inventory-tracking/js/finance-manager.js`
- `inventory-tracking/js/modal-image-manager.js`
- `inventory-tracking/js/note-manager.js`
- `inventory-tracking/js/order-booking-crud.js`
