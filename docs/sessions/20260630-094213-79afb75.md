...
# Session Resume — 2026-06-30 09:42:13 +07

**Token**: `RESUME:20260630-094213-79afb75`
**Branch**: `main`
**HEAD**: `79afb759ab02ccc9ac9ee322d25cda50cbdf1c46`
**Range**: `126821a..79afb75` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-06-30T02:42:13Z

---

## 1. Summary

fix(soan-hang): tách toggle IN khỏi is_active → cột print_enabled (tag VẪN hiện khi tắt in)
...
- `docs/sessions/20260630-092840-126821a.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260630-092840-126821a`](./20260630-092840-126821a.md)
...
```
RESUME:20260630-094213-79afb75
```
