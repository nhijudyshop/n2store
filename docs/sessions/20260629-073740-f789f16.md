...
# Session Resume — 2026-06-29 07:37:40 +07

**Token**: `RESUME:20260629-073740-f789f16`
**Branch**: `main`
**HEAD**: `f789f1642f0a27c6b59dfd57b3e9e2579b2498f8`
**Range**: `27fb461..f789f16` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-06-29T00:37:40Z

---

## 1. Summary

feat(supplier-debt,native-orders): gate admin TT NCC + hiện mã đơn vị "-xxx" trong đơn
...
- `docs/sessions/20260629-071815-27fb461.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260629-071815-27fb461`](./20260629-071815-27fb461.md)
...
```
RESUME:20260629-073740-f789f16
```
