...
# Session Resume — 2026-05-21 15:32:13 +07

**Token**: `RESUME:20260521-153213-c53e98a`
**Branch**: `main`
**HEAD**: `c53e98a3239a9db939c71440b482d427f7219808`
**Range**: `c9f11f0..c53e98a` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-05-21T08:32:13Z

---

## 1. Summary

feat(scripts): auto cache-bust ?v=YYYYMMDDx for changed JS/CSS
...
- `docs/sessions/20260521-151745-c9f11f0.md` — _(điền lý do)_
...
- `scripts/auto-bump-cache-on-change.sh` — _(điền lý do)_
- `scripts/bump-cache-version.sh` — _(điền lý do)_
...
- Previous: [`RESUME:20260521-151745-c9f11f0`](./20260521-151745-c9f11f0.md)
...
```
RESUME:20260521-153213-c53e98a
```
