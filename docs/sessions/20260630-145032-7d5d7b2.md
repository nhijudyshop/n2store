...
# Session Resume — 2026-06-30 14:50:32 +07

**Token**: `RESUME:20260630-145032-7d5d7b2`
**Branch**: `main`
**HEAD**: `7d5d7b24e33ed8e969473e0de10967616a45d31b`
**Range**: `b8f2673..7d5d7b2` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-06-30T07:50:32Z

---

## 1. Summary

feat(so-order): surface 'chờ hàng cần đặt' (giỏ nháp > tồn) → nút Cần đặt + thêm vào đơn [#2...
...
- `docs/sessions/20260630-144114-b8f2673.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260630-144114-b8f2673`](./20260630-144114-b8f2673.md)
...
```
RESUME:20260630-145032-7d5d7b2
```
