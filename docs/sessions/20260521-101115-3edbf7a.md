...
# Session Resume — 2026-05-21 10:11:15 +07

**Token**: `RESUME:20260521-101115-3edbf7a`
**Branch**: `main`
**HEAD**: `3edbf7ab17f0eee5055e00c16b0c2baf370f18cf`
**Range**: `937c317..3edbf7a` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-05-21T03:11:15Z

---

## 1. Summary

fix(tpos-pancake): savePartnerData strip @odata.\* annotations + drop ExtraAddress/Properties/FacebookMap before POST
...
- `docs/sessions/20260521-101024-937c317.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260521-101024-937c317`](./20260521-101024-937c317.md)
...
```
RESUME:20260521-101115-3edbf7a
```
