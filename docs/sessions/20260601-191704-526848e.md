...
# Session Resume — 2026-06-01 19:17:04 +07

**Token**: `RESUME:20260601-191704-526848e`
**Branch**: `main`
**HEAD**: `526848e333a38df8134db849ecd6d673477827d3`
**Range**: `470a0ad..526848e` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-06-01T12:17:04Z

---

## 1. Summary

fix(tpos-customer-service): chuyển searchCustomerByFbUserId sang chatomni/info endpoint
...
- `docs/sessions/20260601-190455-470a0ad.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260601-190455-470a0ad`](./20260601-190455-470a0ad.md)
...
```
RESUME:20260601-191704-526848e
```
