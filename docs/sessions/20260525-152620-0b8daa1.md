...
# Session Resume — 2026-05-25 15:26:20 +07

**Token**: `RESUME:20260525-152620-0b8daa1`
**Branch**: `main`
**HEAD**: `0b8daa193d9fa015b5efd15c6da884622b28063c`
**Range**: `ddf7e02..0b8daa1` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-05-25T08:26:20Z

---

## 1. Summary

feat(delivery-report): auto-hide ghost orders qua POST /cleanup-ghosts
...
- `docs/sessions/20260525-152528-ddf7e02.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260525-152528-ddf7e02`](./20260525-152528-ddf7e02.md)
...
```
RESUME:20260525-152620-0b8daa1
```
