...
# Session Resume — 2026-06-02 14:36:25 +07

**Token**: `RESUME:20260602-143625-f5a7c31`
**Branch**: `main`
**HEAD**: `f5a7c313917877e573fe6580ebcdc2fdbc2ae8a3`
**Range**: `526848e..f5a7c31` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-06-02T07:36:25Z

---

## 1. Summary

feat(native-orders): bỏ nút Reset STT + group STORE/HOUSE thành 1 campaign cho STT
...
- `docs/sessions/20260601-191704-526848e.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260601-191704-526848e`](./20260601-191704-526848e.md)
...
```
RESUME:20260602-143625-f5a7c31
```
