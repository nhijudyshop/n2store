...
# Session Resume — 2026-05-20 17:14:30 +07

**Token**: `RESUME:20260520-171430-832f2f6`
**Branch**: `main`
**HEAD**: `832f2f6fb2eee3c675e8ef6fb89a4f72355b1e94`
**Range**: `2ec46af..832f2f6` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-05-20T10:14:30Z

---

## 1. Summary

fix(web2/native-orders): in bill — STT merge "26 + 30" + bỏ trễ 250ms
...
- `docs/sessions/20260520-170202-2ec46af.md` — _(điền lý do)_
...
- `downloads/n2store-session/bill-merged-stt.png` — _(điền lý do)_
...
- Previous: [`RESUME:20260520-170202-2ec46af`](./20260520-170202-2ec46af.md)
...
```
RESUME:20260520-171430-832f2f6
```
