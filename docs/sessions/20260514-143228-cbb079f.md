...
# Session Resume — 2026-05-14 14:32:28 +07

**Token**: `RESUME:20260514-143228-cbb079f`
**Branch**: `main`
**HEAD**: `cbb079fa1b0b878596daf232c3cd12e2ce9335f6`
**Range**: `62b6f42..cbb079f` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-05-14T07:32:28Z

---

## 1. Summary

fix(orders): badge NAP/TOMATO mất ở cột PHIẾU BÁN HÀNG khi 'Hoàn thành đối soát'
...
- `docs/sessions/20260514-142932-62b6f42.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260514-142932-62b6f42`](./20260514-142932-62b6f42.md)
...
```
RESUME:20260514-143228-cbb079f
```
