...
# Session Resume — 2026-05-18 17:58:01 +07

**Token**: `RESUME:20260518-175801-f5cb1cb`
**Branch**: `main`
**HEAD**: `f5cb1cb346eeeb55c1f03c584ba331166eac82b0`
**Range**: `3e5e034..f5cb1cb` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-05-18T10:58:01Z

---

## 1. Summary

fix(so-order): bỏ giật khi sync — skip Firestore snapshot có hasPendingWrites
...
- `docs/sessions/20260518-175514-3e5e034.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260518-175514-3e5e034`](./20260518-175514-3e5e034.md)
...
```
RESUME:20260518-175801-f5cb1cb
```
