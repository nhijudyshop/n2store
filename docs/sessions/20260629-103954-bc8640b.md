...
# Session Resume — 2026-06-29 10:39:54 +07

**Token**: `RESUME:20260629-103954-bc8640b`
**Branch**: `main`
**HEAD**: `bc8640b9f969a40ee9588ab93c2503a51ea31f69`
**Range**: `1a1adf6..bc8640b` (3 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-06-29T03:39:54Z

---

## 1. Summary

feat(clearance): admin-only chuyển SP rớt xả ↔ kho chính (gate POST /:id/clearance + ẩn nút non-admin)
...
- `docs/sessions/20260629-101330-1a1adf6.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260629-101330-1a1adf6`](./20260629-101330-1a1adf6.md)
...
```
RESUME:20260629-103954-bc8640b
```
