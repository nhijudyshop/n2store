...
# Session Resume — 2026-06-16 18:39:39 +07

**Token**: `RESUME:20260616-183939-970000a`
**Branch**: `main`
**HEAD**: `970000a952400e788cd7134d6b1c6a1ad26e56bf`
**Range**: `306e6ce..970000a` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-06-16T11:39:39Z

---

## 1. Summary

fix(so-order): Sửa lô tách NCC per-row (lô = nguyên ngày giao, nhiều NCC) — ẩn ô NCC chung, thêm cột...
...
- `docs/sessions/20260616-182122-306e6ce.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260616-182122-306e6ce`](./20260616-182122-306e6ce.md)
...
```
RESUME:20260616-183939-970000a
```
