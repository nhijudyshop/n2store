...
# Session Resume — 2026-05-25 08:55:28 +07

**Token**: `RESUME:20260525-085528-5b782f7`
**Branch**: `main`
**HEAD**: `5b782f7fc2374137b9f8ee24600e8efe04ee84ce`
**Range**: `0db506a..5b782f7` (3 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-05-25T01:55:28Z

---

## 1. Summary

fix(snap): FB seek param = 'start' (not 't') — verified qua Playwright test
...
- `docs/sessions/20260525-084428-0db506a.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260525-084428-0db506a`](./20260525-084428-0db506a.md)
...
```
RESUME:20260525-085528-5b782f7
```
