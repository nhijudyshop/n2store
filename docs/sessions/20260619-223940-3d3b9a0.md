...
# Session Resume — 2026-06-19 22:39:40 +07

**Token**: `RESUME:20260619-223940-3d3b9a0`
**Branch**: `main`
**HEAD**: `3d3b9a038ddf8d7cc0406985a80b66471ed28646`
**Range**: `e53a1ef..3d3b9a0` (3 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-06-19T15:39:40Z

---

## 1. Summary

fix(web2/fb): FB khai tử post reach/impressions → dùng metric còn sống (clicks/reactions/video_views/activity...
...
- `docs/sessions/20260619-223425-e53a1ef.md` — _(điền lý do)_
...
- `vieneu-tts/run_local.sh` — _(điền lý do)_
...
- Previous: [`RESUME:20260619-223425-e53a1ef`](./20260619-223425-e53a1ef.md)
...
```
RESUME:20260619-223940-3d3b9a0
```
