...
# Session Resume — 2026-06-25 22:57:44 +07

**Token**: `RESUME:20260625-225744-6ac77b2`
**Branch**: `main`
**HEAD**: `6ac77b217810bcbfcb789381e37e4aee4d3e377b`
**Range**: `578de96..6ac77b2` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-06-25T15:57:44Z

---

## 1. Summary

Tem SP đổi chỗ tên↔giá: tên băng full-width dài hơn, giá+biến thể cạnh QR, fix overlap, decode 90px OK
...
- `docs/sessions/20260625-224330-578de96.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260625-224330-578de96`](./20260625-224330-578de96.md)
...
```
RESUME:20260625-225744-6ac77b2
```
