...
# Session Resume — 2026-06-27 09:14:20 +07

**Token**: `RESUME:20260627-091420-fd83d24`
**Branch**: `main`
**HEAD**: `fd83d2453d8e431edb4c1a3e20c179408e8ba7f2`
**Range**: `a719683..fd83d24` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-06-27T02:14:20Z

---

## 1. Summary

fix(web2/overview): sửa 404 toàn bộ link card/tĩnh (thiếu resolveOur) + login → native-orders
...
- `docs/sessions/20260627-090027-a719683.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260627-090027-a719683`](./20260627-090027-a719683.md)
...
```
RESUME:20260627-091420-fd83d24
```
