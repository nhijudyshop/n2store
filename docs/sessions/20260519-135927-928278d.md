...
# Session Resume — 2026-05-19 13:59:27 +07

**Token**: `RESUME:20260519-135927-928278d`
**Branch**: `main`
**HEAD**: `928278dadf050ef07143b07ca0106a7d217b1f40`
**Range**: `37d678e..928278d` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-05-19T06:59:27Z

---

## 1. Summary

feat(native-orders): move gộp đơn + in bill từ PBH page sang đúng chỗ (Đơn Web)
...
- `docs/sessions/20260519-135148-37d678e.md` — _(điền lý do)_
...
- `downloads/n2store-session/qa-native-bulkbar-merge.png` — _(điền lý do)_
...
- Previous: [`RESUME:20260519-135148-37d678e`](./20260519-135148-37d678e.md)
...
```
RESUME:20260519-135927-928278d
```
