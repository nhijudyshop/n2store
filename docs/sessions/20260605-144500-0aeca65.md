...
# Session Resume — 2026-06-05 14:45:00 +07

**Token**: `RESUME:20260605-144500-0aeca65`
**Branch**: `main`
**HEAD**: `0aeca6525e2e5ae3eff8cf279de14aa3a2632a1a`
**Range**: `528b07a..0aeca65` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-06-05T07:45:00Z

---

## 1. Summary

fix(native-orders): Phieu Soan Hang in 'CHO HANG' (full chu) thay 'CH' khi tick cho hang
...
- `docs/sessions/20260605-144341-528b07a.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260605-144341-528b07a`](./20260605-144341-528b07a.md)
...
```
RESUME:20260605-144500-0aeca65
```
