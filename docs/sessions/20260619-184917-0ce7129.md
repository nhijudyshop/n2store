...
# Session Resume — 2026-06-19 18:49:17 +07

**Token**: `RESUME:20260619-184917-0ce7129`
**Branch**: `main`
**HEAD**: `0ce7129ed00fef7f3fb25092b2d5287f347a9251`
**Range**: `c1d37ac..0ce7129` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-06-19T11:49:17Z

---

## 1. Summary

fix(web2/fb-posts): trả aiAvailable cả khi chưa kết nối → nút 'AI viết lại' không bị disable sớm
...
- `docs/sessions/20260619-183531-c1d37ac.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260619-183531-c1d37ac`](./20260619-183531-c1d37ac.md)
...
```
RESUME:20260619-184917-0ce7129
```
