...
# Session Resume — 2026-05-18 18:03:56 +07

**Token**: `RESUME:20260518-180356-20edfcd`
**Branch**: `main`
**HEAD**: `20edfcd175a7f51f3c17680c81ba74d06d4e5abb`
**Range**: `f5cb1cb..20edfcd` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-05-18T11:03:56Z

---

## 1. Summary

refactor(so-order): sync sang local-first — bỏ onSnapshot, debounce push, pull-on-focus
...
- `docs/sessions/20260518-175801-f5cb1cb.md` — _(điền lý do)_
...
- `downloads/n2store-session/so-order-localfirst.png` — _(điền lý do)_
...
- Previous: [`RESUME:20260518-175801-f5cb1cb`](./20260518-175801-f5cb1cb.md)
...
```
RESUME:20260518-180356-20edfcd
```
