...
# Session Resume — 2026-06-06 12:16:28 +07

**Token**: `RESUME:20260606-121628-55f5efe`
**Branch**: `main`
**HEAD**: `55f5efeb3a0aa350981909c2fc8ad445396da98d`
**Range**: `871426e..55f5efe` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-06-06T05:16:28Z

---

## 1. Summary

fix(snap): update yt-dlp lên latest tại build (postinstall -U) — fix '[facebook] Cannot parse data' → force ex...
...
- `docs/sessions/20260606-121531-871426e.md` — _(điền lý do)_
...
- `render.com/scripts/update-ytdlp.js` — _(điền lý do)_
...
- Previous: [`RESUME:20260606-121531-871426e`](./20260606-121531-871426e.md)
...
```
RESUME:20260606-121628-55f5efe
```
