...
# Session Resume — 2026-05-23 10:11:12 +07

**Token**: `RESUME:20260523-101112-f9995fb`
**Branch**: `main`
**HEAD**: `f9995fbd2dbd57243467eda40f2921f3a043eb04`
**Range**: `8a51caf..f9995fb` (3 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-05-23T03:11:12Z

---

## 1. Summary

fix(snap): credentials 'include' → 'omit' để bypass CORS preflight block
...
- `docs/sessions/20260523-095522-8a51caf.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260523-095522-8a51caf`](./20260523-095522-8a51caf.md)
...
```
RESUME:20260523-101112-f9995fb
```
