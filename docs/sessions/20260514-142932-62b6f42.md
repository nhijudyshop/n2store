...
# Session Resume — 2026-05-14 14:29:32 +07

**Token**: `RESUME:20260514-142932-62b6f42`
**Branch**: `main`
**HEAD**: `62b6f42d8bed1c24c2b96649e33da8728192cda4`
**Range**: `ebc38ef..62b6f42` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-05-14T07:29:32Z

---

## 1. Summary

fix(purchase-orders): TPOS OData 502 — bỏ \$select trong Strategy A, 2-step Strategy B
...
- `scripts/tpos-direct-session.js` — _(điền lý do)_
...
- Previous: [`RESUME:20260514-141937-ebc38ef`](./20260514-141937-ebc38ef.md)
...
```
RESUME:20260514-142932-62b6f42
```
