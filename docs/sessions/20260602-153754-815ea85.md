...
# Session Resume — 2026-06-02 15:37:54 +07

**Token**: `RESUME:20260602-153754-815ea85`
**Branch**: `main`
**HEAD**: `815ea855393bc2281825908ccd6f983a8d34e08b`
**Range**: `3c1bf81..815ea85` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-06-02T08:37:54Z

---

## 1. Summary

feat(tpos-pancake): fallback gửi qua N2 Extension bypass-24h khi Pancake API lỗi (giống native-orders)
...
- `docs/sessions/20260602-153416-3c1bf81.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260602-153416-3c1bf81`](./20260602-153416-3c1bf81.md)
...
```
RESUME:20260602-153754-815ea85
```
