...
# Session Resume — 2026-06-06 13:05:24 +07

**Token**: `RESUME:20260606-130524-c4c0a57`
**Branch**: `main`
**HEAD**: `c4c0a573ad42ec535a5833f2f325943bed634b44`
**Range**: `855cc5e..c4c0a57` (2 commit(s))
**Author**: nhijudyshop <147459165+nhijudyshop@users.noreply.github.com>
**Generated**: 2026-06-06T06:05:24Z

---

## 1. Summary

feat(snap): force extract + nút Lấy thumbnail chuyển CLIENT-SIDE (seek iframe VOD + capture) — fix FB chặn b...
...
- `docs/sessions/20260606-130323-855cc5e.md` — _(điền lý do)_
...
- Previous: [`RESUME:20260606-130323-855cc5e`](./20260606-130323-855cc5e.md)
...
```
RESUME:20260606-130524-c4c0a57
```
