...
if (!ARGS.user || !ARGS.pass) {
    console.error(
        'Usage: --user U --pass P [--concurrency 4] [--per-page-secs 8] [--base URL]\n' +
            '  --base mặc định https://nhijudyshop.github.io/n2store\n' +
            '  Localhost: --base http://localhost:8080  (cần `python3 -m http.server 8080` từ project root)'
    );
    process.exit(1);
}
