...
const ignoredDirs = new Set(['.git', 'node_modules', '.dmux', '.next', 'coverage']);
...
const writableExtensions = new Set(['.md', '.mdx', '.txt']);
...
const allowedSymbolCodePoints = new Set([0x00a9, 0x00ae, 0x2122]);
