...
function getRepoChecks(rootDir) {
    ...
    return [
        ...
        },
        {
            ...
            description:
                'Harness-audit command parity exists between primary and OpenCode command docs',
        ...
        },
        {
            ...
            pass:
                fileExists(rootDir, 'commands/eval.md') &&
                fileExists(rootDir, 'commands/verify.md') &&
...
function getConsumerChecks(rootDir) {
    ...
    return [
        ...
        },
        {
            ...
            pass:
                fileExists(rootDir, '.claude/memory.md') ||
        ...
        },
        {
            ...
            pass:
                countFiles(rootDir, 'evals', null) > 0 ||
                countFiles(rootDir, 'tests', '.test.js') >= 3,
