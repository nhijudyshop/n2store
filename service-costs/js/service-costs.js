...
(function () {
    ...
    const SERVICES = [
        ...
        // broker; Web 1.0 realtime → n2store-fallback. Service + folder đã xóa.
        {
            ...
            billingDay: 1,
            costNote:
                'Web 2.0 Realtime — Pancake WS relay + Facebook Graph (gộp n2store-tpos-pancake + n2store-facebook, 14/06/2026)',
            region: 'Singapore',
            freeTier: 'Starter: 512MB RAM, 0.5 CPU, always-on',
            details: [
                { label: 'Service ID', value: 'srv-d8n45k4vikkc73cg3nrg' },
                { label: 'URL', value: 'https://web2-realtime.onrender.com' },
                { label: 'Root Dir', value: 'live-chat/server' },
                { label: 'Plan', value: 'Starter ($7/mo) - 512MB RAM, 0.5 CPU' },
                { label: 'Health Check', value: '/ping' },
                { label: 'Auto Deploy', value: 'Yes (main branch)' },
                { label: 'Created', value: '14/06/2026' },
                { label: 'Gộp từ', value: 'n2store-tpos-pancake + n2store-facebook (đã xóa)' },
            ],
            consoleUrl: 'https://dashboard.render.com/web/srv-d8n45k4vikkc73cg3nrg',
            status: 'active',
        },
        {
            id: 'render-db',
