...
/**
 * Telegram alert helper. Silently no-ops if TELEGRAM_BOT_TOKEN or
 * TELEGRAM_ADMIN_CHAT_ID is not set. Dedup: same (tag, msg-prefix)
 * throttled to once per 60s.
 */

const TG_TOKEN = process.env.TELEGRAM_BOT_TOKEN;
const TG_CHAT = process.env.TELEGRAM_ADMIN_CHAT_ID;
const SERVICE = process.env.RENDER_SERVICE_NAME || process.env.SERVICE_NAME || 'n2store-realtime';
