// js/order-statistics.js - Order Code Statistics (Simple Version)
...
function renderOrderStatistics() {
    ...
    const filteredInventory = getFilteredData ? getFilteredData() : inventory;
...
function createOrderStatsPanel(stats) {
    ...
    content.className = "order-stats-content hidden";
