...
class FormHandler {
    ...
    initializeFormElements() {
        ...
        // Hide input containers initially
    ...
    initializeEventListeners() {
        ...
        // Form submit handler
        if (this.elements.dataFormElement) {
            this.elements.dataFormElement.addEventListener(
                "submit",
    ...
    toggleForm() {
        ...
        if (isVisible) {
            ...
            this.elements.toggleFormButton.textContent = "Hiện biểu mẫu";
        } else {
            uiManager.toggleForm(this.dataForm, true);
            this.elements.toggleFormButton.textContent = "Ẩn biểu mẫu";
        }
    }
    ...
    validateAndGetFormData() {
        ...
        return {
            phanLoai: authManager.sanitizeInput(phanLoai),
            tenSanPham: authManager.sanitizeInput(tenSanPham),
