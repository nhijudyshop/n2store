      ...
      <CardContent className="space-y-4">
          ...
          <CollapsibleContent className="space-y-4 pt-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="margin-top" className="text-xs">Trên</Label>
                  <Input
                    id="margin-top"
                    type="number"
                    min="0"
                ...
                <div className="space-y-2">
                  <Label htmlFor="margin-bottom" className="text-xs">Dưới</Label>
                  <Input
                    id="margin-bottom"
                    type="number"
                    min="0"
                ...
                <div className="space-y-2">
                  <Label htmlFor="margin-left" className="text-xs">Trái</Label>
                  <Input
                    id="margin-left"
                    type="number"
                    min="0"
                ...
                <div className="space-y-2">
                  <Label htmlFor="margin-right" className="text-xs">Phải</Label>
                  <Input
                    id="margin-right"
                    type="number"
                    min="0"
        ...
        <div className="text-sm text-muted-foreground space-y-1 pt-2 border-t">
          ...
          <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <li><strong>2 chế độ in:</strong>
              <ul className="list-circle list-inside ml-4 space-y-1">
                <li><strong>In Bitmap (Fast):</strong> Nhanh, không cần poppler</li>
                <li><strong>In PDF (High Quality):</strong> Chất lượng cao hơn, CẦN cài poppler-utils</li>
              </ul>
            </li>
          </ul>
          <div className="mt-2 p-3 bg-amber-50 border border-amber-200 rounded-lg">
            ...
            <ul className="list-disc list-inside space-y-1 ml-2 text-amber-700">
              <li><strong>Ubuntu/Debian:</strong> <code className="bg-amber-100 px-1 py-0.5 rounded">sudo apt-get install poppler-utils</code></li>
              <li><strong>macOS:</strong> <code className="bg-amber-100 px-1 py-0.5 rounded">brew install poppler</code></li>
              <li><strong>Windows:</strong> Download từ <a href="https://github.com/oschwartz10612/poppler-windows/releases/" target="_blank" className="underline">github.com/oschwartz10612/poppler-windows</a></li>
            </ul>
