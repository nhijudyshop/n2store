...
console.log('     → Removes soldQty from soluongProducts (Phase 2)');
console.log('');
console.log('  8. cleanupSortedIds(database)');
console.log('     → Removes sortedIds from meta (Phase 2)');
console.log('');
console.log('═══════════════════════════════════════════════════════════');
...
async function cleanupRedundantSoldQty(database) {
    console.log('🧹 Starting cleanup of redundant soldQty from soluongProducts...');
    console.log('⏳ Please wait...');
    ...
    if (count === 0) {
        console.log('✅ No soldQty found in soluongProducts - already clean');
        return;
    }

    console.log(`📦 Found ${count} products with soldQty to remove`);
    console.log('🔄 Removing soldQty from soluongProducts...');
...
async function cleanupSortedIds(database) {
    console.log('🧹 Starting cleanup of sortedIds from soluongProductsMeta...');
    console.log('⏳ Please wait...');
    ...
    if (!meta || !meta.sortedIds) {
        console.log('✅ No sortedIds found in meta - already clean');
        return;
    }

    const sortedIdsCount = Array.isArray(meta.sortedIds) ? meta.sortedIds.length : 0;
    console.log(`📦 Found sortedIds with ${sortedIdsCount} entries`);
    console.log('🔄 Removing sortedIds...');
