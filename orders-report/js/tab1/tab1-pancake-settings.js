...
document.addEventListener('DOMContentLoaded', function() {
    // Update tag filter display text on load
    setTimeout(() => {
        if (typeof updateTagFilterDisplayText === 'function') {
            updateTagFilterDisplayText();
        }
        if (typeof updateExcludeTagFilterDisplayText === 'function') {
            updateExcludeTagFilterDisplayText();
        }
        window.updateExcludedTagsMainDisplay();
    }, 500);
