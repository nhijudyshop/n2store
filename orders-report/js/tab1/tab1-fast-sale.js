...
// ====================================
// #region WALLET IDENTITY + FAILURE STORE — MOVED to ../shared/js/wallet-failure-store.js
// ====================================
// getOrderWalletIdentity / WalletFailureStore / retryWalletOpFailures / race guards
// giờ là SHARED (dùng chung orders-report + don-inbox). HTML phải load
// ../shared/js/wallet-failure-store.js TRƯỚC file này. KHÔNG định nghĩa lại ở đây
// (tránh duplicate — CLAUDE.md).
