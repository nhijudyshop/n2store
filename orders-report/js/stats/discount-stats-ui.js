...
class DiscountStatsUI {
    ...
    loadOpportunityCostSettings() {
        try {
            const saved = n2store.getItem('orders_discount_opportunity_cost_settings');
            if (saved) {
    ...
    saveOpportunityCostSettings() {
        try {
            n2store.setItem('orders_discount_opportunity_cost_settings', JSON.stringify({
    ...
    loadLivestreamCosts() {
        try {
            const saved = n2store.getItem('orders_discount_livestream_costs');
            if (saved) {
    ...
    saveLivestreamCosts() {
        try {
            n2store.setItem('orders_discount_livestream_costs', JSON.stringify(this.livestreamCosts));
        } catch (e) {
