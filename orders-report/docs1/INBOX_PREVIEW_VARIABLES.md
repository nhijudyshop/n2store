...
```
https://pancake.vn/api/v1/pages/117267091364524/customers/658ffee5-09b2-40e9-94de-b7c87afb45b9/inbox_preview?access_token=<TOKEN_REMOVED>
```
...
- Format: `<JWT_REMOVED>{payload}.{signature}`
...
```javascript
const result = window.pancakeTokenManager.debugToken('<JWT_REMOVED>');
console.log(result);
```
