...
export const CORS_HEADERS = {
    ...
    'Access-Control-Allow-Headers': 'Content-Type, Authorization, Accept, tposappversion, x-tpos-lang, feature-version, X-Page-Access-Token, X-Auth-Data, X-User-Id, X-Company-Id',
...
export function proxyResponseWithCors(response) {
    ...
    newResponse.headers.set('Access-Control-Allow-Headers', 'Content-Type, Authorization, Accept, tposappversion, x-tpos-lang, feature-version, X-Company-Id');
    return newResponse;
}
