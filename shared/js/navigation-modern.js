...
const MENU_CONFIG = [
    ...
    {
        href: '../web2/account-chi/index.html',
        icon: 'sliders',
        text: '[V2] Loại chi',
        shortText: 'Loại chi',
        pageIdentifier: 'web2-account-chi',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/account-deposit/index.html',
        icon: 'dollar-sign',
        text: '[V2] Ký quỹ',
        shortText: 'Ký quỹ',
        pageIdentifier: 'web2-account-deposit',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/account-inventory/index.html',
        icon: 'dollar-sign',
        text: '[V2] Điều chỉnh công nợ',
        shortText: 'Điều chỉnh công nợ',
        pageIdentifier: 'web2-account-inventory',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/account-journal/index.html',
        icon: 'sliders',
        text: '[V2] Sổ nhật ký',
        shortText: 'Sổ nhật ký',
        pageIdentifier: 'web2-account-journal',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/account-list/index.html',
        icon: 'sliders',
        text: '[V2] Tài khoản kế toán',
        shortText: 'Tài khoản kế toán',
        pageIdentifier: 'web2-account-list',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/account-payment-change/index.html',
        icon: 'dollar-sign',
        text: '[V2] Tiền thối POS',
        shortText: 'Tiền thối POS',
        pageIdentifier: 'web2-account-payment-change',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/account-payment-chi/index.html',
        icon: 'dollar-sign',
        text: '[V2] Phiếu chi',
        shortText: 'Phiếu chi',
        pageIdentifier: 'web2-account-payment-chi',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/account-payment-list/index.html',
        icon: 'dollar-sign',
        text: '[V2] Thanh toán bán hàng',
        shortText: 'Thanh toán bán hàng',
        pageIdentifier: 'web2-account-payment-list',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/account-payment-thu/index.html',
        icon: 'dollar-sign',
        text: '[V2] Phiếu thu',
        shortText: 'Phiếu thu',
        pageIdentifier: 'web2-account-payment-thu',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/account-thu/index.html',
        icon: 'sliders',
        text: '[V2] Loại thu',
        shortText: 'Loại thu',
        pageIdentifier: 'web2-account-thu',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/application-user/index.html',
        icon: 'settings',
        text: '[V2] Người dùng',
        shortText: 'Người dùng',
        pageIdentifier: 'web2-application-user',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/barcode-product-label/index.html',
        icon: 'box',
        text: '[V2] In mã vạch',
        shortText: 'In mã vạch',
        pageIdentifier: 'web2-barcode-product-label',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/callcenter-config/index.html',
        icon: 'settings',
        text: '[V2] Tích hợp Callcenter',
        shortText: 'Tích hợp Callcenter',
        pageIdentifier: 'web2-callcenter-config',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/category-distributor/index.html',
        icon: 'box',
        text: '[V2] Danh mục khác',
        shortText: 'Danh mục khác',
        pageIdentifier: 'web2-category-distributor',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/company/index.html',
        icon: 'settings',
        text: '[V2] Công ty',
        shortText: 'Công ty',
        pageIdentifier: 'web2-company',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/configs-advanced/index.html',
        icon: 'settings',
        text: '[V2] Cấu hình nâng cao',
        shortText: 'Cấu hình nâng cao',
        pageIdentifier: 'web2-configs-advanced',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/configs-general/index.html',
        icon: 'settings',
        text: '[V2] Cấu hình chung',
        shortText: 'Cấu hình chung',
        pageIdentifier: 'web2-configs-general',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/configs-printer/index.html',
        icon: 'settings',
        text: '[V2] Máy in',
        shortText: 'Máy in',
        pageIdentifier: 'web2-configs-printer',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/configs-roles/index.html',
        icon: 'settings',
        text: '[V2] Phân quyền',
        shortText: 'Phân quyền',
        pageIdentifier: 'web2-configs-roles',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/configs-twofa/index.html',
        icon: 'settings',
        text: '[V2] Xác thực 2FA',
        shortText: 'Xác thực 2FA',
        pageIdentifier: 'web2-configs-twofa',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/coupon-program/index.html',
        icon: 'circle',
        text: '[V2] Coupon',
        shortText: 'Coupon',
        pageIdentifier: 'web2-coupon-program',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/delivery-carrier/index.html',
        icon: 'users',
        text: '[V2] Đối tác giao hàng',
        shortText: 'Đối tác giao hàng',
        pageIdentifier: 'web2-delivery-carrier',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/export-file/index.html',
        icon: 'sliders',
        text: '[V2] Tác vụ xuất file',
        shortText: 'Tác vụ xuất file',
        pageIdentifier: 'web2-export-file',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/fastpurchaseorder-invoice/index.html',
        icon: 'shopping-bag',
        text: '[V2] Mua hàng',
        shortText: 'Mua hàng',
        pageIdentifier: 'web2-fastpurchaseorder-invoice',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/fastpurchaseorder-refund/index.html',
        icon: 'shopping-bag',
        text: '[V2] Trả hàng mua',
        shortText: 'Trả hàng mua',
        pageIdentifier: 'web2-fastpurchaseorder-refund',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/fastsaleorder-delivery/index.html',
        icon: 'circle',
        text: '[V2] Phiếu giao hàng',
        shortText: 'Phiếu giao hàng',
        pageIdentifier: 'web2-fastsaleorder-delivery',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/fastsaleorder-invoice/index.html',
        icon: 'circle',
        text: '[V2] Bán hàng (Hóa đơn)',
        shortText: 'Bán hàng (Hóa đơn)',
        pageIdentifier: 'web2-fastsaleorder-invoice',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/fastsaleorder-refund/index.html',
        icon: 'circle',
        text: '[V2] Trả hàng',
        shortText: 'Trả hàng',
        pageIdentifier: 'web2-fastsaleorder-refund',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/history-cross-check-product/index.html',
        icon: 'circle',
        text: '[V2] Đối soát sản phẩm',
        shortText: 'Đối soát sản phẩm',
        pageIdentifier: 'web2-history-cross-check-product',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/history-ds/index.html',
        icon: 'circle',
        text: '[V2] Lịch sử đối soát',
        shortText: 'Lịch sử đối soát',
        pageIdentifier: 'web2-history-ds',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/inventory-valuation/index.html',
        icon: 'bar-chart-3',
        text: '[V2] Giá trị tồn kho',
        shortText: 'Giá trị tồn kho',
        pageIdentifier: 'web2-inventory-valuation',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/ir-mailserver/index.html',
        icon: 'settings',
        text: '[V2] Cấu hình Mail Server',
        shortText: 'Cấu hình Mail Server',
        pageIdentifier: 'web2-ir-mailserver',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/live-campaign/index.html',
        icon: 'circle',
        text: '[V2] Chiến dịch Live',
        shortText: 'Chiến dịch Live',
        pageIdentifier: 'web2-live-campaign',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/loyalty-program/index.html',
        icon: 'circle',
        text: '[V2] Tích điểm',
        shortText: 'Tích điểm',
        pageIdentifier: 'web2-loyalty-program',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/mail-template/index.html',
        icon: 'settings',
        text: '[V2] Mẫu email',
        shortText: 'Mẫu email',
        pageIdentifier: 'web2-mail-template',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/offer-program/index.html',
        icon: 'circle',
        text: '[V2] Ưu đãi',
        shortText: 'Ưu đãi',
        pageIdentifier: 'web2-offer-program',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/partner-category/index.html',
        icon: 'users',
        text: '[V2] Nhóm khách hàng',
        shortText: 'Nhóm khách hàng',
        pageIdentifier: 'web2-partner-category',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/partner-category-revenue-config/index.html',
        icon: 'users',
        text: '[V2] Cấu hình nhóm doanh số',
        shortText: 'Cấu hình nhóm doan…',
        pageIdentifier: 'web2-partner-category-revenue-config',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/partner-customer/index.html',
        icon: 'users',
        text: '[V2] Khách hàng',
        shortText: 'Khách hàng',
        pageIdentifier: 'web2-partner-customer',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/partner-supplier/index.html',
        icon: 'users',
        text: '[V2] Nhà cung cấp',
        shortText: 'Nhà cung cấp',
        pageIdentifier: 'web2-partner-supplier',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/pos-config/index.html',
        icon: 'circle',
        text: '[V2] Điểm bán hàng',
        shortText: 'Điểm bán hàng',
        pageIdentifier: 'web2-pos-config',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/pos-order/index.html',
        icon: 'circle',
        text: '[V2] Đơn hàng POS',
        shortText: 'Đơn hàng POS',
        pageIdentifier: 'web2-pos-order',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/pos-session/index.html',
        icon: 'circle',
        text: '[V2] Phiên bán hàng',
        shortText: 'Phiên bán hàng',
        pageIdentifier: 'web2-pos-session',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/product-attribute/index.html',
        icon: 'box',
        text: '[V2] Thuộc tính',
        shortText: 'Thuộc tính',
        pageIdentifier: 'web2-product-attribute',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/product-attribute-value/index.html',
        icon: 'box',
        text: '[V2] Giá trị thuộc tính',
        shortText: 'Giá trị thuộc tính',
        pageIdentifier: 'web2-product-attribute-value',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/product-category/index.html',
        icon: 'box',
        text: '[V2] Nhóm sản phẩm',
        shortText: 'Nhóm sản phẩm',
        pageIdentifier: 'web2-product-category',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/product-label-paper/index.html',
        icon: 'settings',
        text: '[V2] Giấy in mã vạch',
        shortText: 'Giấy in mã vạch',
        pageIdentifier: 'web2-product-label-paper',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/product-template/index.html',
        icon: 'box',
        text: '[V2] Sản phẩm',
        shortText: 'Sản phẩm',
        pageIdentifier: 'web2-product-template',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/product-uom/index.html',
        icon: 'box',
        text: '[V2] Đơn vị tính',
        shortText: 'Đơn vị tính',
        pageIdentifier: 'web2-product-uom',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/product-uom-categ/index.html',
        icon: 'box',
        text: '[V2] Nhóm đơn vị tính',
        shortText: 'Nhóm đơn vị tính',
        pageIdentifier: 'web2-product-uom-categ',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/product-variant/index.html',
        icon: 'box',
        text: '[V2] Biến thể sản phẩm',
        shortText: 'Biến thể sản phẩm',
        pageIdentifier: 'web2-product-variant',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/promotion-program/index.html',
        icon: 'circle',
        text: '[V2] Chương trình khuyến mãi',
        shortText: 'Chương trình khuyế…',
        pageIdentifier: 'web2-promotion-program',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/report-audit-fastsale/index.html',
        icon: 'bar-chart-3',
        text: '[V2] Audit log PBH',
        shortText: 'Audit log PBH',
        pageIdentifier: 'web2-report-audit-fastsale',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/report-business-results/index.html',
        icon: 'bar-chart-3',
        text: '[V2] Kết quả kinh doanh',
        shortText: 'Kết quả kinh doanh',
        pageIdentifier: 'web2-report-business-results',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/report-cash-journal/index.html',
        icon: 'bar-chart-3',
        text: '[V2] Sổ tiền mặt',
        shortText: 'Sổ tiền mặt',
        pageIdentifier: 'web2-report-cash-journal',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/report-customer-debt/index.html',
        icon: 'bar-chart-3',
        text: '[V2] Công nợ KH',
        shortText: 'Công nợ KH',
        pageIdentifier: 'web2-report-customer-debt',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/report-delivery/index.html',
        icon: 'bar-chart-3',
        text: '[V2] Thống kê giao hàng',
        shortText: 'Thống kê giao hàng',
        pageIdentifier: 'web2-report-delivery',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/report-exported/index.html',
        icon: 'bar-chart-3',
        text: '[V2] Thống kê xuất kho',
        shortText: 'Thống kê xuất kho',
        pageIdentifier: 'web2-report-exported',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/report-imported/index.html',
        icon: 'bar-chart-3',
        text: '[V2] Thống kê nhập kho',
        shortText: 'Thống kê nhập kho',
        pageIdentifier: 'web2-report-imported',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/report-not-invoice/index.html',
        icon: 'bar-chart-3',
        text: '[V2] KH chưa phát sinh HĐ',
        shortText: 'KH chưa phát sinh HĐ',
        pageIdentifier: 'web2-report-not-invoice',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/report-order/index.html',
        icon: 'bar-chart-3',
        text: '[V2] Thống kê hóa đơn',
        shortText: 'Thống kê hóa đơn',
        pageIdentifier: 'web2-report-order',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/report-partner-create/index.html',
        icon: 'bar-chart-3',
        text: '[V2] Nguồn tạo KH',
        shortText: 'Nguồn tạo KH',
        pageIdentifier: 'web2-report-partner-create',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/report-product-invoice/index.html',
        icon: 'bar-chart-3',
        text: '[V2] SP HĐ nháp/xác nhận',
        shortText: 'SP HĐ nháp/xác nhận',
        pageIdentifier: 'web2-report-product-invoice',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/report-purchase/index.html',
        icon: 'bar-chart-3',
        text: '[V2] Thống kê mua hàng',
        shortText: 'Thống kê mua hàng',
        pageIdentifier: 'web2-report-purchase',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/report-rate-saleonline/index.html',
        icon: 'bar-chart-3',
        text: '[V2] Tỷ lệ lên đơn SO',
        shortText: 'Tỷ lệ lên đơn SO',
        pageIdentifier: 'web2-report-rate-saleonline',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/report-refund/index.html',
        icon: 'bar-chart-3',
        text: '[V2] Thống kê trả hàng',
        shortText: 'Thống kê trả hàng',
        pageIdentifier: 'web2-report-refund',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/report-revenue/index.html',
        icon: 'bar-chart-3',
        text: '[V2] Thống kê doanh thu',
        shortText: 'Thống kê doanh thu',
        pageIdentifier: 'web2-report-revenue',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/report-supplier-debt/index.html',
        icon: 'bar-chart-3',
        text: '[V2] Công nợ NCC',
        shortText: 'Công nợ NCC',
        pageIdentifier: 'web2-report-supplier-debt',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/res-currency/index.html',
        icon: 'settings',
        text: '[V2] Tiền tệ',
        shortText: 'Tiền tệ',
        pageIdentifier: 'web2-res-currency',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/revenue-began-customer/index.html',
        icon: 'users',
        text: '[V2] DSD đầu kỳ Khách hàng',
        shortText: 'DSD đầu kỳ Khách h…',
        pageIdentifier: 'web2-revenue-began-customer',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/revenue-began-supplier/index.html',
        icon: 'users',
        text: '[V2] DSD đầu kỳ Nhà cung cấp',
        shortText: 'DSD đầu kỳ Nhà cun…',
        pageIdentifier: 'web2-revenue-began-supplier',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
    ...
    {
        href: '../web2/sale-order/index.html',
        icon: 'circle',
        text: '[V2] Đơn đặt hàng',
        shortText: 'Đơn đặt hàng',
        pageIdentifier: 'web2-sale-order',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/sale-quotation/index.html',
        icon: 'circle',
        text: '[V2] Báo giá',
        shortText: 'Báo giá',
        pageIdentifier: 'web2-sale-quotation',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/sales-channel/index.html',
        icon: 'globe',
        text: '[V2] Kênh bán hàng',
        shortText: 'Kênh bán hàng',
        pageIdentifier: 'web2-sales-channel',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/stock-fifo-vacuum/index.html',
        icon: 'circle',
        text: '[V2] Điều chỉnh giá vốn',
        shortText: 'Điều chỉnh giá vốn',
        pageIdentifier: 'web2-stock-fifo-vacuum',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/stock-inventory/index.html',
        icon: 'circle',
        text: '[V2] Điều chỉnh tồn kho',
        shortText: 'Điều chỉnh tồn kho',
        pageIdentifier: 'web2-stock-inventory',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/stock-location/index.html',
        icon: 'circle',
        text: '[V2] Vị trí kho',
        shortText: 'Vị trí kho',
        pageIdentifier: 'web2-stock-location',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/stock-move/index.html',
        icon: 'circle',
        text: '[V2] Dịch chuyển kho',
        shortText: 'Dịch chuyển kho',
        pageIdentifier: 'web2-stock-move',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/stock-picking-type/index.html',
        icon: 'circle',
        text: '[V2] Tất cả hoạt động kho',
        shortText: 'Tất cả hoạt động kho',
        pageIdentifier: 'web2-stock-picking-type',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/stock-warehouse-product/index.html',
        icon: 'circle',
        text: '[V2] Cấu hình SP kho',
        shortText: 'Cấu hình SP kho',
        pageIdentifier: 'web2-stock-warehouse-product',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/tag/index.html',
        icon: 'sliders',
        text: '[V2] Nhãn (Tag)',
        shortText: 'Nhãn (Tag)',
        pageIdentifier: 'web2-tag',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/wi-invoice/index.html',
        icon: 'circle',
        text: '[V2] Hóa đơn điện tử',
        shortText: 'Hóa đơn điện tử',
        pageIdentifier: 'web2-wi-invoice',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/wi-invoice-config/index.html',
        icon: 'circle',
        text: '[V2] HĐĐT cấu hình',
        shortText: 'HĐĐT cấu hình',
        pageIdentifier: 'web2-wi-invoice-config',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/wi-invoice-history/index.html',
        icon: 'circle',
        text: '[V2] HĐĐT lịch sử',
        shortText: 'HĐĐT lịch sử',
        pageIdentifier: 'web2-wi-invoice-history',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/xuat-nhap-ton/index.html',
        icon: 'bar-chart-3',
        text: '[V2] Nhập-Xuất-Tồn',
        shortText: 'Nhập-Xuất-Tồn',
        pageIdentifier: 'web2-xuat-nhap-ton',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    // -- WEB2_NAV_ITEMS_END --
...
async function loadCustomMenuNamesFromFirebase() {
    try {
        ...
        console.warn(
            '[Menu Names] Error loading from API (fallback localStorage):',
            e?.message || e
        );
...
const DEFAULT_GROUPS_CONFIG = [
    ...
    // -- WEB2_NAV_GROUPS_START -- (auto-generated by scripts/web2-build-nav.js)
    {
        ...
        items: [
            ...
            'web2-sale-quotation',
            'web2-wi-invoice',
            'web2-wi-invoice-config',
            'web2-wi-invoice-history',
        ],
    },
    {
        name: 'Web 2.0 — Báo cáo',
        icon: 'bar-chart-3',
        items: [
            'web2-inventory-valuation',
            'web2-report-audit-fastsale',
            'web2-report-business-results',
            'web2-report-cash-journal',
            'web2-report-customer-debt',
            'web2-report-delivery',
            'web2-report-exported',
            'web2-report-imported',
            'web2-report-not-invoice',
            'web2-report-order',
            'web2-report-partner-create',
            'web2-report-product-invoice',
            'web2-report-purchase',
            'web2-report-rate-saleonline',
            'web2-report-refund',
            'web2-report-revenue',
            'web2-report-supplier-debt',
            'web2-xuat-nhap-ton',
        ],
    },
    {
        name: 'Web 2.0 — Cấu hình',
        icon: 'settings',
        items: [
            'web2-application-user',
            'web2-callcenter-config',
            'web2-company',
            'web2-configs-advanced',
            'web2-configs-general',
            'web2-configs-printer',
            'web2-configs-roles',
            'web2-configs-twofa',
            'web2-ir-mailserver',
            'web2-mail-template',
            'web2-product-label-paper',
            'web2-res-currency',
        ],
    },
    {
        name: 'Web 2.0 — Cấu hình kế toán',
        icon: 'sliders',
        items: [
            'web2-account-chi',
            'web2-account-journal',
            'web2-account-list',
            'web2-account-thu',
            'web2-export-file',
            'web2-tag',
    ...
    {
        name: 'Web 2.0 — Kênh bán',
        icon: 'globe',
        items: ['web2-sales-channel'],
    },
    {
        name: 'Web 2.0 — Khách hàng',
        icon: 'users',
        items: [
            'web2-delivery-carrier',
            'web2-partner-category',
            'web2-partner-category-revenue-config',
            'web2-partner-customer',
            'web2-partner-supplier',
            'web2-revenue-began-customer',
            'web2-revenue-began-supplier',
        ],
    },
    {
        name: 'Web 2.0 — Kho hàng',
        icon: 'circle',
        items: [
            'web2-stock-fifo-vacuum',
            'web2-stock-inventory',
            'web2-stock-location',
            'web2-stock-move',
            'web2-stock-picking-type',
            'web2-stock-warehouse-product',
        ],
    },
    {
        name: 'Web 2.0 — Khuyến mãi',
        icon: 'circle',
        items: [
            'web2-coupon-program',
            'web2-loyalty-program',
            'web2-offer-program',
            'web2-promotion-program',
        ],
    },
    {
        name: 'Web 2.0 — Mua hàng',
        icon: 'shopping-bag',
        items: ['web2-fastpurchaseorder-invoice', 'web2-fastpurchaseorder-refund'],
    },
    {
        name: 'Web 2.0 — Sale Online',
        icon: 'circle',
        items: ['web2-live-campaign', 'web2-sale-online-facebook'],
    },
    {
        name: 'Web 2.0 — Sản phẩm',
        icon: 'box',
        items: [
            'web2-barcode-product-label',
            'web2-category-distributor',
            'web2-product-attribute',
            'web2-product-attribute-value',
            'web2-product-category',
            'web2-product-template',
            'web2-product-uom',
            'web2-product-uom-categ',
            'web2-product-variant',
        ],
    },
    {
        name: 'Web 2.0 — Tài chính',
        icon: 'dollar-sign',
        items: [
            'web2-account-deposit',
            'web2-account-inventory',
            'web2-account-payment-change',
            'web2-account-payment-chi',
            'web2-account-payment-list',
            'web2-account-payment-thu',
        ],
    },
    // -- WEB2_NAV_GROUPS_END --
    {
