...
const MENU_CONFIG = [
    ...
    {
        href: '../web2/balance-history/index.html',
        icon: 'dollar-sign',
        text: '[V2] Lịch sử biến động số dư (SePay)',
        shortText: 'Lịch sử biến động …',
        pageIdentifier: 'web2-balance-history',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/delivery-zone/index.html',
        icon: 'circle',
        text: '[V2] Phương thức giao hàng',
        shortText: 'Phương thức giao h…',
        pageIdentifier: 'web2-delivery-zone',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    {
        href: '../web2/product-counter/index.html',
        icon: 'circle',
        text: '[V2] Đếm bó / pack',
        shortText: 'Đếm bó / pack',
        pageIdentifier: 'web2-product-counter',
        permissionRequired: 'web2-launcher',
        publicAccess: true,
    },
    // -- WEB2_NAV_ITEMS_END --
