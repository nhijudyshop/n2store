...
/**
 * Shared Utilities for Live-Pancake
 * Extracted from live-chat.js and pancake-chat.js to eliminate duplication
 */
...
const SharedUtils = {
     ...
     * @param {string} [directAvatarUrl] - Direct URL from Pancake/Live
     * @returns {string}
     */
