...
/**
 * Shared Event Bus for Live-Pancake
 * Cross-column event communication replacing ad-hoc window.dispatchEvent patterns
 *
 * Events:
 *   live:commentSelected   - User selected a comment in Live column
 *   live:orderCreated      - New order created from comment
 *   live:orderUpdated      - Existing order updated
 *   live:newComment         - New comment received via realtime
 ...
 *   pancake:savedListUpdated - Saved Live list updated
