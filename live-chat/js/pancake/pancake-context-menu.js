...
const PancakeContextMenu = {
    ...
    show(e, convId, pageId) {
        ...
        var divider = menu.querySelector('.pk-live-saved-divider');
        var action = menu.querySelector('.pk-live-saved-action');
        if (divider && action) {
            var show = state.activeFilter === 'live-saved';
    ...
    async handleAction(action) {
        ...
        try {
            if (action === 'mark-unread') {
                ...
                return;
            } else if (action === 'remove-live-saved') {
                ...
                var custId =
                    ...
                    customer.psid ||
                    customer.id;
                if (custId) window.PancakeConversationList.removeFromLiveSaved(custId);
            }
        } catch (error) {
